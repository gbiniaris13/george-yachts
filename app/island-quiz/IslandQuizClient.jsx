...
const ISLANDS = {
  ...
  koufonisia: { name: 'Koufonisia', emoji: '🏝️', tagline: 'The Free Spirit', desc: "You believe the best things are the simplest: bare feet on white sand, swimming in water that belongs in a dream, and a sky full of stars that makes you forget your phone exists. Koufonisia is tiny, car-free, and achingly beautiful - the Greek Caribbean, without trying to be anything else.", region: 'Cyclades', bestFor: 'Beaches, simplicity, barefoot luxury, stargazing', yacht: "S/CAT SEABARIT LX or S/CAT ALMA" },
};
