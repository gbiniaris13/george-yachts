...
const SLUG = "yacht-charter-mykonos-8-guests";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/yacht-charter-mykonos-8-guests` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/yacht-charter-mykonos-8-guests`,
    type: "article",
