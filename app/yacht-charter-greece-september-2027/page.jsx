...
const SLUG = "yacht-charter-greece-september-2027";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/yacht-charter-greece-september-2027` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/yacht-charter-greece-september-2027`,
    type: "article",
