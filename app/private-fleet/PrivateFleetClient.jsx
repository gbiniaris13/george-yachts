  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0D1B2A" }}>
      ...
      <div style={{ position: "fixed", top: 100, left: 24, zIndex: 9999 }}>
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none", fontFamily: "var(--gy-font-ui)", fontSize: 11, letterSpacing: "0.15em", color: "rgba(248, 245, 240,0.5)", padding: "12px 20px", background: "rgba(13, 27, 42, 0.6)", backdropFilter: "blur(8px)", borderRadius: 4, border: "1px solid rgba(201,168,76,0.2)" }}>
      ...
      <section style={{ padding: "80px 24px", background: "#0D1B2A" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: 10, letterSpacing: "0.4em", color: "#C9A84C", textTransform: "uppercase", marginBottom: 16 }}>
              ...
              <Link key={yacht._id} href={`/yachts/${yacht.slug}`} style={{ textDecoration: "none", display: "block", border: "1px solid rgba(201,168,76,0.08)", borderRadius: 4, overflow: "hidden" }}>
                ...
                <div style={{ position: "relative", aspectRatio: "16/10", overflow: "hidden" }}>
                  ...
                  <div style={{ position: "absolute", bottom: 20, left: 20, right: 20 }}>
                    <h3 style={{ fontFamily: "var(--gy-font-editorial)", fontSize: "1.5rem", fontWeight: 300, color: "#F8F5F0", margin: 0, letterSpacing: "0.02em" }}>{yacht.name}</h3>
                    <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: 9, color: "rgba(248, 245, 240,0.45)", letterSpacing: "0.18em", textTransform: "uppercase", marginTop: 5 }}>
                ...
                <div style={{ padding: "24px 28px", background: "rgba(13, 27, 42,0.98)", textAlign: "center", borderTop: "1px solid rgba(201,168,76,0.1)" }}>
                  ...
                  {yacht.weeklyRatePrice ? (
                    <>
                      <p style={{ fontFamily: "var(--gy-font-editorial)", fontSize: "1.35rem", fontWeight: 300, color: "#C9A84C", margin: "0 0 8px 0", letterSpacing: "0.03em" }}>
                        {yacht.weeklyRatePrice.split('|')[0].trim()}
                      </p>
                      {yacht.weeklyRatePrice.includes('|') && (
                        <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: 9, color: "rgba(248, 245, 240,0.3)", letterSpacing: "0.15em", textTransform: "uppercase", margin: 0 }}>
                    ...
                    <>
                      <p style={{ fontFamily: "var(--gy-font-editorial)", fontSize: "1.2rem", fontWeight: 300, color: "#C9A84C", margin: "0 0 6px 0" }}>
                        Price on request
                      </p>
                      <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: 9, color: "rgba(248, 245, 240,0.3)", letterSpacing: "0.15em", textTransform: "uppercase", margin: 0 }}>
                        Contact for rates
      ...
      <section style={{ padding: "100px 24px", background: "#0D1B2A", borderTop: "1px solid rgba(201,168,76,0.08)" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", display: "flex", alignItems: "center", gap: 40, flexWrap: "wrap", justifyContent: "center" }}>
          ...
          <div style={{ textAlign: "center", flex: 1, minWidth: 250 }}>
            ...
            <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: 11, color: "#C9A84C", letterSpacing: "0.15em", textTransform: "uppercase", marginBottom: 16 }}>
      ...
      <section style={{ padding: "100px 24px", background: "#0D1B2A", textAlign: "center" }}>
        ...
        <a
          href="https://api.whatsapp.com/send/?phone=17867988798&text=Hello%20George%2C%20I%27d%20like%20to%20begin%20a%20Private%20Charter%20conversation.%20Which%20yachts%20are%20available%3F"
          target="_blank"
          rel="noopener noreferrer"
