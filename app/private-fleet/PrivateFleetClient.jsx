      ...
      <section style={{ padding: "clamp(40px, 5vw, 56px) 24px", background: "#0D1B2A" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(340px, 1fr))", gap: 24 }}>
            {yachts.map((yacht) => (
              <Link key={yacht._id} href={`/yachts/${yacht.slug}`} style={{ textDecoration: "none", display: "block", border: "1px solid rgba(218, 161, 16,0.08)", borderRadius: 4, overflow: "hidden" }}>
                {/* Image */}
                ...
                {/* Pricing Panel */}
                <div style={{ padding: "24px 28px", background: "rgba(13, 27, 42,0.98)", textAlign: "center", borderTop: "1px solid rgba(218, 161, 16,0.1)" }}>
                  {/* Gold divider */}
                  <div style={{ width: 32, height: 1, background: "linear-gradient(90deg, transparent, #DAA110, transparent)", margin: "0 auto 18px" }} />
                  ...
                  {yacht.weeklyRatePrice ? (
                    ...
                    <>
                      <p style={{ fontFamily: "var(--gy-font-editorial)", fontSize: "1.2rem", fontWeight: 300, color: "#DAA110", margin: "0 0 6px 0" }}>
                        Price on request
                      </p>
                      <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: 9, color: "rgba(248, 245, 240,0.3)", letterSpacing: "0.15em", textTransform: "uppercase", margin: 0 }}>
                        Contact for rates
                  ...
                  {/* Bottom rule */}
                  <div style={{ width: 32, height: 1, background: "linear-gradient(90deg, transparent, rgba(218, 161, 16,0.3), transparent)", margin: "18px auto 0" }} />
                </div>
              </Link>
            ))}
          </div>
