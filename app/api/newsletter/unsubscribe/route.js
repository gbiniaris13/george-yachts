...
<body style="margin:0; padding:0; background: #0D1B2A; color:#F8F5F0; font-family:Georgia, serif; min-height:100vh; display:flex; align-items:center; justify-content:center;">
  <div style="max-width:520px; margin:0 auto; padding:48px 32px; text-align:center; border:1px solid rgba(218, 161, 16,0.25);">
    <p style="margin:0 0 14px; font-family:'Montserrat',Arial,sans-serif; font-size:9px; letter-spacing:0.55em; text-transform:uppercase; color:#DAA110; font-weight:600;">
    ...
    <p style="margin:0 0 28px; font-family:Georgia,serif; font-size:16px; line-height:1.7; color:rgba(248,245,240,0.78); font-weight:300;">
      ${body}
    </p>
    <a href="https://georgeyachts.com" style="display:inline-block; padding:12px 26px; font-family:'Montserrat',Arial,sans-serif; font-size:10px; letter-spacing:0.28em; text-transform:uppercase; color:#DAA110; text-decoration:none; border:1px solid rgba(218, 161, 16,0.45);">
