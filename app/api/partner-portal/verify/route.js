  ...
  if (!email) {
    return new Response(
      `<!doctype html><meta charset="utf-8"><title>Link expired</title>
       <body style="font-family:sans-serif;background:#0a0a0a;color:#fff;display:flex;min-height:100vh;align-items:center;justify-content:center">
         <div style="text-align:center;max-width:420px;padding:24px">
           ...
           <a href="/partner-portal" style="font-family:'Montserrat',sans-serif;font-size:11px;letter-spacing:0.24em;text-transform:uppercase;font-weight:700;color:#0a1a2f;background:#DAA520;padding:12px 22px;text-decoration:none">Back to portal →</a>
         </div>
       </body>`,
