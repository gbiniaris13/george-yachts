      ...
      `<!doctype html><meta charset="utf-8"><title>Link expired</title>
       <body style="font-family:sans-serif;background:#0D1B2A;color:#F8F5F0;display:flex;min-height:100vh;align-items:center;justify-content:center">
         <div style="text-align:center;max-width:420px;padding:24px">
           ...
           <p style="color:rgba(248,245,240,0.78);margin:0 0 22px">Magic links are good for 15 minutes. Request a new one from the portal.</p>
           <a href="/partner-portal" style="font-family:'Montserrat',sans-serif;font-size:11px;letter-spacing:0.24em;text-transform:uppercase;font-weight:700;color:#0D1B2A;background:#C9A84C;padding:12px 22px;text-decoration:none">Back to portal →</a>
         </div>
       </body>`,
