// Wake (travel agents) full-auto newsletter cron.
//
// Fires every Thursday 13:00 UTC (~16:00 Athens). The cadence gate inside
...
export async function GET(request) {
  ...
  const result = await runAutoSend("wake", { force });
