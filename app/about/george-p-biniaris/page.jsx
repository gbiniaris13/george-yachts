...
function PersonJsonLd() {
  ...
  const json = {
    ...
    description:
      "Founder and Managing Broker of George Yachts Brokerage House LLC, headquartered in the U.S. (Wyoming) and operated from Athens. Cycladic roots (Syros); BSc in Shipping Management & Operations (Business College of Athens); licensed skipper and charter operations professional; a decade in luxury hospitality management in Mykonos. IYBA Charter Active Member, MYBA-standard practitioner, Forbes-featured (May 2026). Specialises in crewed luxury yacht charter across Greek waters for UHNW clientele.",
    url: "https://georgeyachts.com/about/george-p-biniaris",
