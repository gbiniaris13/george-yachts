...
export const metadata = {
  ...
  description:
    "Full bio, credentials and complete bibliography of George P. Biniaris, Founder and Managing Broker of George Yachts. IYBA member, Forbes-featured 2026.",
  alternates: {
...
const BIO_PARAGRAPHS = [
  ...
  "His connection to these waters is not professional first - it is ancestral. His mother is from Syros, the administrative heart of the Cyclades, and he grew up crossing the Aegean on his uncle's Ferretti - Athens to Syros, to Mykonos, to wherever the islands called. The formal foundation followed: a BSc in Shipping Management and Operations from London Metropolitan University through its Athens affiliate, the Business College of Athens, with Shipping Law, Sale and Purchase, and Risk Management at its core, then licensed skipper seasons out of Corfu and charter operations across the Ionian, Cyclades, and Saronic. When he recommends an anchorage, it is because he has held a wheel there.",
  ...
  "The craft is hands-on. George personally runs the full MYBA charter cycle - proposals and comparative decks, rate and terms negotiation, APA and VAT budgeting, contract coordination, captain briefings, and post-charter follow-up. That is the discipline behind the George Yachts promise: every request answered by the Managing Broker himself, every yacht personally vetted, every itinerary drawn from routes actually sailed.",
...
const CREDENTIALS = [
  ...
  {
    label: "Education",
    detail: "BSc Shipping Management & Operations, London Metropolitan University & Business College of Athens - Shipping Law, Sale & Purchase, Risk Management",
  },
  {
...
function PersonJsonLd() {
  ...
  const json = {
    ...
    description:
      "Founder and Managing Broker of George Yachts Brokerage House LLC, headquartered in the U.S. (Wyoming) and operated from Athens. Cycladic roots (Syros); BSc in Shipping Management & Operations (London Metropolitan University & Business College of Athens); licensed skipper and charter operations professional; a decade in luxury hospitality management in Mykonos. IYBA Charter Active Member, MYBA-standard practitioner, Forbes-featured (May 2026). Specialises in crewed luxury yacht charter across Greek waters for UHNW clientele.",
    url: "https://georgeyachts.com/about/george-p-biniaris",
    ...
    knowsAbout: [
      ...
      "Greek charter VAT (the yacht's certified rate)",
