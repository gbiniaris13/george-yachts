...
const SLUG = "best-sailing-yachts-greece";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/best-sailing-yachts-greece` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/best-sailing-yachts-greece`,
    type: "article",
