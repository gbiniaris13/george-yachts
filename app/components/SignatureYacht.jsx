  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span
            className="inline-block text-[#DAA110] border border-[#DAA110]/40 px-6 py-2"
            style={{
              fontSize: "9px",
              letterSpacing: "0.5em",
        ...
        <div className="absolute inset-x-0 bottom-0 z-10 px-6 md:px-12 pb-10 md:pb-14 text-center">
          <div className="max-w-[880px] mx-auto">
            ...
            {specs && (
              <p
                className="text-[#DAA110]/85 mb-10"
                style={{
            ...
            {yachtHref && (
              <Link
                href={yachtHref}
                className="group inline-flex items-center gap-3 pb-2 border-b border-[#DAA110]/50 hover:border-[#DAA110] text-[#DAA110] transition-colors duration-500"
                style={{
                  fontFamily: "var(--gy-font-ui)",
                  fontSize: "11px",
                  letterSpacing: "0.4em",
        ...
        <span
          aria-hidden="true"
          className="absolute top-6 left-6 md:top-10 md:left-10 w-8 h-8 md:w-12 md:h-12 border-t border-l border-[#DAA110]/40 pointer-events-none"
        />
        <span
          aria-hidden="true"
          className="absolute top-6 right-6 md:top-10 md:right-10 w-8 h-8 md:w-12 md:h-12 border-t border-r border-[#DAA110]/40 pointer-events-none"
        />
        <span
          aria-hidden="true"
          className="absolute bottom-6 left-6 md:bottom-10 md:left-10 w-8 h-8 md:w-12 md:h-12 border-b border-l border-[#DAA110]/40 pointer-events-none"
        />
        <span
          aria-hidden="true"
          className="absolute bottom-6 right-6 md:bottom-10 md:right-10 w-8 h-8 md:w-12 md:h-12 border-b border-r border-[#DAA110]/40 pointer-events-none"
        />
      </div>
    </section>
  );
