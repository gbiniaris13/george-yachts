  ...
  return (
    <div ref={dropdownRef} className={wrapperClass}>
      <button
        ...
        onMouseEnter={(e) => {
          if (variant === 'inline') {
            e.currentTarget.style.borderColor = 'rgba(218, 161, 16,0.4)';
          }
        }}
        onMouseLeave={(e) => {
          if (variant === 'inline') {
      ...
      {isOpen && (
        ...
        >
          <div style={{
            padding: '12px 16px', borderBottom: '1px solid rgba(218, 161, 16,0.1)',
            fontFamily: "var(--gy-font-ui)", fontSize: 8,
            letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(218, 161, 16,0.4)',
          }}>
            Select Language
          </div>
          {availableLocales.map(lang => (
            <button
              ...
              style={{
                ...
                color: locale === lang.code ? '#DAA110' : 'rgba(248, 245, 240,0.5)',
                background: locale === lang.code ? 'rgba(218, 161, 16,0.06)' : 'transparent',
            ...
            >
              ...
              {locale === lang.code && <span style={{ marginLeft: 'auto', fontSize: 10, color: '#DAA110' }}>✓</span>}
            </button>
          ))}
        </div>
      )}
