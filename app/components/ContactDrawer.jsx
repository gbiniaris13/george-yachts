...
const CONTACT = {
  // Boss's real WhatsApp number — already in WhatsAppButton.
  phone: "+17867988798",
  // iMessage opens with sms: protocol on iOS/macOS. Falls back gracefully.
  ...
  // Boss's email used as Signal username placeholder. Signal doesn't
  // support deep-link to a phone number directly without an existing
  // contact, so we link to a Signal handle URL pattern.
  signalUrl: "https://signal.me/#p/+17867988798",
  ...
  const channels = [
    {
      ...
      href: `https://wa.me/${CONTACT.phone.replace("+", "")}?text=${encodeURIComponent(CONTACT.whatsappMsg)}`,
      icon: (
