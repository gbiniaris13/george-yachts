    ...
    >
      ...
      <div className="relative lg:absolute lg:top-1/2 lg:right-[5%] lg:lg:right-[10%] lg:-translate-y-1/2 z-30 w-full lg:max-w-[500px] px-0 lg:px-6 order-2">
        <div className="bg-[#0D1B2A]/40 lg:bg-[#0D1B2A]/60 backdrop-blur-2xl border border-white/10 p-8 lg:p-12 shadow-[0_40px_100px_rgba(13, 27, 42,0.5)] relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-0.5 bg-linear-to-r from-[#DAA110] via-[#A87E00] to-transparent"></div>
          ...
          >
            ...
            <div
              className={`p-2 border border-white/10 rounded-full transition-all duration-300 ${isCopied ? "bg-white text-black border-white" : "text-[#DAA110] hover:border-[#DAA110]"}`}
            >
              {isCopied ? (
          ...
          <div className="mb-10">
            ...
            <p className="text-[#DAA110] font-sans text-[10px] tracking-[0.5em] uppercase mt-4 opacity-80">
          ...
          <div className="flex flex-col gap-6">
            ...
            <button
              ...
              className="w-full text-black py-5 text-xs font-sans font-bold tracking-[0.4em] uppercase shadow-[0_0_30px_rgba(218, 161, 16,0.2)] hover:shadow-[0_0_50px_rgba(248, 245, 240,0.2)] hover:brightness-110 transition-all duration-300"
              style={{
                background:
            ...
            {yacht.slug?.current && (
              <Link
                ...
                className="w-full bg-transparent border border-white/10 text-white/50 py-4 text-[10px] font-sans font-bold tracking-[0.3em] uppercase transition-all duration-300 hover:bg-white/5 hover:text-[#DAA110] hover:border-[#DAA110]/30 text-center block"
              >
                View Full Details
              </Link>
            )}
