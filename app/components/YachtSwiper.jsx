        ...
        <div className="bg-white border-2 border-[#DAA520] overflow-hidden">
          <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-between h-full">
              ...
              {/* Download Brochure (commented out in original) */}
              {/* <div className="mt-6 mb-2 flex flex-col items-center justify-end space-y-3 md:hidden">
                <button className="px-6 py-3 text-[#DAA520] border-2 border-[#DAA520] font-semibold uppercase tracking-wider rounded-full hover:bg-gray-100 transition duration-300">
                  Download Brochure
                </button>
              </div> */}
            </div>
