  ...
  return [
    {
      ...
      paragraph: t('panels.panel1Text', `From the Cyclades to the Ionian and the Saronic Gulf off Athens, George Yachts places crewed yacht charters across the three grounds it works. The ${FLEET_COUNT} motor yachts and catamarans this house represents are chosen for quality, crew excellence, and guest experience. Whether you envision Mykonos sunsets or Corfu coastlines, your charter begins with a single conversation.`),
