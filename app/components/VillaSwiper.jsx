  ...
  return (
    <section className="max-w-[1440px] mx-auto py-10 px-2">
      ...
      <EnquirePopup
        ...
        yachtName={villa.name} // Passes villa name as the "Re:" subject
      />
          ...
          <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="p-8 md:p-12 flex flex-col justify-between h-full">
              <div className="flex flex-col md:justify-start md:items-start">
                ...
                <div className="flex justify-between items-center pb-6">
                  ...
                  <p className="text-[#0D1B2A] text-xl font-bold">
                    {villa.rentalRates}
                  </p>
                </div>
              </div>
            ...
            <div className="absolute bottom-[-22px] left-1/2 -translate-x-1/2 md:right-[-50px] md:left-auto">
              <button
                ...
                className="px-8 py-3 bg-[#C9A84C] text-black font-bold uppercase tracking-wider rounded-full hover:bg-black hover:text-white cursor-pointer"
              >
                ENQUIRE
              </button>
            </div>
