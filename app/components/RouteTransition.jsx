    ...
    >
      ...
      <span
        ...
        style={{
          ...
          background:
            "linear-gradient(180deg, transparent 0%, rgba(218, 161, 16,0.85) 25%, #DAA110 50%, rgba(218, 161, 16,0.85) 75%, transparent 100%)",
          boxShadow:
            "0 0 16px rgba(218, 161, 16,0.6), 0 0 32px rgba(218, 161, 16,0.3)",
        }}
      />
      <style jsx global>{`
