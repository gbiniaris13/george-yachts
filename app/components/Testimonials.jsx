...
const GoldStar = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="#DAA110" xmlns="http://www.w3.org/2000/svg">
...
export default function Testimonials() {
  return (
    <section className="relative w-full bg-black py-24 md:py-32 overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#DAA110]/15 to-transparent" />

      <div className="relative z-10 max-w-[1100px] mx-auto px-6 md:px-12">
        <Reveal>
          <div className="text-center mb-16">
            <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: "9px", letterSpacing: "0.4em", textTransform: "uppercase", color: "#DAA110", fontWeight: 600, marginBottom: "16px" }}>
              Guest Experiences
            </p>
            <h2 style={{ fontFamily: "var(--gy-font-editorial)", fontSize: "clamp(26px, 3.5vw, 40px)", fontWeight: 300, color: "#F8F5F0", margin: "0 0 16px" }}>
              What Our Guests Say
            </h2>
            <div style={{ width: "60px", height: "1px", background: "linear-gradient(90deg, #B58A0A 0%, #F0C756 38%, #DAA110 62%, #B58A0A 100%)", margin: "0 auto" }} />
          </div>
        </Reveal>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <Reveal key={i} delay={i * 0.12}>
              <div style={{ background: "rgba(218, 161, 16,0.02)", border: "1px solid rgba(218, 161, 16,0.06)", padding: "36px 28px", height: "100%", display: "flex", flexDirection: "column" }}>
                {/* Stars */}
                ...
                {/* Quote */}
                <blockquote style={{ fontFamily: "var(--gy-font-editorial)", fontSize: "16px", fontStyle: "italic", color: "rgba(248,245,240,0.66)", lineHeight: 1.8, margin: "0 0 24px", flex: 1 }}>
                  &ldquo;{t.quote}&rdquo;
                </blockquote>

                {/* Attribution */}
                <div>
                  <div style={{ width: "24px", height: "1px", background: "rgba(218, 161, 16,0.3)", marginBottom: "12px" }} />
                  <p style={{ fontFamily: "var(--gy-font-ui)", fontSize: "9px", color: "#DAA110", letterSpacing: "0.15em", textTransform: "uppercase" }}>
                    {t.attribution}
                  </p>
                </div>
              </div>
