        ...
        <div className="text-center mb-20">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-14">
            ...
            >
              ...
              <div className="text-left">
                <span className="block text-[8px] tracking-[0.22em] uppercase text-white/30" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                  Athens Office
                </span>
                <span className="text-[13px] text-white/50 group-hover:text-white transition-colors duration-300" style={{ fontFamily: "'Montserrat', sans-serif", letterSpacing: "0.05em" }}>
                  +30 697 038 0999
                </span>
              </div>
            </a>

            <span className="hidden sm:block w-px h-8" style={{ background: "rgba(218,165,32,0.12)" }} />
