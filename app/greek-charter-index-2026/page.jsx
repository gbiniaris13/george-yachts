...
export async function generateMetadata() {
  ...
  return {
    ...
    description:
      `Original rate data across the ${FLEET_COUNT} yachts I know first hand: what a week costs by type and size, from EUR 17,000 up, and when the 2027 rate cards open.`,
