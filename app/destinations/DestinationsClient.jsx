...
const ISLANDS = [
  ...
  },
  {
    ...
    tagline: 'An island that could be a country',
    emoji: '🏛️',
    bestFor: 'History, gastronomy, wild landscapes, Minoan civilization, gorges, wine',
    bestMonths: 'April – October',
    anchorage: 'Elounda (luxury, sheltered), Spinalonga Bay (historic), Chania Venetian harbour (atmospheric)',
    restaurants: [
      { name: 'Peskesi', type: 'Cretan heritage cuisine', note: 'In Heraklion. Recipes from 100-year-old cookbooks. Farm-to-table before it was fashionable.' },
      { name: 'Thalassino Ageri', type: 'Seafood', note: 'Chania old harbour. The freshest fish in western Crete. Ask for the daily catch.' },
      { name: 'Ntounias', type: 'Mountain taverna', note: 'In the hills above Rethymno. Lamb cooked underground for 8 hours. Life-changing.' },
    ],
    hiddenGems: ['Balos Lagoon — turquoise water that rivals the Caribbean. Accessible by boat only = your yacht is the ticket.', 'Spinalonga Island — the last leper colony in Europe. Hauntingly beautiful. Tender from Elounda.', 'Samaria Gorge from the sea — anchor at Agia Roumeli at the bottom. See the gorge exit without the 16km hike.'],
    yachtTip: 'Crete is enormous — 260km long. Don\'t try to see it all by yacht. Pick either western Crete (Chania, Balos, Gramvousa) or eastern Crete (Elounda, Spinalonga, Sitia). Western is wilder, eastern is more luxury-oriented.',
    yachts: ['la-pellegrina-1', 'genny', 'above-beyond'],
  },
  {
    id: 'rhodes',
    name: 'Rhodes',
    region: 'Dodecanese',
    tagline: 'Where the Colossus once stood',
    emoji: '🗡️',
    bestFor: 'Medieval history, Knights castle, Lindos, beaches, archaeology',
    bestMonths: 'May – October',
    anchorage: 'Mandraki harbour (iconic, where the Colossus stood), Lindos Bay (stunning), Symi day-trip',
    restaurants: [
      { name: 'Mavrikos', type: 'Fine dining', note: 'In Lindos. Family-run since 1933. Creative Greek cuisine in a rooftop setting with Acropolis views.' },
      { name: 'Ta Kioupia', type: 'Traditional', note: 'Hidden in a residential area. Local grandmother-style cooking. No menu — you eat what she\'s made.' },
      { name: 'Stegna Kozas', type: 'Beach fish taverna', note: 'In Stegna beach. Fresh catch, simple grill, toes in the sand. The real Rhodes.' },
    ],
    hiddenGems: ['Medieval Old Town at night — UNESCO World Heritage. Walk the Street of the Knights after the shops close. Atmospheric beyond words.', 'Prasonisi — where the Aegean meets the Mediterranean. Two seas, one beach. Windsurfers\' paradise.', 'Symi day trip by tender — 45 minutes. The most photogenic harbour in Greece. Pastel neoclassical houses, sponge divers.'],
    yachtTip: 'Rhodes is the launching point for the Dodecanese chain. From here you can reach Symi (45 min), Kos, and even the Turkish coast. Mandraki harbour is where the Colossus once stood — anchoring there is genuinely historic.',
    yachts: ['ad-astra', 'alina', 'crazy-horse'],
  },
  {
    id: 'paros',
    name: 'Paros',
