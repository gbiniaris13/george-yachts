...
const SLUG = "yacht-charter-santorini-couples";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/yacht-charter-santorini-couples` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/yacht-charter-santorini-couples`,
    type: "article",
