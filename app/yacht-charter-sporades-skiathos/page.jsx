...
const SLUG = "yacht-charter-sporades-skiathos";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/yacht-charter-sporades-skiathos` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/yacht-charter-sporades-skiathos`,
    type: "article",
