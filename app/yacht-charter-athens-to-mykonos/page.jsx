...
const SLUG = "yacht-charter-athens-to-mykonos";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/yacht-charter-athens-to-mykonos` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/yacht-charter-athens-to-mykonos`,
    type: "article",
