  ...
  return (
    <div className="space-y-6">
      <p className="text-white/70 max-w-2xl">
        ...
        <code className="ml-2 text-[#DAA110] text-sm">
      ...
      {FEATURED_COMPARISONS.map((c) => (
        <Link
          ...
          className="block border border-white/10 rounded-lg p-6 hover:border-[#DAA110] transition"
        >
          <h2 className="font-cormorant text-2xl text-[#DAA110] mb-2">
            {c.title}
          </h2>
          <p className="text-white/70 text-sm">{c.description}</p>
          <span className="mt-3 inline-block text-xs text-[#DAA110] tracking-widest uppercase">
            View comparison →
          </span>
        </Link>
      ))}
        ...
        <section className="max-w-6xl mx-auto px-6 py-24">
          ...
          {yachtsByOrder.length === 0 ? (
            ...
            <>
              ...
              <div className="grid gap-6 mb-12" style={{ gridTemplateColumns: `200px repeat(${yachtsByOrder.length}, minmax(0, 1fr))` }}>
                ...
                {yachtsByOrder.map((y) => (
                  <Link key={y._id} href={`/yachts/${y.slug}`} className="group">
                    <div className="aspect-[4/3] relative overflow-hidden bg-white/5 mb-3" style={{ border: "1px solid rgba(218, 161, 16,0.2)" }}>
                      {y.imageUrl ? (
                        <Image
                          src={y.imageUrl}
                    ...
                    <h2 className="font-cormorant text-2xl text-white group-hover:text-[#DAA110] transition">
                      {y.name}
                    </h2>
              ...
              {/* Spec rows */}
              <div className="overflow-hidden" style={{ border: "1px solid rgba(218, 161, 16,0.22)" }}>
              ...
              <div className="mt-12" style={{ display: "flex", gap: 16, flexWrap: "wrap", justifyContent: "center" }}>
                <Link
                  ...
                  style={{
                    ...
                    fontWeight: 500,
                    textDecoration: "none",
                    border: "1px solid rgba(218, 161, 16,0.7)",
                    boxShadow: "0 14px 35px -10px rgba(218, 161, 16,0.5), inset 0 1px 0 rgba(248, 245, 240,0.3)",
                  }}
                >
              ...
              <p className="mt-8 text-xs text-white/40 text-center">
                ...
                Weekly rates exclude APA (20-40% by yacht type) and VAT at each yacht's certified rate (5.2-12% in practice) on
