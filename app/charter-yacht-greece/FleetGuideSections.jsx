    ...
    <>
      ...
      <section style={{ padding: "72px 24px" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <h2 style={h2Style}>A sample week, Athens to the Cyclades</h2>
          <p style={bodyStyle}>
