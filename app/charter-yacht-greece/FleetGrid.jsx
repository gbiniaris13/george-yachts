    ...
    >
      ...
      <div className="fleet-card__info">
        ...
        <div className="fleet-card__bottom">
          ...
          <a
            href={`https://api.whatsapp.com/send/?phone=17867988798&text=${encodeURIComponent(`Hi, I'm interested in chartering ${name} - could you share availability and rates?`)}`}
            target="_blank"
