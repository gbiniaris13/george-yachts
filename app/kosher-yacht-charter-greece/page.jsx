...
const SLUG = "kosher-yacht-charter-greece";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/kosher-yacht-charter-greece` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/kosher-yacht-charter-greece`,
    type: "article",
