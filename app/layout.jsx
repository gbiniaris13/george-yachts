...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      `Featured in Forbes (May 2026). ${FLEET_COUNT} curated yachts in Greek waters. Catamaran Fleet (42 sailing and power catamarans) + Motor Yacht Fleet (28 fully crewed motor yachts). IYBA Charter Active Member. Personal broker service from Athens.`,
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
