...
const SLUG = "best-yachts-greece-couples";
...
export const metadata = {
  ...
  alternates: { canonical: `https://georgeyachts.com/best-yachts-greece-couples` },
  openGraph: {
    title: PAGE.seoTitle,
    description: PAGE.seoDescription,
    url: `https://georgeyachts.com/best-yachts-greece-couples`,
    type: "article",
