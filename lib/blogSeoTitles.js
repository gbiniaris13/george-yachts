...
export const BLOG_SEO_TITLES = {
  // 2026-09-24 - the Cyclades islands guide, the informational piece for
  // the "cyclades islands in greece" family. The H1 is 101 characters; the
  // tab keeps the term at 41 + 16.
  "cyclades-islands-greece-guide": "The Cyclades Islands in Greece, Explained",
  // 2026-09-22 - the private yacht cruise piece, written in the vocabulary
  // American clients use (cruise, vacation, trip). The H1 is 83 characters;
  // the tab keeps the term at 41 + 16.
  "private-yacht-cruise-greece": "Private Yacht Cruise in Greece, Explained",
  // 2026-09-19 - the multi-generational Ionian piece. The H1 is 93
  // characters and carries the whole question; the tab keeps the term.
  "multi-generational-family-yacht-charter-ionian":
    "Multi-Generational Yacht Charter, Ionian",
  // 2026-09-18, Ahrefs "title too long": the Corfu cost piece carried its
  // 64-character question into the tab. The H1 keeps the question.
  "yacht-charter-corfu-cost": "Corfu Yacht Charter Cost: Real 2027 Numbers",
  // 2026-09-17 - the crewed luxury piece. The H1 carries the question and
  // the EUR 30,000 all-in figure; the tab keeps the question.
  // 2026-09-17, Ahrefs "title too long": the layout appends " | George
  // Yachts" (16 characters), so a short title must stay at 44 or under
  // for the whole tab to fit in 60. Four blog posts were over; all four
  // now fit. The H1 on the page is untouched.
  "crewed-luxury-yacht-charter-explained":
    "Crewed Luxury Yacht Charter, Explained",
  "yacht-charter-greece-with-young-children":
    "Chartering with Young Children in Greece",
  "best-greek-islands-crewed-yacht-charter-2027":
    "Best Greek Islands for a Crewed Charter",
  "skippered-vs-fully-crewed-yacht-charter-greece":
    "Skippered or Fully Crewed? The Middle Tier",
  // 2026-09-10 - the standards piece. The H1 is 118 characters and says
  // everything; the tab needs the question and the three names.
  "who-sets-crewed-yacht-charter-standards-greece":
    "Greek Charter Standards: MYBA, GYA and Law",
  "discretionary-yacht-charter-services-uhnw-greece":
    "Discretionary Yacht Charter Services, Greece",
  ...
  "greece-vs-croatia-yacht-charter-2026":
    "Greece vs Croatia Yacht Charter: Which Wins",
  ...
  "honeymoon-yacht-charter-greece-2026-romantic-itinerary":
    "Honeymoon Yacht Charter Greece, Privately",
  ...
  "how-much-does-yacht-charter-greece-cost-complete-breakdown":
    "Yacht Charter Greece Cost: EUR 17,000 to 235,000 a Week",
  ...
  "how-far-in-advance-book-greek-yacht-charter-2027":
    "Summer 2027 Is Decided in Autumn 2026",
