...
export function faqItems() {
  ...
  return [
    ...
    },
    {
      ...
      answer:
        `Under the 2026 Greek regime, commercial yacht charters longer than 48 hours carry a reduced ${VAT_PCT}% VAT, so every weekly charter qualifies for the ${VAT_PCT}% rate. Short charters under 48 hours, static stays, and bareboat charters without crew are taxed at the standard 24%.`,
    },
    {
