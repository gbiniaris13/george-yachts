  ...
  return [
    ...
    // The hospitality decade is the part no competing broker can claim.
    {
      ...
      answer:
        ...
        "We own no hulls and hold no central agency mandates, so nothing on our list is a boat we are paid to fill. And George is a licensed sailing skipper through the Olympiacos SFP Sailing Academy with a powerboat licence, who ran charter seasons out of Corfu and operations across the Ionian, Cyclades and Saronic, before which he spent a decade in luxury hospitality operations with the Interni Group in Mykonos, at The Wild Hotel and Ftelia Beach Club, and founded two premium venues in Kifisia. " +
