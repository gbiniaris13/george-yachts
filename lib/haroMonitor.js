...
export function generateHaroDraft(query) {
  ...
  if (queryLower.includes("cost") || queryLower.includes("price")) {
    expertAngle =
      "A 2026 Greek charter on a 35-metre motor yacht runs €120,000-180,000 per week base, plus 30% APA, 13% Greek VAT, and 10-15% crew gratuity - typically a 55% addition to the headline number. Greece is structurally cheaper than the French Riviera (40% premium) and competitive with Croatia at the luxury tier.";
