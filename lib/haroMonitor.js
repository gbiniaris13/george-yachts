...
export function generateHaroDraft(query) {
  ...
  if (queryLower.includes("cost") || queryLower.includes("price")) {
    expertAngle =
      "A 2026 Greek charter on a 35-metre motor yacht runs €120,000-180,000 per week base, plus an APA of roughly 20 to 40% of the base depending on how much fuel the yacht burns, Greek VAT at the yacht's certified rate (6.5-12% typical), and a customary 10-15% crew gratuity calculated on the base alone - typically a 55% addition to the headline number. Greece is structurally cheaper than the French Riviera (40% premium) and competitive with Croatia at the luxury tier.";
    ...
    expertAngle =
      "Greek vs Croatia is the most-asked comparison in 2026. Greece is the bigger sea, three cruising grounds within a week of Athens with alternatives a few miles from every famous anchorage; Croatia is the shorter passage and the larger bareboat market, and usually the cheaper week at the same length. The Greek side is published: on the George Yachts Greek Charter Index a fully crewed week runs from EUR 10,900 for a 14 metre sailing catamaran to EUR 235,000 for a 50 metre motor yacht, per yacht per week, before VAT at the yacht's certified rate of 5.2 to 12 per cent and APA.";
  } else {
    expertAngle =
      "Greek crewed chartering is priced per yacht per week and the figures are published: on the George Yachts Greek Charter Index a fully crewed week runs from EUR 10,900 for a 14 metre sailing catamaran to EUR 235,000 for a 50 metre motor yacht, before Greek VAT, which is invoiced at the yacht's certified rate of 5.2, 6.5, 7.8 or 12 per cent, and APA of 20 to 40 per cent. The house's list holds 88 crewed yachts, 61 of them with a walkthrough video, in three cruising grounds from one country. On the Index, July and August weeks book six to twelve months ahead.";
  }
