...
export function generateHaroDraft(query) {
  ...
  if (queryLower.includes("cost") || queryLower.includes("price")) {
    ...
    expertAngle =
      "Greek yacht chartering at the UHNW tier is structurally different from the broader Mediterranean market: deeper crewed fleet (250+ yachts above 24m), lower VAT regime (certified rates of 5.2-13% vs French 20%), and more cultural variety per charter week than any other Mediterranean coastline. The bottleneck for 2026 is supply - peak July-August is increasingly closed by Q1.";
  }
