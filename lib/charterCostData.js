...
// 2026-06-26 — Greek charter VAT corrected to 13%. Under the 2026 regime the
// reduced 13% rate applies to all commercial charters over 48 hours (every
// weekly charter qualifies). It drops to an effective 12% only when >=60% of
// charter time is spent outside Greek territorial waters; short (<48h) or
// static charters are taxed at 24%. 13% is the right default for a weekly
// charter and aligns this model with /tools/charter-cost-calculator and the
// /weekly-yacht-charter-rates-greece rate card.
