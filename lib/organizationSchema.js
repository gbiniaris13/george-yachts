...
export const organizationSchema = {
  ...
  "description": "Boutique crewed yacht charter brokerage working exclusively in Greek waters - Cyclades, Ionian, Saronic, Dodecanese and Sporades. Catamaran specialists: 37 of the 59 yachts we place are catamarans, 25 sailing and 12 power. Charters are booked by the week. MYBA-standard contracts, IYBA member.",
  ...
  //
  // The fleet says otherwise: 37 of 59 are catamarans, 25 sailing and 12
  // power, against 17 motor yachts and 5 monohulls. Order and specificity
  // are the whole mechanism here, so catamarans lead and each type is its
  // own entity. Motor yachts stay, because 17 of them is real, just not
  // first.
  "knowsAbout": [
