...
export const organizationSchema = {
  ...
  //
  // The fleet: 17 motor yachts, 16 power catamarans, 33 sailing catamarans,
  // 5 monohulls. Every type is now its own entity rather than a blur.
  //
