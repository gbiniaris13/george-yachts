...
const BRAND_GOLD = "#DAA110";
const BRAND_BLACK = "#0D1B2A";
...
<body style="margin: 0; padding: 0; background: ${BRAND_CREAM}; font-family: Georgia, serif;">
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background: ${BRAND_CREAM};">
    <tr><td align="center" style="padding: 24px 16px;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; background: #F8F5F0; border: 1px solid rgba(218, 161, 16,0.15);">
        ...
        <tr><td style="background: ${BRAND_BLACK}; padding: 40px 30px; text-align: center; border-bottom: 1px solid ${BRAND_GOLD};">
          ...
          <h1 style="margin: 0; font-family: Georgia, 'Cormorant Garamond', serif; font-size: 26px; font-weight: 300; color: #F8F5F0; letter-spacing: 0.1em;">
            THE GEORGE YACHTS JOURNAL
          </h1>
          <p style="margin: 14px auto 0; font-family: Georgia, serif; font-size: 14px; font-style: italic; color: rgba(248,245,240,0.66); max-width: 420px; line-height: 1.55;">
        ...
        <tr><td style="padding: 36px 34px 10px;">
          ...
          <p style="margin: 0 0 18px; font-family: Georgia, serif; font-size: 16px; line-height: 1.65; color: #142233; font-weight: 300;">
            ${escape(
              featured.tagline ||
        ...
        <tr><td style="padding: 30px 34px 0;">
          <div style="height: 1px; background: linear-gradient(to right, ${BRAND_GOLD}, rgba(218, 161, 16,0.1));"></div>
        </td></tr>
        ...
        <tr><td style="padding: 30px 34px 40px;">
          <div style="height: 1px; background: linear-gradient(to right, ${BRAND_GOLD}, rgba(218, 161, 16,0.1)); margin-bottom: 24px;"></div>
          <p style="margin: 0 0 10px; font-family: Georgia, serif; font-size: 15px; line-height: 1.7; color: #142233; font-weight: 300;">
          ...
          <p style="margin: 18px 0 0; font-family: Georgia, serif; font-size: 15px; color: ${BRAND_INK}; line-height: 1.5;">
            ...
            <span style="font-size: 12px; color: #9CA3AF;">Managing Broker &middot; George Yachts</span>
          </p>
        </td></tr>
        ...
        <tr><td style="background: ${BRAND_BLACK}; padding: 24px 30px; text-align: center;">
          ...
          <p style="margin: 0; font-family: 'Montserrat', Arial, sans-serif; font-size: 9px; letter-spacing: 0.15em; color: rgba(248, 245, 240,0.3);">
            <a href="${baseUrl}" style="color: rgba(248, 245, 240,0.45); text-decoration: none;">georgeyachts.com</a>
            &nbsp;&middot;&nbsp;
            ${
              unsubscribeUrl
                ? `<a href="${unsubscribeUrl}" style="color: rgba(248, 245, 240,0.45); text-decoration: underline;">Unsubscribe</a>`
