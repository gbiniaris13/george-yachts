...
function buildPage(destinationSlug, durationKey) {
  ...
  return {
    ...
    seoDescription: short
      ...
      : week
        ? `${tpl.durationName} crewed charter from ${place}: EUR ${WEEKLY_INDEX.low} to ${WEEKLY_INDEX.high} a week per yacht on the Index, plus APA and VAT. Departure ${dest.departurePort}, day by day.`
        : `${tpl.durationName} crewed charter from ${place}: quoted per yacht from the weekly Index, EUR ${WEEKLY_INDEX.low} to ${WEEKLY_INDEX.high} a week, plus APA and VAT. Departure ${dest.departurePort}.`,
