...
const TEMPLATES = {
  "3-day": {
    ...
    paceBody:
      ...
      "The yachts that suit a compact programme are the crewed catamarans of 16 to 22 metres and the 20 to 30 metre motor yachts: on the Greek Charter Index 2026 a 16 to 19 metre sailing catamaran runs EUR 18,900 to 48,000 a week, a 20 to 22 metre EUR 31,500 to 43,500, a 22 to 25 metre motor yacht EUR 21,000 to 47,500, per yacht before VAT and APA. Five-night pricing is quoted by the owner from the weekly rate, never assumed.",
...
const WEEKLY_INDEX = { low: "17,000", high: "235,000" };
...
const DEPTH = {
  "yacht-charter-paros-7-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 20 to 22 m sailing catamaran EUR 31,500 to 43,500; 23 to 24 m 54,900 to 90,000; 26 to 31 m motor 35,900 to 75,000 a week net base",
  ...
  "yacht-charter-hydra-7-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 20 to 22 m sailing catamaran EUR 31,500 to 43,500; 22 to 25 m motor 21,000 to 47,500; 26 to 31 m motor 35,900 to 75,000 a week net base",
  ...
  "yacht-charter-lefkada-10-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 20 to 22 m sailing catamaran EUR 31,500 to 43,500; 23 to 24 m 54,900 to 90,000; 26 to 31 m motor 35,900 to 75,000 a week net base; extra days quoted per yacht",
  ...
  "yacht-charter-mykonos-7-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 20 to 22 m sailing catamaran EUR 31,500 to 43,500; 23 to 24 m 54,900 to 90,000; 26 to 31 m motor 35,900 to 75,000; 35 to 40 m 59,900 to 150,000 a week net base",
      "July and August book 6 to 12 months ahead on the Index; June and September list 15 to 25% below peak",
  ...
  "yacht-charter-lefkada-7-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 16 to 19 m sailing catamaran EUR 18,900 to 48,000; 20 to 22 m 31,500 to 43,500; 24 to 31 m crewed sailing yacht 24,000 to 55,000; 26 to 31 m motor 35,900 to 75,000 a week net base",
  ...
  "yacht-charter-athens-7-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 16 to 19 m sailing catamaran EUR 18,900 to 48,000; 20 to 22 m 31,500 to 43,500; 22 to 25 m motor 21,000 to 47,500; 26 to 31 m 35,900 to 75,000 a week net base",
      "July and August book 6 to 12 months ahead on the Index; May, June, September and early October list 15 to 25% below peak",
  ...
  "yacht-charter-paros-3-day": {
    ...
    keyFacts: [
      ...
      "Index 2026 bands: 16 to 19 m sailing catamaran EUR 18,900 to 48,000; 22 to 25 m motor 21,000 to 47,500 a week net base, per yacht",
...
function buildPage(destinationSlug, durationKey) {
  ...
  return {
    ...
    seoDescription: short
      ? `Three days from ${place}: this house writes weekly charters and the five-night Saronic week is the shortest. How a week from ${dest.departurePort} opens.`
      : week
        ? `${tpl.durationName} crewed charter from ${place}: EUR ${WEEKLY_INDEX.low} to ${WEEKLY_INDEX.high} a week per yacht, plus APA and VAT. Departure ${dest.departurePort}, day by day.`
        : `${tpl.durationName} crewed charter from ${place}: quoted per yacht from the weekly Index, EUR ${WEEKLY_INDEX.low} to ${WEEKLY_INDEX.high} a week, plus APA and VAT. From ${dest.departurePort}.`,
    ...
    faq: [
      { q: `How much does a ${tpl.durationName.toLowerCase()} yacht charter from ${dest.name} cost?`, a: short
          ? `This house prices by the week, one price per yacht with the crew included. On the Greek Charter Index 2026 the weekly base runs from EUR ${WEEKLY_INDEX.low} for a 15 metre crewed catamaran to EUR ${WEEKLY_INDEX.high} for the yachts above 50 metres; a 16 to 19 metre sailing catamaran lists at EUR 18,900 to 48,000 and a 22 to 25 metre motor yacht at 21,000 to 47,500. The five-night Saronic week, the shortest programme we write, is quoted by the owner from that weekly rate. Add APA of 20 to 40% by yacht type, Greek VAT at the certified rate (5.2 to 12%) and a gratuity of 10 to 15% of base at your discretion.`
          : `One price per yacht per week with the crew included. On the Greek Charter Index 2026 the weekly base runs from EUR ${WEEKLY_INDEX.low} for a 15 metre crewed catamaran to EUR ${WEEKLY_INDEX.high} for the yachts above 50 metres: a 20 to 22 metre sailing catamaran lists at EUR 31,500 to 43,500, a 26 to 31 metre motor yacht at 35,900 to 75,000, a 35 to 40 metre at 59,900 to 150,000.${week ? "" : " The extra days are quoted by the owner from the weekly rate, per yacht."} Add APA of 20 to 40% by yacht type, Greek VAT at the certified rate (5.2 to 12%) and a gratuity of 10 to 15% of base at your discretion.` },
