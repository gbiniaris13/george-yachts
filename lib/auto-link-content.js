...
const AUTO_LINK_MAP = {
  ...
  // ── Commercial pillar anchors (2026-08-28) ────────────────────
  // The hierarchy cure for the pages Google refuses to associate
  // with their own head terms. GSC 28/8: /sailing-yacht-charter-greece
  // invisible for "sailing yacht charter greece" (1,900 US searches/mo)
  // while two other pages straggle at 33/61; the private page invisible
  // for its own name. Exact-phrase anchors from article copy are the
  // strongest internal vote we can cast. Longest phrases first.
  "luxury yacht charter in Greece": "/luxury-yacht-charter-greece",
  "luxury yacht charter": "/luxury-yacht-charter-greece",
  "sailing yacht charter in Greece": "/sailing-yacht-charter-greece",
  "sailing yacht charter": "/sailing-yacht-charter-greece",
  "crewed sailing yacht": "/sailing-yacht-charter-greece",
  "private yacht charter in Greece": "/private-yacht-charter-greece",
  "private yacht charter": "/private-yacht-charter-greece",
  ...
  // 2026-09-04 (plan item 9, roles in the cost cluster): APA mentions go
  // to the APA explainer, which owns that question; the breakdown post
  // keeps the general "how much" intent and nothing else steals it.
  "Advance Provisioning Allowance": "/advance-provisioning-allowance-apa-greek-yacht-charter-explained",
  "APA": "/advance-provisioning-allowance-apa-greek-yacht-charter-explained",
  ...
  "Motor Yacht Fleet": "/private-fleet",
  "Catamaran Fleet": "/explorer-fleet",

  // ── Tools that ARE live ───────────────────────────────────────
  "itinerary builder": "/itinerary-builder",
  "cost calculator": "/tools/charter-cost-calculator",
  ...
  // 2026-07-03 (Wave 2) — the crewed head page went live 2026-07-02
  // with zero in-content anchors pointing at it. These run FIRST in
  // the cluster (longest phrase first, per the engine rule) so every
  // blog post that says "crewed yacht charter..." feeds the money
  // page with a contextual link.
  "crewed yacht charter in Greece": "/crewed-yacht-charter-greece",
  "crewed yacht charter Greece": "/crewed-yacht-charter-greece",
  "crewed yacht charter": "/crewed-yacht-charter-greece",
  "weekly crewed charter": "/crewed-yacht-charter-greece",
  // Yacht-type roots
  ...
  // Use-case roots
  // 2026-07-11 additions: verification article + Dodecanese cluster
  "verify a yacht charter broker": "/blog/how-to-verify-yacht-charter-broker-credentials-2026",
  "broker credentials": "/blog/how-to-verify-yacht-charter-broker-credentials-2026",
  "Dodecanese": "/yacht-charter-dodecanese-rhodes",
  "honeymoon": "/honeymoon-yacht-charter-greece",
  ...
  "crewed catamaran": "/crewed-catamaran-charter-greece",
  ...
  "Mykonos or Santorini": "/mykonos-vs-santorini-yacht-charter",
  "Santorini vs Mykonos": "/mykonos-vs-santorini-yacht-charter",

  // Tools variations
  "charter cost estimator": "/tools/charter-cost-calculator",
  "Greek charter pricing tool": "/tools/charter-cost-calculator",
  ...
  "private yacht charter Greece 2026": "/private-yacht-charter-greece",
  ...
  // 2026-09-25: this key was a duplicate of the one at line 113 that
  // sends "crewed yacht charter" to the hub. In a JS object the LAST
  // duplicate wins, so since this line was added every in-content anchor
  // for the head term pointed at the glossary definition instead of the
  // money page. Search Console showed the result: the glossary at 7 to 17
  // and the hub at 58 for its own term. The definition keeps a phrase of
  // its own; the head term goes to the hub.
  "what is a crewed charter": "/glossary/crewed-charter",
...
export function autoLinkPortableText(blocks, dynamicTerms = []) {
  if (!blocks || !Array.isArray(blocks)) return blocks;

  // Phase Stage2 (Extra IA) — merge dynamic terms (yacht names sourced from
  // Sanity at render time) with the static map, longest-first so multi-word
  // names win over any single-word substring. Sourcing yacht names live
  // keeps the map free of stale hardcoded vessel names.
  const TERMS = dynamicTerms.length
    ? [...SORTED_TERMS, ...dynamicTerms].sort(([a], [b]) => b.length - a.length)
    : SORTED_TERMS;
