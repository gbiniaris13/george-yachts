...
export const GLOSSARY_TERMS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whyItMatters:
      "APA is the difference between a quoted charter price and the actual cash you will commit. A 35 to 40 metre motor yacht at EUR 60,000 to 120,000 a week on the Greek Charter Index 2026 carries an APA of 30 to 40% of that base before you board, EUR 18,000 to 48,000 held by the captain. If your broker is not framing APA, season, and gratuity in the same conversation as the base fee, you are not talking to a broker who prices whole weeks.",
    examples: [
      {
        title: "Motor yacht, 26 to 31 metres, Athens to the Cyclades, 7 nights",
        body: "Index 2026 band: EUR 40,000 to 65,000 a week. APA at 30 to 40%, EUR 12,000 to 26,000, wired before embarkation. Fuel first, then food, drink and berths; the unspent balance refunded against receipts on the morning you step off.",
      },
      {
    ...
    examples: [
      {
        ...
        body: "Index 2026 band: EUR 40,000 to 65,000 a week. Gratuity at 10 to 15% of the base: EUR 4,000 to 9,750, in cash, one envelope to the captain, who distributes it among the crew.",
      },
      {
...

  {
    ...
    longDefinition:
      ...
      "**Charter-fee anatomy by yacht type, from the Greek Charter Index 2026 (weekly, base only):** motor yachts 22 to 24 m EUR 21,000 to 33,000, 26 to 31 m 40,000 to 65,000, 35 to 40 m 60,000 to 120,000, above 50 m 162,500 to 235,000; crewed sailing yachts 24 to 31 m 24,000 to 49,000; catamarans from 10,900 at 14 m, 18,900 to 27,500 at 16 to 19 m, 31,500 to 43,500 at 20 to 22 m, 56,000 to 90,000 at 23 to 24 m. The Index carries no gulet band. " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription:
      "A crewed luxury yacht charter comes with its crew already aboard: captain, chef, stewardesses. What each one does, and how crew scales from 3 to 25 by yacht size.",
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Some superyachts accept day charters, with very high minimums set by the owner and only outside the peak. In July and August the yachts above 35 metres are on weekly contracts; on the Greek Charter Index 2026 that class lists at EUR 60,000 to 120,000 a week and above 50 metres at 162,500 to 235,000.",
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    longDefinition:
      ...
      "**Superyacht charter market, Greece 2026:** on the Greek Charter Index the yachts above 50 metres list at EUR 162,500 to 235,000 a week net base and the 35 to 40 metre band at EUR 60,000 to 120,000; the largest hulls that visit Greek waters are quoted on request rather than listed.",
    whyItMatters:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    longDefinition:
      ...
      "**LOA and price on the Greek Charter Index 2026 (motor yachts):** 22 to 24 metres EUR 21,000 to 33,000 a week; 26 to 31 metres 40,000 to 65,000; 35 to 40 metres 60,000 to 120,000; above 50 metres 162,500 to 235,000. Price scales faster than length because every additional metre adds crew, fuel, and complexity. " +
