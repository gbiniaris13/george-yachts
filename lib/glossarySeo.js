...
export const GLOSSARY_TERMS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      // what a featured snippet and an AI citation both need.
      {
        ...
        a: "APA stands for Advance Provisioning Allowance. It is often written as Advanced Provisioning Allowance, but Advance is the correct MYBA term. It is the sum you wire before embarkation so the captain has working funds for everything the yacht consumes during your week: fuel, food and drink, port and marina fees, water, customs clearance and laundry. It is not a deposit, not a tip, and not a tax. On a Greek charter it is commonly set at 30% of the base charter fee, lower on a sailing yacht and higher on a fuel-hungry motor yacht, and whatever is left unspent is returned to you at disembarkation against receipts.",
      },
...

  {
    ...
    longDefinition:
      "Crew gratuity is the most personal cost line of a yacht charter and the one most often left out of comparison spreadsheets. MYBA's guidance for charter yacht captains puts the customary tip at **5% to 15% of the base charter fee**, with the top of that band earned by excellent service, and the convention brokers quote in the market is **10% to 15% of base**  -  never of the total invoiced amount (which includes APA, VAT, delivery). " +
      "What sets the percentage: service quality, crew size, charter length, and the guest's personal benchmark. In the Greek market in 2026 the median tip is **10-12%**. Tips below 7% are read by the crew as a signal of dissatisfaction; tips at the top of the range, 15%, are reserved for charters where the crew has gone significantly beyond standard MYBA service. " +
    ...
    examples: [
      ...
      },
      {
        ...
        body: "Gratuity at 15%: €37,500. Reserved for charters where guests felt the crew transformed the experience  -  bespoke shore excursions, private chef interventions, surprise birthday set-pieces.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "10-12% of the base charter fee is the 2026 Greek-market median. 5-7% signals dissatisfaction. 15%, the top of the 10-15% convention, signals exceptional service.",
      },
      {
    ...
    seoDescription:
      "Crew gratuity is 10-15% of the base charter fee, paid in cash at disembarkation. Greek-market 2026 median is 10-12%. Full etiquette guide from George Yachts.",
...

  {
    ...
    whyItMatters:
      "Comparing two yachts by charter fee alone misleads UHNW buyers. A yacht quoted €120,000/week with a 35% APA, 13% VAT, and obligatory €15k delivery costs €192,600 fully loaded (and less if her certified VAT rate is lower)  -  versus a €130,000/week yacht with 25% APA, no delivery, same VAT = €179,400. The 'cheaper' yacht is more expensive once you add everything.",
    examples: [
      {
        title: "Full cost breakdown of a 'mid-market' €100,000 charter",
        body: "Charter fee: €100,000. VAT at the 13% ceiling: €13,000 (a 6.5%-certified yacht would pay €6,500). APA 30%: €30,000. Delivery (Athens to Mykonos return): €8,000. Gratuity 12%: €12,000. **Fully loaded: €163,000**  -  63% above the headline weekly rate.",
      },
      {
        title: "Same yacht, no delivery (already in Mykonos), shoulder pricing",
        body: "Charter fee (June discount): €82,000. VAT at the 13% ceiling: €10,660. APA 30%: €24,600. Gratuity 12%: €9,840. **Fully loaded: €127,100**  -  €36k saved by understanding the timing.",
      },
    ],
    faq: [
      {
