...
export const GLOSSARY_TERMS = [
...

  {
    ...
    longDefinition:
      ...
      "**The questions to ask:** does the yacht have stabilisers, are they zero-speed capable, fin or gyroscopic, when were they last serviced. The fit is a yacht-by-yacht fact stated on each rate card, and this house confirms it with the owner before a name goes on a shortlist. Eight motor yachts we represent state at-anchor or zero-speed stabilisers on their listing: VISTA, SHERO, STAR LINK, SUMMER FUN, PROJECT STEEL, ARIELA, PAREAKI II and LA PELLEGRINA 1; several of the crewed catamarans state stabilisers too, though two hulls barely roll at anchor to begin with.",
    whyItMatters:
    ...
    examples: [
      {
        ...
        body: "VISTA, a Princess 85 built 2020 with stabilisers at anchor and under way, EUR 55,000 to 59,000 a week; SHERO, a Ferretti built 2021, EUR 60,000; STAR LINK, a Falcon 90, EUR 40,000 to 45,000. The Cyclades week for a motion-sensitive party at the quieter end of the band, each rate from the yacht's own card.",
      },
      {
