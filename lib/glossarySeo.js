...
export const GLOSSARY_TERMS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    longDefinition:
      ...
      "**Crew sizes by yacht length, from the rate cards of the yachts this house represents:** 14 to 16 metre crewed catamarans carry a captain and a cook or hostess; 20 to 24 metre catamarans three to five crew; 24 to 28 metre motor yachts four to five (NAYLA four, SHERO five); 30 to 40 metres six to eight (SUMMER FUN seven, PAREAKI II eight); 45 to 50 metres nine to ten (NORTHWIND II nine, KOKOMO NIGHTS ten, LA PELLEGRINA 1 nine); ELYSIUM, 64 metres, 24 to 28. The crew count is on every card. " +
    ...
    examples: [
      ...
      {
        title: "Seven nights on Alegria, a 14 metre Lagoon 46 for eight",
        body: "Captain and cook aboard, from EUR 10,900 a week on the Index: the smallest crewed week this house places, the same preference sheet, the same chef at the table, on a scale where the captain also drives the tender.",
      },
    ],
    faq: [
      {
...

  {
    ...
    longDefinition:
      ...
      "**Bareboat vs crewed cost:** the bareboat operators publish their own weekly rates, per boat, and they sit below a crewed week because you are the crew. On the Greek Charter Index 2026 the smallest crewed week, a 14 metre catamaran with captain and cook, lists from EUR 10,900. The saving is real, but only if the charterer is genuinely qualified and willing to do the work, because bareboat is a vacation that includes labour.",
    whyItMatters:
      "Bareboat is a different product than crewed chartering. UHNW buyers who say 'I want to bareboat' usually want a low-stress crewed week on a smaller yacht  -  in which case they should look at a 14 to 16 metre crewed catamaran with captain and cook, EUR 10,900 to 15,000 a week on the Index (Alegria, My Star), not a bareboat. Asking the right qualifying question is the broker's job.",
    examples: [
      {
      ...
      {
        title: "Crewed instead: a 14 metre catamaran, Ionian, 7 nights",
        body: "Alegria or My Star, a Lagoon 46 with captain and cook: EUR 10,900 to 15,000 a week on the Greek Charter Index 2026, plus APA of 20 to 30% and Greek VAT at the certified rate. Nobody in the party stands a watch, anchors the boat or cooks.",
      },
    ],
    faq: [
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    examples: [
      {
        title: "Spec breakdown, ARIELA, 39.6 metres",
        body: "LOA: 39.6 m (129.11 ft). Builder: CRN. Cabins: 6. Sleeps: 12 guests. Crew: 8. Stabilisers at anchor. Rate card: EUR 105,000 to 120,000 a week. The card carries every one of these lines; the length is the first of them and the least.",
      },
    ],
    faq: [
      {
...

  {
    ...
    longDefinition:
      ...
      "**The questions to ask:** does the yacht have stabilisers, are they zero-speed capable, fin or gyroscopic, when were they last serviced. The fit is a yacht-by-yacht fact stated on each rate card, and this house confirms it with the owner before a name goes on a shortlist. Eleven motor yachts we represent state stabilisers on their listing: NAYLA, SHERO, SUMMER FUN, DALOLI, PROJECT STEEL, OAK, RIANA II, NAIA, ARIELA, PAREAKI II and LA PELLEGRINA 1; several of the crewed catamarans state stabilisers too, though two hulls barely roll at anchor to begin with.",
    whyItMatters:
    ...
    examples: [
      {
        ...
        body: "NAYLA, a Monte Carlo Yachts 80 built 2018 with stabilisers at anchor and under way, EUR 39,500 to 47,500 a week; SHERO, a Ferretti built 2021, EUR 60,000; SUMMER FUN, an Admiral 101 refitted 2026, EUR 45,000 to 65,000. The Cyclades week for a motion-sensitive party at the quieter end of the band, each rate from the yacht's own card.",
      },
      {
        title: "Stabilised with twelve berths",
        body: "SUMMER FUN, an Admiral 101 at 30.8 metres, stabilised both ways and refitted 2026, EUR 45,000 to 65,000; PROJECT STEEL at 34 metres, EUR 55,000 to 67,000; PAREAKI II and ARIELA at 39 to 40 metres; LA PELLEGRINA 1 at 50. The family group's answer to an August week in the Cyclades.",
      },
    ],
    faq: [
      {
