...
// Single source of truth for the UHNW yacht-charter definitions
// that power /glossary and /glossary/[slug] (37 terms as of
// 2026-06 — the GLOSSARY array below is the source of truth).
//
...
export const GLOSSARY_TERMS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    // 2026-08-15 GSC strike: "advanced provisioning allowance" (15 imp,
    // pos 18.1) and "advanced provisioning allowance in yachting" (9 imp,
    // pos 18.0) are the misspelling searchers actually type. It was not
    // listed anywhere on the page.
    alsoKnownAs: [
    ...
    category: "pricing",
    shortDefinition:
      "APA is an upfront sum, and the MYBA contract fixes how it works rather than what it costs: in practice it runs from about 20% of the base charter fee on a sailing yacht to about 40% on a motor yacht, because the figure tracks fuel burn. It is paid before embarkation to cover the yacht's running expenses during your charter: fuel, food, drink, port fees, and laundry.",
    longDefinition:
    ...
    examples: [
      {
        title: "Motor yacht, 26 to 31 metres, Athens to the Cyclades, 7 nights",
        body: "Index 2026 band: EUR 35,900 to 75,000 a week. APA at 30 to 40%, EUR 10,800 to 30,000, wired before embarkation. Fuel first, then food, drink and berths; the unspent balance refunded against receipts on the morning you step off.",
      },
      {
        title: "Sailing catamaran, 20 to 22 metres, Ionian, 7 nights",
        body: "Index 2026 band: EUR 31,500 to 43,500 a week. APA at 20 to 30%, EUR 6,300 to 13,050. A sheltered week under sail burns the least fuel of any yacht type, and most of the float comes back.",
      },
    ],
    faq: [
      {
        q: "Is APA refundable if I spend less than the deposit?",
        a: "Yes. Any APA not consumed during the charter is refunded to you at disembarkation, in cash or by bank wire soon after. The captain provides a full receipt-backed reconciliation.",
      },
      {
        q: "Can the captain ask for additional APA mid-charter?",
        a: "Yes, if the yacht's consumption exceeds the initial estimate (long passages, heavy guest hospitality, premium spirits). A professional captain flags this well before the float runs down and shows the running ledger before requesting a top-up.",
      },
      {
        q: "Is APA the same on a sailing yacht as on a motor yacht?",
        a: "No. Sailing yachts and catamarans burn less fuel and run on 20 to 30% APA. Motor yachts run 30 to 40%, with the fast planing hulls and the yachts above 50 metres at the top of that band.",
      },
      {
    ...
    relatedPages: [
      ...
      { title: "Charter cost calculator", url: "/tools/charter-cost-calculator" },
    ],
    seoTitle: "What Is APA? Advance Provisioning Allowance Explained",
    seoDescription:
      "APA is an upfront sum, 20-40% of base by yacht type, covering running costs: fuel, food, port fees. Full breakdown with real Greek-market numbers.",
...

  {
    ...
    category: "pricing",
    shortDefinition:
      "Gratuity is a separate cash tip paid to the yacht's crew at the end of a successful charter, customarily 10-15% of the base charter fee. It is not included in the charter fee or the APA.",
    longDefinition:
      "Crew gratuity is the most personal cost line of a yacht charter and the one most often left out of comparison spreadsheets. The convention this house quotes, and the one the Greek market works to, is **10 to 15% of the base charter fee, at the guest's discretion**, never of the total invoiced amount (which includes APA, VAT and any positioning fee). " +
      "What sets the percentage: service quality, crew size, charter length, and the guest's own benchmark. Within the band the guest decides; the top of it, 15%, says the crew transformed the week. The percentage is of the base rate on the Greek Charter Index 2026. " +
      "How to pay: cash to the captain at disembarkation, in euros, in a sealed envelope. The captain distributes among the crew according to the yacht's own arrangement. One envelope, to the captain, is the form; splitting it by hand undermines the captain's authority. " +
    ...
    whyItMatters:
      "Gratuity is the line item that determines whether the crew remembers your name and gives you priority next season. The Greek charter community is small, captains talk to each other, and a reputation for fair gratuity opens doors to yachts that are nominally booked out.",
    examples: [
      {
        title: "Motor yacht, 26 to 31 metres, 7 nights, crew of four or five",
        body: "Index 2026 band: EUR 35,900 to 75,000 a week. Gratuity at 10 to 15% of the base: EUR 4,000 to 9,750, in cash, one envelope to the captain, who distributes it among the crew.",
      },
      {
        title: "LA PELLEGRINA 1, 50 metres, 7 nights, nine crew",
        body: "Rate card: EUR 180,000 to 235,000 a week. Gratuity at 10 to 15% of the base: EUR 18,000 to 35,250. The top of the band is for the week the crew made: the shore excursions nobody asked for, the birthday nobody mentioned, the anchorage nobody knew.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "10 to 15% of the base charter fee, at your discretion. The top of the band is for a crew that made the week; the percentage is of the base rate, never of the APA or the VAT.",
      },
      {
      ...
      },
      {
        ...
        a: "The gratuity sits outside the charter fee and the APA and does not appear on the charter invoice; it is handed to the crew, not to the yacht's operating company. How the crew declare it is a matter for them and their flag state, and this house does not advise on tax.",
      },
    ],
    ...
    seoTitle: "Yacht Charter Crew Gratuity: How Much to Tip",
    seoDescription:
      "Crew gratuity is 10 to 15% of the base charter fee, at your discretion, paid in cash to the captain at disembarkation. Full etiquette guide from George Yachts.",
...

  {
    ...
    examples: [
      {
        ...
        body: "Alimos to Mykonos is 90 nautical miles on the house table: four to five hours on a planing hull at 22 to 25 knots, about ten at a displacement nine. The delivery is quoted per yacht by the owner on the delivery line, usually the yacht's daily rate for the days at sea plus fuel, and it is a figure to ask for on the specific yacht rather than to estimate.",
      },
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. In Greece in 2026 delivery is invoiced at the same VAT rate as the charter fee, whatever certified rate applies to that yacht.",
      },
      {
    ...
    seoTitle: "What Is a Yacht Charter Delivery Fee?",
    seoDescription:
      "Delivery fees cover repositioning the yacht to your embarkation port. Often negotiable, sometimes waivable, with real Greek-market numbers.",
...

  {
    ...
    alsoKnownAs: ["Greek Charter VAT", "Charter VAT 5.2-13%", "Greek Yacht Tax"],
    category: "pricing",
    shortDefinition:
      "Greek charter VAT has two statutory rates: 13% for commercial crewed charters longer than 48 hours (every weekly charter) and 24% for short, static or bareboat arrangements. In practice most weekly charters are invoiced BELOW the statutory figure: 2026 rate sheets show 5.2%, 6.5%, 7.8% or 12% depending on the yacht's certification and itinerary. Your written quote states the exact rate for the specific yacht.",
    longDefinition:
      "Greece sets a **reduced statutory VAT rate of 13% on commercial crewed yacht charters that exceed 48 hours** (Law 5073/2023), with the **standard 24%** applying to short charters of 48 hours or less, static charters and bareboat. On top of that sits a licence-based reduction system: yachts holding the relevant certification (the Protocol of General Inspection classification) are invoiced on a reduced taxable value, cutting the effective rate by 40 to 60% depending on the certification and the itinerary. " +
      "**What 2026 rate sheets actually show, yacht by yacht:** 5.2% on large yachts certified for international cruises (we see it on 44 to 50 metre charters), 6.5% on yachts certified for Greek-waters cruises (common on crewed catamarans and certified motor yachts of every size), 7.8% on some short-range Argosaronic itineraries, and 12% on yachts invoiced from the 24% base with a 50% reduction (common on motor yachts without the lower certification). The same model of yacht can carry a different rate than her sister ship, because the rate follows the individual yacht's papers, not the type. " +
      ...
      "Even at the statutory ceiling, Greece is one of the most favourable charter VAT regimes in the Mediterranean: level with Croatia's 13% and well below Spain (21%) and Italy (22%). With the certification reductions, the invoiced Greek rate is frequently the lowest in the Mediterranean outright.",
    whyItMatters:
      "VAT is a real five-figure line item on a luxury charter, and the certified rate is money in your pocket: on a €150,000 week, 6.5% instead of 13% is €9,750 back. A broker who quotes every yacht at one flat rate, any flat rate, is not reading the yacht's papers. George quotes the exact certified rate for each yacht in writing before you commit.",
    examples: [
      {
        title: "€150,000 weekly crewed charter on a yacht certified at 6.5%",
        body: "VAT at 6.5%: €9,750. Total invoice: €159,750 + APA + gratuity. The same week on a 12% yacht carries €18,000 of VAT, and the statutory ceiling of 13% would be €19,500. The certification difference is real money.",
      },
      {
        title: "Short charter of 48 hours or less, or a static charter",
        body: "These fall under the standard 24% statutory rate rather than 13%, before any certification-based reduction. A day charter or a yacht hired while it stays on the berth does not qualify for the weekly crewed treatment.",
      },
    ],
    faq: [
      {
        q: "Is Greek charter VAT 13%, 12% or 6.5%?",
        a: "All of these exist, plus 5.2% and 7.8%, because the invoiced rate follows the individual yacht's certification and itinerary. The statutory rates are 13% for crewed charters over 48 hours and 24% otherwise; licence-based reductions of 40 to 60% then produce the invoiced figures. On 2026 rate sheets, weekly charters run from 5.2% on large internationally certified yachts, through 6.5% and 7.8%, to 12%. Your quote states the exact rate for your yacht.",
      },
      {
        q: "Is VAT included in the charter quote?",
        a: "Some brokers quote pre-VAT (cleaner for comparison), some quote inclusive. Always ask: 'Is this number gross or net of VAT, and at which certified rate?' The difference between 5.2% and 13% matters at scale.",
      },
      {
      ...
      },
      {
        ...
        a: "Yes, and it is built into the system rather than a trick: charter a yacht whose certification carries the reduced taxable value. That is the difference between 13% and 6.5% or 5.2% on the invoice, and it is one of the specific things George checks when shortlisting yachts for you. The rate is set by the yacht's papers and the itinerary, and it is stated in your contract.",
      },
    ],
    ...
    seoTitle: "Greek Charter VAT: The Rate That Lands on Your Invoice",
    seoDescription:
      "Greek charter VAT in practice: 5.2%, 6.5%, 7.8% or 12% by the yacht's certification, under the statutory 13%/24%. What 2026 rate sheets actually show.",
...

  {
    ...
    longDefinition:
      "MYBA  -  the **Mediterranean Yacht Brokers Association**  -  publishes the standard form charter agreement that most crewed charters in the Mediterranean use, and every charter this house writes. The MYBA form is the equivalent of an ISDA in finance: a known, predictable, lawyer-tested document that protects both charterer and yacht owner, and that no serious broker would deviate from without explicit reason. " +
      ...
      "**Why MYBA over a bespoke contract:** your counsel will recognise MYBA, and a bespoke contract costs review time the form does not. Owners prefer the form because it protects their asset under a known liability regime, and it has been refined over decades of real-world disputes, so most edge cases are already resolved on the page. " +
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Your own counsel will recognise the form, and a lawyer familiar with MYBA spots non-standard amendments quickly. This house sends the completed agreement before signature so you can have it reviewed if you wish; the decision is yours and nothing moves until you are comfortable.",
      },
      {
    ...
    seoTitle: "MYBA Charter Contract: The Standard Agreement",
    seoDescription:
      "MYBA is the standard charter contract of the Mediterranean and of every charter this house writes. Clauses, deposits and protections explained.",
...

  {
    ...
    longDefinition:
      ...
      "**What the charter fee does NOT include  -  the four other cost buckets:** (1) APA at 20-40% of the charter fee by yacht type, covering fuel, food, drink, and port fees; (2) Greek VAT at the yacht's certified rate (5.2-13%) on the charter fee + delivery; (3) Delivery fee if the yacht must reposition; (4) Crew gratuity at 10-15% of the charter fee, paid at disembarkation. " +
      "**Charter-fee anatomy by yacht type, from the Greek Charter Index 2026 (weekly, base only):** motor yachts 22 to 25 m EUR 21,000 to 47,500, 26 to 31 m 35,900 to 75,000, 35 to 40 m 59,900 to 150,000, above 50 m 162,500 to 235,000; crewed sailing yachts 24 to 31 m 24,000 to 55,000; catamarans from 17,000 at 15 m, 18,900 to 48,000 at 16 to 19 m, 31,500 to 43,500 at 20 to 22 m, 54,900 to 90,000 at 23 to 24 m. The Index carries no gulet band. " +
      "**Seasonal multipliers on the base fee:** July-August carries the highest rate (the published number). The Greek Charter Index puts the shoulder months, May and late September to October, at 15 to 25% below peak pricing, and April and late October lower still on many rate cards. May and shoulder-September are the sweet spot for value-quality balance.",
    whyItMatters:
      "Comparing two yachts by charter fee alone misleads. A 26 to 31 metre motor yacht at EUR 35,900 to 75,000 on the Greek Charter Index 2026 carries APA of 30 to 40%; a 20 to 22 metre catamaran at 31,500 to 43,500 carries 20 to 30%; the VAT depends on each yacht's certification, 5.2 to 12%; a positioning fee, where one applies, is quoted per yacht by the owner. The all-in figure is the one to compare, and the calculator produces it for any band.",
    examples: [
      {
        title: "Full cost of a 26 to 31 metre motor yacht week at the top of its band",
        body: "Charter fee: EUR 65,000. APA at 35%: EUR 22,750. VAT on the fee at a 6.5% certification: EUR 4,225 (the 13% ceiling would be 8,450). Gratuity at 12%: EUR 7,800. **All-in before any positioning fee: about EUR 99,775.** Positioning, where the yacht must move to meet you, is quoted per yacht by the owner.",
      },
      {
        title: "Same yacht in June, 20% below peak on the Index",
        body: "Charter fee: EUR 52,000. APA at 35%: EUR 18,200. VAT at 6.5%: EUR 3,380. Gratuity at 12%: EUR 6,240. **All-in: about EUR 79,820**, the shoulder saving on the Index, same yacht, same crew, same islands.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "On standard yachts in peak season (July and August), rarely. On shoulder dates and on yachts with open calendars some owners move; any reduction is the owner's decision, quoted per yacht, never assumed. A broker who never asks is not advocating for you.",
      },
      {
        q: "What's the difference between weekly charter fee and daily rate?",
        a: "Crewed charters are quoted weekly because the seven-night week is the operational standard and the Index is built on it. The five-night Saronic week, the shortest programme this house writes, is quoted by the owner from the weekly rate. Anything shorter is day hire, a different business with different operators.",
      },
    ],
    ...
    seoTitle: "Yacht Charter Fee: What's Included & What's Not",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    longDefinition:
      ...
      "**Crew sizes by yacht length, from the rate cards of the yachts this house represents:** 15 to 16 metre crewed catamarans carry two or three, a captain with a cook-hostess or with a cook and hostess; 20 to 24 metre catamarans three to five crew; 24 to 28 metre motor yachts four to five (NAYLA four, FREEDOM four); 30 to 40 metres six to eight (SUMMER FUN seven, PAREAKI II eight); 45 to 50 metres nine to ten (NORTHWIND II nine, KOKOMO NIGHTS ten, LA PELLEGRINA 1 nine); ELYSIUM, 64 metres, 24 to 28. The crew count is on every card. " +
      ...
      "**The long answer:** what a crewed luxury charter is, who is aboard and what a week in Greece costs all-in from EUR 30,000, with the yachts named, is set out in [the crewed luxury yacht charter article](/blog/crewed-luxury-yacht-charter-explained). The rates by yacht type and the fleet itself are on [crewed yacht charter Greece](/crewed-yacht-charter-greece), the page this definition supports.",
    whyItMatters:
    ...
    examples: [
      {
        title: "Seven nights on PAREAKI II, 39 metres, twelve guests",
        body: "Crew of eight. Daily routine: breakfast on demand, morning swim or shore excursion, lunch aboard or ashore, afternoon on the toys, sunset cocktails, dinner aboard. The guest principal sets every variable; the captain sets the anchorage.",
      },
      {
        title: "Seven nights on EFFIE STAR, a 15.6 metre Lagoon 51 for ten",
        body: "Captain and cook-hostess aboard, from EUR 17,000 a week on the Index: the smallest crewed week this house places, the same preference sheet, the same chef at the table, on a scale where the captain also drives the tender.",
      },
    ],
    faq: [
      {
        q: "Do I tip the crew on a crewed charter?",
        a: "Yes. Crew gratuity of 10-15% of the base charter fee is paid in cash at disembarkation. See our Gratuity glossary entry for the full convention.",
      },
      {
      ...
      // 2026-07-27 GSC strike: "crew coordination luxury yacht charter"
      // (38 impressions, position 28.6) ranked here with no answer on how
      // crew coordination actually works before and during the week.
      {
        q: "Who coordinates the crew on a luxury yacht charter?",
        a: "The captain runs the crew aboard; the broker runs the coordination before you board. It works in three stages. Before the charter, you complete a preference sheet (menus, allergies, drinks, bed configuration, celebrations, children's ages, water toys, pace) and the broker passes it to the captain and chef so provisioning is bought against your answers, not a generic list. On embarkation day the captain holds a short briefing: safety, the week's weather picture, and the shape of day one. During the week, the daily rhythm is set at breakfast between you and the captain, and the crew reorganises around it. You never task individual crew members; one conversation with the captain moves the whole boat.",
      },
      {
        q: "How far ahead should the crew be briefed?",
        a: "Fourteen days before embarkation is the working standard, and it is the difference between a good week and a seamless one. Specialist requests need longer: certified kosher provisioning wants 3 to 5 days' ordering lead on top, a children's programme or a dive instructor is a crew-placement question best raised at booking, and specific water toys (e-foils, Seabobs) have to be on the yacht before she leaves her home port.",
      },
    ],
    ...
    // 2026-08-06 (job 19) — this page carries 182 impressions across
    // "what is a crewed luxury yacht charter", its question-mark variant, and
    // "what is a crewed yacht charter", at positions 17.1, 19.7 and 45.6, and
    // it has taken ZERO clicks in 90 days. Two reasons, both in the snippet.
    // The searcher types "luxury" and the title did not contain it. And the
    // description opened by dating itself to 2026, which is the wrong year to
    // wave at someone in August planning next summer. "The Standard" told
    // nobody anything; the crew ladder is the thing worth clicking for.
    seoTitle: "What Is a Crewed Luxury Yacht Charter? Captain, Chef, Crew",
    seoDescription:
      "A crewed luxury yacht charter comes with its crew already aboard: captain, chef, stewardesses. What each does, and how crew scales from 3 to 25 by yacht size.",
...

  {
    ...
    longDefinition:
      ...
      "**Bareboat vs crewed cost:** the bareboat operators publish their own weekly rates, per boat, and they sit below a crewed week because you are the crew. On the Greek Charter Index 2026 the smallest crewed week, a 15 metre catamaran with captain and cook-hostess, lists from EUR 17,000. The saving is real, but only if the charterer is genuinely qualified and willing to do the work, because bareboat is a vacation that includes labour.",
    whyItMatters:
      "Bareboat is a different product than crewed chartering. UHNW buyers who say 'I want to bareboat' usually want a low-stress crewed week on a smaller yacht  -  in which case they should look at a 15 to 16 metre crewed catamaran with captain and cook, EUR 17,000 to 22,000 a week on the Index (EFFIE STAR, BABALU), not a bareboat. Asking the right qualifying question is the broker's job.",
    examples: [
      {
        title: "Standard bareboat, 45-foot sailing yacht, Cyclades, 7 nights",
        body: "Charter fee: quoted by the bareboat operator, per boat per week. APA: not applicable, you provision yourselves. Fuel and marina fees: paid as you go. The cost is the fee plus your time, your qualifications and the work.",
      },
      {
        title: "Crewed instead: a 15.6 metre catamaran from Athens, 7 nights",
        body: "EFFIE STAR, a Lagoon 51 with captain and cook-hostess: EUR 17,000 to 22,000 a week on the Greek Charter Index 2026, plus APA of 20 to 30% and Greek VAT at the certified rate. Nobody in the party stands a watch, anchors the boat or cooks.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: "Bareboat operators include basic hull insurance with a deductible and sell a waiver against it; both figures are theirs to quote. On a crewed charter under the MYBA form the owner's insurance covers the yacht and the crew, and the charterer's exposure is the security deposit.",
      },
      {
        q: "Can I hire a skipper for a bareboat yacht?",
        // 2026-08-21 (section 5). This answered "yes" and then quoted the
        // daily rate, which is a how-to-buy for a product this house does
        // not broker. The term still gets defined, because that is what a
        // glossary is for; what it no longer does is tell somebody how to
        // arrange one and leave them assuming we would.
        a: "Bareboat operators generally can, and the arrangement is usually called a skippered charter: a professional aboard to run the boat, without the chef and interior crew of a full charter. It is not something George Yachts brokers. This house writes fully crewed weeks only, so if that is what you are after a Greek bareboat operator is the right call and we will say so.",
      },
    ],
    ...
    seoTitle: "Bareboat Yacht Charter Greece: Rules & Costs",
    seoDescription:
      "Bareboat chartering means renting a yacht without crew: you skipper, and need sailing certifications. Full guide to the Greek bareboat market.",
    canonical: "https://georgeyachts.com/glossary/bareboat-charter",
  },

  // 2026-07-23 — kosher vertical (George's call after an Israeli inquiry).
  // Facts verified against chabad.gr + chabad.org the same day; see the
  // /kosher-yacht-charter-greece pillar for the full sourcing note.
  {
    slug: "kosher-charter",
    term: "Kosher Charter",
    alsoKnownAs: ["Kosher Yacht Charter", "Glatt Kosher Charter", "Shomer Shabbat Charter"],
    category: "charter-types",
    shortDefinition:
      "A kosher charter is a crewed yacht charter where the galley, provisioning and often the itinerary are arranged to meet Jewish dietary law (kashrut) and, when requested, Shabbat observance. In Greece this is genuinely achievable: glatt kosher catering from Athens delivers across the country, including Mykonos and Santorini.",
    longDefinition:
      "A kosher charter adapts three layers of a normal crewed charter. **The food:** options range from sealed glatt kosher meals prepared under rabbinic supervision and delivered to the yacht (3-5 days ordering lead), to the yacht's chef cooking exclusively kosher ingredients with disposable or dedicated equipment, up to a fully koshered galley arranged with the guest's rabbi. **The crew briefing:** what enters the galley, which equipment is reserved, and what does not happen between Friday sunset and Saturday night, all agreed in writing before boarding. **The itinerary:** for Shabbat-observant guests the yacht moors or anchors before candle-lighting on Friday and does not cruise until after havdalah, with the route planned around that rest day rather than against it. " +
      "Greece is unusually well suited to kosher chartering: Chabad houses operate in Athens, Thessaloniki, Mykonos, Crete and Rhodes; Mykonos has a kosher shop and kosher catering; and Athens is roughly a 2-hour nonstop flight from Tel Aviv with about 50 direct flights weekly in season.",
    whyItMatters:
      "For observant families the kosher layer decides whether a charter happens at all. A broker who arranges certified provisioning, briefs the crew in writing and designs the route around Shabbat removes the single biggest barrier between an observant family and a week in the Cyclades - and Greece's real kosher infrastructure makes it work in practice, not just on paper.",
    examples: [
      {
        title: "Shabbat-aware Cyclades week, crewed catamaran",
        body: "Sunday embark from Athens after the morning Tel Aviv flight. Kea, Syros, Mykonos midweek with a Chabad evening ashore, Delos and Rhenia, then moored at Mykonos before Friday sunset. Shabbat at rest, Saturday-night sail, Athens disembark.",
      },
      {
        title: "Sealed glatt meal service on a 30m motor yacht",
        body: "Glatt kosher meals prepared in Athens under rabbinic supervision, delivered sealed to the yacht before departure and restocked at Mykonos. The galley serves the rest of the party normally; the kosher service stays sealed end-to-end.",
      },
    ],
    faq: [
      {
        q: "Can a non-kosher yacht serve kosher food?",
        a: "Yes, with the right format. Sealed glatt meal service works on any yacht because nothing is cooked aboard. Stricter standards - dedicated equipment or a koshered galley - are arranged case by case and agreed with the guest (and their rabbi, if desired) before the charter.",
      },
      {
        q: "Does a kosher charter cost more?",
        a: "The yacht's base rate does not change. Kosher catering and island delivery are provisioning costs that run through the APA, and lead time matters more than money: glatt delivery to the islands needs 3-5 days notice.",
      },
      {
        q: "Can the yacht sail on Shabbat?",
        a: "That is the guest's call, not the broker's. For Shabbat-observant parties the itinerary is designed so the yacht is moored or anchored before Friday sunset and stays at rest until Saturday night; other guests simply enjoy a slower mid-charter day.",
      },
    ],
    relatedTerms: ["crewed-charter", "apa", "preference-sheet", "charter-fee"],
    relatedPages: [
      { title: "Kosher yacht charter in Greece - the full guide", url: "/kosher-yacht-charter-greece" },
      { title: "Greek charter for Israeli clients", url: "/yacht-charter-greece-israeli-clients" },
      { title: "2027 charter calendar - join the priority list", url: "/yacht-charter-greece-2027" },
    ],
    seoTitle: "Kosher Charter Meaning: How It Works in Greece",
    seoDescription:
      "What a kosher yacht charter is, how glatt provisioning and Shabbat-aware itineraries work aboard, and why Greece is the most kosher-capable option.",
    canonical: "https://georgeyachts.com/glossary/kosher-charter",
  },

  {
    ...
    category: "charter-types",
    // 2026-08-06 (George's call) — the site is coming out of day charter
    // entirely. We broker weekly fully crewed charters, and a site that also
    // appears to sell day hire is a site that reads as a general boat agency
    // to both a reader and a language model. The URL stays, because it holds
    // real search visibility and because a glossary that refuses to define a
    // common term is a worse glossary. What changes is the position: this
    // defines the term, states plainly that it is not our product, and shows
    // the arithmetic that sends a serious buyer to the week.
    shortDefinition:
      "A day charter is a yacht hire of 8-12 hours, embarking and disembarking the same day from the same port. George Yachts does not broker day charters: we place weekly fully crewed charters only. The definition and the pricing reality are below, because the comparison is worth understanding before you book either.",
    longDefinition:
      ...
      "**Day charter pricing in Greece:** quoted by the day-hire operators themselves, per boat per day, and it rises steeply with length and with the month. This house publishes no day rates because it places none; the weekly figures it does publish are on the Greek Charter Index 2026, one price per yacht per week with the crew included. " +
      "**What a day-hire operator typically includes:** the crew, fuel for a normal day's running, basic food and drink, snorkelling gear. Catering, longer routes and marina fees elsewhere are quoted on top. " +
    ...
    whyItMatters:
      "Day charter is the product buyers ask for when they don't yet know they want the five-night Saronic week, the shortest programme this house writes. Three day hires in one trip cost more than a crewed week on a 16 to 19 metre sailing catamaran at EUR 18,900 to 48,000 on the Greek Charter Index 2026, and give you none of the nights aboard. A good broker asks 'How many days are you in Greece?' before answering 'How much for a day?'",
    examples: [
      {
        title: "The arithmetic from Athens",
        body: "Three day hires from the Athens Riviera in one week, each back at base by evening, against the five-night Saronic week from Alimos: Aegina 18 nautical miles, Poros 25, Hydra 35 on the house table, every night aboard, the chef cooking from the APA, the five nights quoted by the owner from the weekly Index rate.",
      },
      {
        title: "The Mykonos comparison",
        body: "A day hire on a 35 metre motor yacht in July is quoted by its operator per day. The same class on the Index lists at EUR 59,900 to 150,000 for a week with the crew, and for a party already on the island the week reaches Delos, Paros, Naxos and Santorini, 80 nautical miles south, which no day trip returns from.",
      },
    ],
    faq: [
      // 2026-07-14 - Brand Radar missed query: "Athens private boat tour
      // 1 day with skipper" had no exact-match answer on the site.
      // 2026-08-06 (George's call) — this answer used to open with "Yes." and
      // read as an offer. George Yachts brokers weekly fully crewed charters
      // and does not broker day hire. The page keeps its glossary duty, which
      // is to define the term accurately and to be citable, but it no longer
      // sells something we do not sell. The tax point stays because it is a
      // real and useful difference most day-hire buyers are never told.
      {
        q: "Can I book a private one-day boat tour from Athens?",
        a: "Not through us. George Yachts brokers weekly fully crewed charters, and day hire is a different business with different operators, so we would be the wrong introduction. If a single day is genuinely what you want, book directly with a day-hire operator out of Alimos, Flisvos or the Athens Riviera marinas. One thing worth knowing before you do: charters of 48 hours or less carry Greek VAT at the standard 24%, while a weekly crewed charter is taxed at its yacht's reduced certified rate, so the per-day cost gap is wider than the headline prices suggest.",
      },
      // 2026-08-01 SD-1 — cannibalization fix. GSC July: "motor yacht
      // charter greece prices" ranked BOTH /weekly-yacht-charter-rates-greece
      // (11.7) and this glossary page (19.6), splitting the signal. This FAQ
      // answers the weekly-intent visitor honestly and hands the exact-match
      // anchor to the page that should own the query.
      {
        q: "I searched for weekly prices and landed here - where is the weekly rate card?",
        a: "This page covers single-day hire. For weekly figures, our motor yacht charter Greece prices are published on the weekly rate card at /weekly-yacht-charter-rates-greece, listed by yacht size and season from the live rate cards of the yachts here, with the APA, VAT and gratuity layers broken out so the all-in number is visible before you inquire.",
      },
      // 2026-08-01 SD-1.1 — "day yacht" (22 impressions, pos 10.7) was in
      // the mined table and got skipped in batch #1; George's honesty check
      // caught the silent omission.
      {
        q: "What is a day yacht?",
        a: "A day yacht is simply a yacht set up for single-day hire: crewed, provisioned for a day's running, and back at base by evening. In Greece that fleet runs from small motor boats to 40m superyachts. We do not place day yachts. The reason is not snobbery, it is that the two products are not comparable: if you book a day yacht more than twice in the same trip you have already spent more than a short crewed charter would have cost, and you have had none of the week.",
      },
      {
        q: "Can I sleep aboard on a day charter?",
        a: "No. A day charter explicitly excludes overnight accommodation. If you want to sleep aboard, you book a crewed charter; the shortest this house writes is the five-night Saronic week from Athens.",
      },
      {
        q: "What's the difference between day charter and term charter?",
        a: "Day charter: same-day embarkation and disembarkation. Term charter: nights aboard, typically seven, with bespoke service and itinerary; the five-night Saronic week is the shortest programme this house writes.",
      },
      {
        q: "Is a day charter cheaper than a week charter divided by 7?",
        a: "No. A day-hire operator prices the crew time, the fuel and the week he cannot sell into the single day, so a day is a far larger share of a weekly rate than one seventh. The weekly rate on the Greek Charter Index 2026 is one price per yacht with the crew included.",
      },
      // 2026-07-22 feeder: GSC shows day-intent queries landing here (991
      // impressions) while the business sells weeks — answer the question
      // they haven't asked yet.
      {
        q: "We are in Greece for a week anyway. Is one day on a yacht the right call?",
        a: "Honestly, usually not. If you have five to seven days in Greece, two or three day charters cost more than the five-night Saronic week where you sleep aboard, wake in a different bay, and the chef cooks to your taste. Tell us your dates and party size and we will price the week, with no obligation. The 2027 weekly calendars are already open for those planning ahead.",
      },
      {
        q: "Can I do a day charter on a superyacht?",
        a: "Some superyachts accept day charters, with very high minimums set by the owner and only outside the peak. In July and August the yachts above 35 metres are on weekly contracts; on the Greek Charter Index 2026 that class lists at EUR 59,900 to 150,000 a week and above 50 metres at 162,500 to 235,000.",
      },
    ],
    relatedTerms: ["crewed-charter", "bareboat-charter", "charter-fee", "tender"],
    relatedPages: [
      { title: "2027 charter calendar - join the priority list", url: "/yacht-charter-greece-2027" },
      // SD-1: the crawlable exact-match anchor for the query this page was
      // cannibalizing from the weekly rate card (FAQ text alone is not a link).
      { title: "Motor yacht charter Greece prices - weekly rate card", url: "/weekly-yacht-charter-rates-greece" },
      { title: "Full fleet", url: "/charter-yacht-greece" },
      { title: "Charter cost calculator", url: "/tools/charter-cost-calculator" },
    ],
    // 2026-08-06 (job 8) — third cannibalisation of the day. This page was
    // ranking 17.8 on "motor yacht charter greece prices", a weekly-intent
    // query, purely because its title carried a price range with no unit.
    // /weekly-yacht-charter-rates-greece owns that query and sits at 11.1.
    // "Per Day" makes the unit explicit so the two stop overlapping, and it is
    // a better title for its own term either way.
    // 2026-08-06 — first attempt dropped the phrase "Day Yacht Charter
    // Greece" from this title entirely. That was wrong and George caught the
    // principle: this page holds 1.860 impressions and 11 clicks at position
    // 11.2, and that phrase is what holds them. Goal one is the ranking. So
    // the matching phrase stays at the front and the weekly frame follows it,
    // which changes what the reader is told without throwing away the
    // position that lets us tell them anything at all.
    seoTitle: "Day Yacht Charter Greece vs a Full Week: The Arithmetic",
    seoDescription:
      "What a day charter costs in Greece, and the arithmetic that sends most serious buyers to a full crewed week instead. Published by a weekly-only brokerage.",
...

  {
    ...
    seoTitle: "Cabin Yacht Charter: What It Is & Pricing",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    longDefinition:
      ...
      "**Superyacht charter market, Greece 2026:** on the Greek Charter Index the yachts above 50 metres list at EUR 162,500 to 235,000 a week net base and the 35 to 40 metre band at EUR 59,900 to 150,000; the largest hulls that visit Greek waters are quoted on request rather than listed.",
    whyItMatters:
    ...
    examples: [
      {
        title: "Entry to the class: SUMMER FUN, 30.8 metres",
        body: "Admiral 101, six cabins for twelve, seven crew, stabilised at anchor and under way, EUR 45,000 to 65,000 a week on the rate card: the volume of a superyacht at the price of the 26 to 31 metre Index band.",
      },
      {
        title: "The top of the Greek list: LA PELLEGRINA 1, 50 metres",
        body: "Couach 164, five cabins for twelve, nine crew, EUR 180,000 to 235,000 a week. Above her, ELYSIUM at 64 metres is certified for up to 49 guests at EUR 162,500. The yachts above 70 metres are rare in Greek waters and mostly base in Monaco or Antibes; this house does not pretend to represent them.",
      },
    ],
    faq: [
      {
    ...
    seoTitle: "What Is a Superyacht? Definition & Sizes",
    seoDescription:
...

  {
    ...
    examples: [
      {
        ...
        body: "Charter fee: €650,000. APA 30%: €195,000. VAT at the 13% ceiling: €84,500 (many yachts this size certify at 5.2%, €33,800). Gratuity 12%: €78,000. Total fully loaded: €1,007,500.",
      },
      {
    ...
    seoTitle: "Megayacht Charter: What Defines a Megayacht",
    seoDescription:
      "A megayacht is an informal term for 50m+ superyachts. Above 50 metres the Greek Charter Index lists EUR 162,500 to 235,000 a week net base.",
...

  {
    ...
    seoTitle: "What Is a Motor Yacht? Speed, Range, Stabilisers",
    seoDescription:
...

  {
    ...
    seoTitle: "What Is a Sailing Yacht? Sail vs Power, Explained",
    seoDescription:
      "Sailing yachts charter at 30-40% lower rates than equivalent motor yachts, plus the sailing experience itself. Full guide to luxury sail charter in Greece.",
...

  {
    ...
    faq: [
      ...
      // 2026-08-06 (job 5) — exact-match FAQ. This page holds position 7.6
      // with 81 impressions and zero clicks for "why choose a catamaran
      // charter in greece", while the three commercial catamaran pages sit
      // at 47.3, 71.7 and lower for the same question. The answer was
      // already in the body; it just was not phrased as the question people
      // actually type, so nothing in the snippet matched.
      {
        q: "Why choose a catamaran charter in Greece?",
        a: "Three reasons specific to Greek waters. The Meltemi builds a short, steep chop across the Cyclades from late June to early September, and a catamaran barely rolls in it, which matters if anyone aboard is prone to seasickness. Greek anchorages are often shallow, so a 1.5m draft opens bays around Donousa, Lipsi and Spetses that a monohull of the same length cannot enter. And a Greek charter week is mostly spent at anchor rather than under way, so the full-beam deck and saloon are where the holiday actually happens.",
      },
    ],
    relatedTerms: ["sailing-yacht", "motor-yacht", "draft", "superyacht"],
    relatedPages: [
      { title: "Catamaran charter Greece", url: "/catamaran-charter-greece" },
      // 2026-08-06 (job 5) — the two commercial catamaran pages were not
      // linked from here at all, which is why they rank 40 to 60 places
      // behind a glossary definition for their own buying-intent query.
      { title: "Best catamarans in Greece", url: "/best-catamarans-greece-charter" },
      { title: "Catamaran charter for families", url: "/catamaran-charter-greece-family" },
      // 2026-05-14 — Ahrefs flagged the second entry as a broken link
      // (Power catamaran landing page was never built). Replaced with
      // the existing "Best motor yachts" page which covers the same
      // power-cat search intent (speed + deck space). next.config.mjs
      // also 308-redirects the dead URL for any external referrers.
      { title: "Best motor yachts Greece", url: "/best-motor-yachts-greece-speed" },
    ],
    // 2026-08-06 (job 5) — the query is "why choose a catamaran charter in
    // GREECE" and the old title said neither "why" nor "Greece". Position
    // 7.6 with a title that answers a different question is the textbook
    // zero-click shape.
    seoTitle: "Catamaran Charter in Greece: Stability and Shallow Draft",
    seoDescription:
      "Barely rolls in the Meltemi, sits in 1.5m of water, and gives you the full width of the yacht at anchor. Why families pick a catamaran for a Greek week.",
...

  {
    ...
    seoTitle: "What Is a Gulet? The Traditional Wooden Yacht",
    seoDescription:
...

  {
    ...
    seoTitle: "Trawler Yacht Charter: Long-Range Luxury",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    examples: [
      {
        ...
        body: "Two yachts on one itinerary: ALINA, a Fountaine Pajot Power 80 for ten, and ChristAl MiO 80, a Thira 80 for twelve, EUR 70,000 to 90,000 a week each on their cards. The itineraries are synchronised so the party dines together on alternating yachts; each yacht is priced per yacht per week.",
      },
      {
        title: "Day-guest addition for a birthday at anchor",
        body: "Twelve overnight guests aboard a 39 metre motor yacht. For the birthday dinner at anchor, further guests arrive by tender from a villa ashore, dine aboard and return for the night. Whether day guests are permitted, and how many, is set by the yacht's licence and confirmed with the owner before the charter; this house does not assume it.",
      },
    ],
    faq: [
      {
    ...
    // 2026-08-06 (job 8) — position 8.0 in the US on "explanation of the 12
    // passenger rule on charter yachts", 77 impressions, zero clicks over 90
    // days. Page one and nobody clicks means the snippet is not promising the
    // explanation the searcher typed. It now says what the rule is in the
    // title, so the result answers before the click rather than after it.
    seoTitle: "The 12-Passenger Rule: Why Charter Yachts Cap at 12",
    seoDescription:
      "Why every commercially chartered yacht caps at 12 overnight guests under SOLAS, what to do if your group is 14, and how day guests are counted differently.",
...

  {
    ...
    longDefinition:
      ...
      "**Compliance and customs:** Greek customs allow yacht provisioning duty-free under certain conditions, particularly for yachts under foreign flags. This can save the VAT on alcohol provisioning specifically. Captains handle the paperwork; charterers benefit invisibly.",
    whyItMatters:
    ...
    seoTitle: "Yacht Charter Provisioning: Food & Drink Aboard",
    seoDescription:
      "Provisioning stocks the yacht with food, wine, and consumables before a charter. Full breakdown of preference sheets, budgets, and quality benchmarks.",
...

  {
    ...
    seoTitle: "What Is a Yacht Tender? Sizes & Uses",
    seoDescription:
      "Tenders are the small boats yachts carry for shore transfers and water sports. Full breakdown of sizes, uses, and how to compare yachts on tenders.",
...

  {
    ...
    seoTitle: "Yacht Water Toys: What Every Tier Offers",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Yacht Captain: The Most Important Crew Role",
    seoDescription:
...

  {
    ...
    seoTitle: "Yacht Stewardess: The Interior Service Role",
    seoDescription:
      "Stewardesses run yacht interior service to hotel standards: meals, bar, cabins, laundry. Full breakdown of the role and what defines top-tier service.",
...

  {
    ...
    examples: [
      ...
      },
      {
        ...
        body: "The chef aboard the sailing catamaran Above & Beyond took first place Platinum at MEDYS 2022 and first place Diamond at EMMYS 2023, the trade's chef competitions judged by charter brokers and starred chefs. The preference sheet comes back as a week of menus proposed day by day; wine goes through the APA at cost.",
      },
    ],
    faq: [
      {
    ...
    seoTitle: "Yacht Chef: Charter Cuisine at Michelin Level",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    longDefinition:
      ...
      "**LOA and price on the Greek Charter Index 2026 (motor yachts):** 22 to 25 metres EUR 21,000 to 47,500 a week; 26 to 31 metres 35,900 to 75,000; 35 to 40 metres 59,900 to 150,000; above 50 metres 162,500 to 235,000. Price scales faster than length because every additional metre adds crew, fuel, and complexity. " +
      "**LOA and marina fees:** Greek marinas charge by LOA and by season, at rates each marina publishes; a berth in Mykonos in August is among the most expensive in Greece and is paid from the APA. Anchoring is free in most Greek waters, which is why the week this house writes sleeps at anchor more often than alongside.",
    whyItMatters:
    ...
    examples: [
      {
        title: "Spec breakdown, PAREAKI II, 39 metres",
        body: "LOA: 39.08 m (128 ft). Builder: Maiora. Cabins: 5. Sleeps: 12 guests. Crew: 8. Stabilisers at anchor and under way. Rate card: EUR 98,000 to 115,000 a week. The card carries every one of these lines; the length is the first of them and the least.",
      },
    ],
    faq: [
      {
...

  {
    ...
    longDefinition:
      "Draft is the constraint that determines where a yacht can anchor or moor. Lakka on Paxos is 3 to 4 metres over sand, Vathy on Ithaca 3.5 to 4 off the town, Mongonisi 3 to 6, the Despotiko channel off Antiparos 4 to 9: a catamaran drawing a metre and a half lies in all of them, a sailing yacht drawing three picks its spot with care. This single specification opens or closes whole categories of Greek anchorages. " +
      ...
      "**Greek anchorages where draft matters most, from the house guides:** the Despotiko channel off Antiparos (4 to 9 m over sand), Lakka and Longos on Paxos (3 to 4 m), Mongonisi (3 to 6 m), Vathy on Ithaca (3.5 to 4 m), Kolona on Kythnos (3 to 10 m), Naxos harbour (4 to 7 m). Catamarans lie close in at all of these; deep-draft sailing yachts anchor further out. " +
    ...
    whyItMatters:
      "If your itinerary includes the shallow anchorages (the Despotiko channel, the north coast of Paxos, the inner harbours of Ithaca and Meganisi), draft is the single most important spec. A party that wants the Small Cyclades or the inner Ionian close in needs a catamaran or a shallow-draft motor yacht.",
    examples: [
      {
        title: "Yacht-anchorage compatibility, the Despotiko channel",
        body: "Despotiko, from the Paros guide: 4 to 9 metres over sand with excellent holding, one of the most protected anchorages in the southern Cyclades in a northerly. A catamaran drawing 1.5 metres lies in the shallow end by the beach; a sailing yacht drawing 3 metres anchors in the deeper middle; a 40 metre motor yacht drawing more than that lies outside and tenders in.",
      },
    ],
    faq: [
      {
    ...
    seoTitle: "Yacht Draft Explained: How Deep a Yacht Sits",
    seoDescription:
...

  {
    ...
    seoTitle: "What Is a Yacht Flybridge? The Top-Deck Space",
    seoDescription:
...

  {
    ...
    longDefinition:
      "Roll, the side-to-side motion of a yacht as waves push the hull, is the single largest comfort variable on a yacht. A yacht without stabilisers at anchor in a swell rolls enough to unsettle a motion-sensitive guest and to move the glasses on the table; a yacht with zero-speed stabilisation in the same swell barely moves. " +
      "**Two stabiliser technologies on modern yachts:** **(1) Fin stabilisers**, underwater fins on either side of the hull that pivot to counter roll, highly effective under way and, on the newer zero-speed systems, at anchor as well. **(2) Gyroscopic stabilisers**, internal spinning gyroscopes whose angular momentum counters roll, effective at any speed including dead-stopped at anchor. " +
      "**Why stabilisers matter for charter selection in Greece:** the Meltemi blows through the central Cyclades on July and August afternoons, and the swell it raises reaches the south-coast lees of Mykonos and the bays of Paros. Lunch at anchor on a stabilised yacht is lunch; on an unstabilised one it is a matter of bracing. The Saronic and the Ionian are sheltered, so the fit matters most for a Cyclades week. " +
      "**The questions to ask:** does the yacht have stabilisers, are they zero-speed capable, fin or gyroscopic, when were they last serviced. The fit is a yacht-by-yacht fact stated on each rate card, and this house confirms it with the owner before a name goes on a shortlist. Eleven motor yachts we represent state stabilisers on their listing: FREEDOM, LADY NATASA, NAYLA, SUMMER FUN, DALOLI, PROJECT STEEL, OAK, RIANA II, NAIA, PAREAKI II and LA PELLEGRINA 1; several of the crewed catamarans state stabilisers too, though two hulls barely roll at anchor to begin with.",
    whyItMatters:
      "Stabilisers are the most cost-effective comfort variable in a Cyclades week. Comparing two motor yachts of similar length on the Greek Charter Index 2026, the one with zero-speed stabilisation delivers a noticeably better week in a Meltemi, and this house surfaces the spec before the price.",
    examples: [
      {
        title: "Stabilised under 28 metres",
        body: "NAYLA, a Monte Carlo Yachts 80 built 2018 with stabilisers at anchor and under way, EUR 39,500 to 47,500 a week; LADY NATASA, a Ferretti 830 with zero-speed stabilisers, EUR 34,000 to 37,000; SUMMER FUN, an Admiral 101 refitted 2026, EUR 45,000 to 65,000. The Cyclades week for a motion-sensitive party at the quieter end of the band, each rate from the yacht's own card.",
      },
      {
        title: "Stabilised with twelve berths",
        body: "SUMMER FUN, an Admiral 101 at 30.8 metres, stabilised both ways and refitted 2026, EUR 45,000 to 65,000; PROJECT STEEL at 34 metres, EUR 55,000 to 67,000; PAREAKI II at 39 metres; LA PELLEGRINA 1 at 50. The family group's answer to an August week in the Cyclades.",
      },
    ],
    faq: [
      {
        q: "Do all luxury yachts have stabilisers?",
        a: "No. The newer motor yachts usually carry zero-speed stabilisation; older yachts vary, some retrofitted, some with fins that work under way only. Ask for the model and the year, and ask specifically whether the system is zero-speed capable. On the yachts this house represents the answer is on the rate card.",
      },
      {
        q: "Are stabilisers noisy?",
        a: "Modern systems are essentially silent in the guest spaces. Some older fin systems and large gyroscopes produce a faint low hum noticeable only when engaged.",
      },
      {
        q: "Do stabilisers consume a lot of fuel?",
        a: "Gyroscopic systems run on the generator, so the yacht burns a little more fuel at anchor with them on. The cost sits inside the APA and is small against a week's fuel; the comfort gain is not.",
      },
      {
        q: "Can I turn the stabilisers off?",
        a: "Yes, but rarely necessary. The captain may disengage them in flat-calm conditions; most guests want them on whenever there is any swell. A sailing yacht under sail is steadied by the sails themselves, and a catamaran needs none.",
      },
    ],
    relatedTerms: ["motor-yacht", "draft", "beam", "captain"],
    relatedPages: [
      { title: "The eight stabilised yachts, with rates", url: "/best-yachts-greece-stabilizers-smooth-sailing" },
      { title: "Greek yacht charter with stabilisers", url: "/yacht-charter-greece-with-stabilizers" },
      { title: "Full fleet", url: "/charter-yacht-greece" },
    ],
    seoTitle: "Yacht Stabilizers Explained: Why They Matter",
    seoDescription:
      "Stabilizers eliminate yacht roll, the single largest comfort variable on a charter. Full breakdown of Seakeeper vs fin stabilizers and what to ask.",
