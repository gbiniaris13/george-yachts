...
export const GLOSSARY_TERMS = [
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. In Greece in 2026 delivery is invoiced at the same 13% reduced VAT rate as the charter fee.",
      },
      {
...

  {
    ...
    alsoKnownAs: ["Greek Charter VAT", "VAT 13%", "Greek Yacht Tax"],
    category: "pricing",
    shortDefinition:
      "Greek yacht charters are taxed at a reduced VAT rate of 13% on commercial crewed charters longer than 48 hours (which every weekly charter is), applied to the base charter fee. Short charters of 48 hours or less, static charters, and bareboat charters without crew are taxed at the standard 24%.",
    longDefinition:
      "Greece applies a **reduced VAT rate of 13% on commercial crewed yacht charters that exceed 48 hours**, set by Law 5073/2023 and confirmed by AADE Circular E.2006/2026. A crewed weekly charter is treated as a passenger-transport service, which is what unlocks the reduced rate. The **standard 24% rate** applies to short charters of 48 hours or less, to static charters where the yacht never gets under way, and to bareboat charters operated without a permanent crew. The 13% reduced rate is one of the most favourable yacht-charter VAT regimes in the Mediterranean, level with Croatia's 13% and well below Spain (21%) and Italy (22%). " +
      ...
      "**A note on the old numbers:** you may still see 12% or effective rates near 6.5% quoted online. The 12% reduced rate applied in 2021 to 2022 before it moved to 13%, and the very low effective rates came from a pre-2020 regime that reduced VAT for time spent outside EU waters, which the EU required Greece to abolish from January 2020. Neither is valid for 2026. " +
      "Compared to: Spain (21% standard), Italy (22% standard), Monaco (no VAT on charters embarking Monaco, the major reason luxury fleets reposition there in shoulder seasons).",
    whyItMatters:
      "VAT is a real €15-65k line item on a luxury charter. UHNW buyers compare jurisdictions and Greece is structurally cheaper than Spain and Italy on this single point. A broker who is fuzzy on Greek VAT, or who quotes the abolished 12% or 6.5% figures, is signalling either inexperience or laziness, both unacceptable at this price point.",
    examples: [
      {
        title: "Standard €150,000 weekly crewed charter, over 48 hours",
        body: "VAT at 13%: €19,500. Total invoice: €169,500 + APA + gratuity.",
      },
      {
        title: "Short charter of 48 hours or less, or a static charter",
        body: "Taxed at the standard 24%, not the 13% reduced rate. The reduced rate is reserved for commercial crewed charters that get under way for more than 48 hours, so a day charter or a yacht hired while it stays on the berth does not qualify.",
      },
    ],
    faq: [
      {
        q: "Is Greek charter VAT 12% or 13%?",
        a: "13% as of 2026, for commercial crewed charters over 48 hours, under Law 5073/2023 and AADE Circular E.2006/2026. The 12% reduced rate applied only in 2021 to 2022. Older effective rates near 6.5% came from a pre-2020 outside-EU-waters regime that was abolished from January 2020. Neither applies today.",
      },
      {
        q: "Is VAT included in the charter quote?",
        a: "Some brokers quote pre-VAT (cleaner for comparison), some quote inclusive. Always ask: 'Is this number gross or net of VAT?' The 13% difference matters at scale.",
      },
      {
      ...
      },
      {
        ...
        a: "Not via the old international-waters trick, which Greece abolished from January 2020. A genuinely international voyage that calls at non-Greek ports can change the VAT treatment on the qualifying portion, but it is document-dependent and rarely worth the complexity. For almost every charter the clean answer is the 13% reduced rate. Confirm specifics with us and your accountant.",
      },
    ],
    ...
    seoTitle: "Greek Yacht Charter VAT 2026: The 13% Rate Explained",
    seoDescription:
      "Greece taxes commercial crewed charters over 48 hours at 13% VAT, the reduced rate, structurally cheaper than Spain and Italy. Full international comparison.",
...

  {
    ...
    longDefinition:
      ...
      "**What the charter fee does NOT include  -  the four other cost buckets:** (1) APA at 25-35% of the charter fee, covering fuel, food, drink, and port fees; (2) Greek VAT at 13% of the charter fee + delivery; (3) Delivery fee if the yacht must reposition; (4) Crew gratuity at 5-20% of the charter fee, paid at disembarkation. " +
    ...
    whyItMatters:
      "Comparing two yachts by charter fee alone misleads UHNW buyers. A yacht quoted €120,000/week with a 35% APA, 13% VAT, and obligatory €15k delivery costs €192,600 fully loaded  -  versus a €130,000/week yacht with 25% APA, no delivery, same VAT = €179,400. The 'cheaper' yacht is more expensive once you add everything.",
    examples: [
      {
        title: "Full cost breakdown of a 'mid-market' €100,000 charter",
        body: "Charter fee: €100,000. VAT 13%: €13,000. APA 30%: €30,000. Delivery (Athens to Mykonos return): €8,000. Gratuity 12%: €12,000. **Fully loaded: €163,000**  -  63% above the headline weekly rate.",
      },
      {
        title: "Same yacht, no delivery (already in Mykonos), shoulder pricing",
        body: "Charter fee (June discount): €82,000. VAT 13%: €10,660. APA 30%: €24,600. Gratuity 12%: €9,840. **Fully loaded: €127,100**  -  €36k saved by understanding the timing.",
      },
    ],
    faq: [
      {
    ...
    examples: [
      {
        ...
        body: "Charter fee: €650,000. APA 30%: €195,000. VAT 13%: €84,500. Gratuity 12%: €78,000. Total fully loaded: €1,007,500.",
      },
      {
...

  {
    ...
    longDefinition:
      ...
      "**Compliance and customs:** Greek customs allow yacht provisioning duty-free under certain conditions, particularly for yachts under foreign flags. This can save 13% VAT on alcohol provisioning specifically. Captains handle the paperwork; charterers benefit invisibly.",
    whyItMatters:
