...
export const GLOSSARY_TERMS = [
...

  {
    ...
    faq: [
      ...
      {
        q: "Can I book a private one-day boat tour from Athens with a skipper?",
      ...
      // anchor to the page that should own the query.
      {
        ...
        a: "This page covers single-day hire. For weekly figures, our motor yacht charter Greece prices are published on the weekly rate card at /weekly-yacht-charter-rates-greece, listed by yacht size and season from our own fleet's live rate cards, with the APA, VAT and gratuity layers broken out so the all-in number is visible before you inquire.",
      },
