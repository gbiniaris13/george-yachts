...
export const USE_CASES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      "Six-guest yachts from their own cards: SEA U EUR 21,000 to 24,000, SEA YA 24,000 to 28,000, MELITI 26,500, Just Marie 2 49,000 to 59,000, per yacht per week before VAT and APA",
    ...
    quickAnswer: {"question":"What does a honeymoon yacht charter in Greece cost, and which yacht?","answer":"One price per yacht per week with crew: the six-guest yachts on this house's list start at EUR 21,000 a week net base for SEA U, a 22 metre Riva 72 with a crew of two, and run through SEA YA at 24,000 to 28,000 and MELITI, a 26 metre sailing yacht with four crew, at 26,500; crewed sailing catamarans start at EUR 17,000. Add APA of 20 to 40% by type and Greek VAT at the yacht's certified rate. May, June and September list 15 to 25% below peak, and the week can start on any day."},
    ...
    seoTitle: "Honeymoon Yacht Charter Greece | From EUR 17,000/Week",
    seoDescription: "Private honeymoon yacht charter in Greek waters. Crewed sailing yachts, catamarans, and motor yachts for couples. From EUR 17,000 a week, Index 2026.",
    ...
    yachtFilter: '_type == "yacht" && slug.current in ["sea-u", "sea-ya", "lady-l", "meliti-sy", "just-marie-2"] && !(retired == true)',
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Family yacht charter in Greek waters. Crewed catamarans and motor yachts for 4-12. Child-safe platforms, chef catering. Index 2026 rates from EUR 17,000 a week.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Birthday Yacht Charter Greece | Crewed Weeks for Birthdays",
    seoDescription: "Birthday yacht charter in Greek waters. Milestone birthdays (40, 50, 60) and family birthday weekends. From EUR 17,000 a week, Index 2026.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Anniversary yacht charter in Greek waters. 10th, 25th, 50th milestone anniversaries hosted at sea. From EUR 17,000 a week, Index 2026.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Group yacht charter in Greek waters for 8 to 12 guests. Multi-cabin motor yachts and catamarans. From EUR 17,000 a week, Index 2026.",
...

  {
    ...
    faq: [
      { q: "How much does a bachelor party yacht charter cost?", a: "A week, per yacht, from the Greek Charter Index 2026: a crewed sailing catamaran for eight at EUR 18,900 to 48,000 net base at 16 to 19 metres, a 20 to 22 metre catamaran at 31,500 to 43,500, a 26 to 31 metre motor yacht at 35,900 to 75,000. A two-yacht flotilla is two rate cards side by side. Add APA of 20 to 40% by yacht type and Greek VAT at the certified rate. Quoted as the week for the yacht, never split per head; the five-night Saronic week is the shortest programme this house writes." },
...

  {
    ...
    quickAnswer: {
      ...
      answer:
        "One price per yacht per week with crew, from the Greek Charter Index 2026: a crewed sailing catamaran for eight or ten at EUR 18,900 to 48,000 net base by length, a 26 to 31 metre motor yacht at 35,900 to 75,000, before APA and Greek VAT at the certified rate. Two programmes dominate: the five-night Saronic week from Athens, the shortest this house writes, or the full Cyclades week with Mykonos as the base, 90 nautical miles from Athens, anchored at Ornos or Psarou for the beach clubs.",
    },
    keyFacts: [
      "Index 2026 bands: crewed sailing catamaran for 8 to 10 guests EUR 18,900 to 48,000; 26 to 31 m motor yacht 35,900 to 75,000 a week net base",
    ...
    faq: [
      { q: "How much does a bachelorette yacht charter cost?", a: "A week, per yacht, from the Greek Charter Index 2026: a crewed sailing catamaran for eight or ten at EUR 18,900 to 48,000 net base by length, a 26 to 31 metre motor yacht at 35,900 to 75,000, crew included. Add APA and VAT at the certified rate. The five-night Saronic week is the shortest programme this house writes." },
...

  {
    ...
    seoTitle: "Retreat Yacht Charter Greece | Crewed Weeks for Retreats",
...

  {
    ...
    seoTitle: "Proposal Yacht Charter Greece | Crewed Weeks for Proposals",
...

  {
    ...
    quickAnswer: {
      ...
      answer: "One that sleeps everyone in a cabin of their own: for eight to ten, a 20 to 24 metre crewed catamaran at EUR 31,500 to 90,000 a week on the Greek Charter Index 2026; for twelve, one of the yachts we represent that sleep twelve in five or six cabins, from SUMMER FUN at EUR 45,000 to 65,000 to KOKOMO NIGHTS at EUR 120,000 to 140,000, per yacht per week before VAT and APA; for more than twelve, two yachts sailing together, each on its own rate card. The milestone day is built into the middle of the week, the chef briefed on it before you board, and the anchorage chosen for the evening rather than the passage.",
    },
    keyFacts: [
      "Twelve guests on one hull, from their own cards: SUMMER FUN EUR 45,000 to 65,000, PROJECT STEEL EUR 55,000 to 67,000, ChristAl MiO 80 (a catamaran) EUR 70,000 to 90,000, CAN'T REMEMBER EUR 80,000 to 90,000, PAREAKI II EUR 98,000 to 115,000, KOKOMO NIGHTS EUR 120,000 to 140,000.",
