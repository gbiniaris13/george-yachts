...
export const USE_CASES = [
...

  {
    ...
    whenTitle: "When to book",
    whenBody: "Bachelorette season runs **May to October**. **June and September** are the sweet spots - Mykonos energy still on, less crowding for the content shoots, rates 15 to 25% below peak on the Greek Charter Index. Book **6-9 months ahead** for full-week charters in peak August.",
