...
export const USE_CASES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      "Six-guest yachts from their own cards: Endless Beauty EUR 14,000 to 17,500, SEA U 21,000 to 24,000, SEA YA 24,000 to 28,000, MELITI 26,500, Just Marie 2 49,000 to 59,000, per yacht per week before VAT and APA",
      "Four of the 68 enquiries logged on this desk between 30 May and 6 September 2026 were for two guests, two of them honeymoons",
      "Cyclades legs on the house table: Mykonos to Paros 30 nautical miles, Paros to Santorini 60; the Santorini sunset is taken from a mooring buoy at Ammoudi",
      "The five-night Saronic week from Athens is the shortest programme: Aegina 18 nautical miles, Hydra 35",
      "APA 20 to 30% of base on a catamaran, 30 to 40% on a motor yacht; Greek VAT at the certified rate; gratuity 10 to 15% of base"
    ],
    evidence: { label: "George Yachts Greek Charter Index 2026", href: "/greek-charter-index-2026" },
    quickAnswer: {"question":"What does a honeymoon yacht charter in Greece cost, and which yacht?","answer":"One price per yacht per week with crew: the six-guest yachts on this house's list start at EUR 14,000 a week net base for Endless Beauty, a 13.4 metre power catamaran with captain and cook-hostess, and run through SEA U at 21,000 to 24,000, SEA YA at 24,000 to 28,000 and MELITI, a 26 metre sailing yacht with four crew, at 26,500; crewed sailing catamarans start at EUR 10,900. Add APA of 20 to 40% by type and Greek VAT at the yacht's certified rate. May, June and September list 15 to 25% below peak, and the week can start on any day."},
    ...
    seoTitle: "Honeymoon Yacht Charter Greece | From EUR 10,900/Week",
    seoDescription: "Private honeymoon yacht charter in Greek waters. Crewed sailing yachts, catamarans, and motor yachts for couples. From EUR 10,900 a week, Index 2026.",
    ...
    yachtFilter: '_type == "yacht" && slug.current in ["sea-u", "sea-ya", "lady-l", "meliti-sy", "endless-beauty", "just-marie-2", "shooting-star"] && !(retired == true)',
    ...
    insiderTips: [
      ...
      "Crew tip on honeymoons is convention 10 to 15% of base rate, paid in cash to the captain on the last morning.",
    ...
    faq: [
      // 2026-08-07 (AI offensive) — on a honeymoon page the broker question is
      // really a crew question, so the answer is framed that way rather than
      // repeating the credentials list first.
      {
        q: "Who should I book a honeymoon yacht charter in Greece through?",
        a: "For a honeymoon the yacht matters less than the four or five people who will be twenty feet away from you for a week. That is the whole brief: a crew who can read a room, disappear when they should, and produce dinner on deck at exactly the right moment without being asked. It is not something a fleet list can tell you, which is why the useful broker is one who has met the captains. We have, and there is nothing we gain by steering you to one over another. Practically: IYBA Charter Active Member, verifiable in their directory. MYBA-standard contracts with the base fee, APA, certified VAT rate and gratuity range itemised before signature, so the week holds no financial surprises during the one holiday you will not want them. George Yachts Brokerage House LLC, Wyoming, operating from Athens. Forbes, May 2026. Weekly and fully crewed, Greek waters only, and George answers you himself from first enquiry to disembarkation.",
      },
      // 2026-07-11 GSC-driven: "honeymoon yacht charter" (100 impressions,
      // pos 27.6) is a broad query  -  this answers it head-on.
      {
        q: "Is Greece the best place for a honeymoon yacht charter?",
        a: "For couples, Greek waters make an unusually strong case: short distances between islands mean more anchorage time and less passage time, protected gulfs give calm first-time sailing, crewed sailing catamarans start at EUR 10,900 a week and the six-guest yachts on this list at EUR 14,000, and the season runs long, from May to October. Add empty coves that only a boat can reach, and Greece is where honeymoon charters punch far above their price."
      },
      {
      ...
      },
      {
        ...
        a: "One price per yacht per week with crew, from the Greek Charter Index 2026 and the six-guest cards: a crewed sailing catamaran from EUR 10,900 a week at 14 metres; Endless Beauty, a 13.4 metre power catamaran for six, EUR 14,000 to 17,500; SEA U (Riva 72) 21,000 to 24,000; SEA YA (Azimut 66) 24,000 to 28,000; MELITI, a 26 metre sailing yacht for six with four crew, 26,500; a 26 to 31 metre motor yacht 35,900 to 75,000. Add APA of 20 to 40% by yacht type (food, drink, fuel, berths) plus Greek VAT at the certified rate, 5.2 to 12% (13% the statutory ceiling, 24% for charters of 48 hours or less). May, June and September list 15 to 25% below peak."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Family Yacht Charter Greece | Multi-Generational",
    seoDescription: "Family yacht charter in Greek waters. Crewed catamarans and motor yachts for 4-12. Child-safe platforms, chef catering. Index 2026 rates from EUR 10,900 a week.",
    ...
    yachtFilter: '_type == "yacht" && sleeps >= 6 && category in ["motor-yachts", "power-catamarans", "sailing-catamarans"] && !(retired == true)',
    ...
    faq: [
      ...
      // 2026-08-15 GSC strike: "best charter yachts in greece for families
      // with young children" (53 imp, pos 11.8, up from 24.1). The page had
      // a safety answer but nothing that answered which yachts, which is
      // what the query actually asks.
      {
        q: "Which yachts are best in Greece for families with young children?",
        a: "Crewed catamarans, in almost every case. A 45 to 80 foot catamaran gives you flat decks with no heel under sail, a wide swim platform a five-year-old can use unsupervised from the top step, a 1.2 to 1.5 metre draft that lets the boat anchor close in on calm sandy bays, and two hulls that keep sleeping children away from the saloon in the evening. Weekly net base for a crewed catamaran runs from about €10,900 at 14 metres to €90,000 at 24 metres, with the family sweet spot, a 20 to 22 metre boat for eight to ten guests, at €31,500 to €43,500, per our Greek Charter Index. The alternative for larger families is a motor yacht above 24 metres with stabilisers, which holds the boat steady at anchor and suits multi-generational groups who want separate guest zones. The format to avoid with children under eight is the sailing monohull: it heels under sail, which unsettles young children and makes the deck harder to move around.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Corporate Yacht Charter Greece | Team Off-Sites",
    seoDescription: "Corporate yacht charter for executive retreats, off-sites, client hosting. 4-12 guests. Wi-Fi, A/V, conference space. Index 2026 rates from EUR 17,500 a week.",
    ...
    featuredHeading: "Conference-capable yachts for 2027",

    whenTitle: "When to charter for corporate use",
    whenBody:
      "Corporate charters concentrate in **May, June, and September**: warm enough water for swimming breaks, mild enough for outdoor dining, and rates 15 to 25% below peak on the Greek Charter Index. **July and August** are not preferred for corporate use due to crowded anchorages and heat. **Winter charters** are rare; we'd recommend a hotel for January or February planning weeks instead. **Mid-week starts (Tuesday or Wednesday)** are typical for corporate charters, distinct from the Saturday-to-Saturday leisure pattern.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Wedding Yacht Charter Greece | Wedding Receptions",
    ...
    whyBody:
      ...
      "Three common patterns. **Reception on board** - a 30 to 40 metre yacht anchored off Mykonos or Santorini hosting the wedding party for dinner, dancing, and a late send-off to the tender that returns guests to their hotels; how many may be aboard at anchor beyond the twelve who sleep aboard is set by the yacht's licence, confirmed with the owner before the charter, and ELYSIUM, 64 metres, is certified for up to 49. **Two yachts on one itinerary** - chartered together for a wedding week, with the bride and groom on the flagship and the other yacht hosting family. **The photography morning** - inside the crewed week, the captain positions the yacht at dawn in the iconic anchorages (Antiparos, Folegandros, Hydra) for bride-and-groom photography, with the wedding itself at a land-based venue. " +
    ...
    yachtFilter: '_type == "yacht" && sleeps >= 8 && category in ["motor-yachts", "power-catamarans", "sailing-catamarans"] && !(retired == true)',
    yachtsHeadline: "Yachts suitable for wedding events",
    featuredHeading: "Wedding-ready yachts for 2027",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Birthday Yacht Charter Greece",
    seoDescription: "Birthday yacht charter in Greek waters. Milestone birthdays (40, 50, 60) and family birthday weekends. From EUR 10,900 a week, Index 2026.",
    ...
    featuredHeading: "Birthday-week yachts for 2027",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Not with us. We broker crewed charters by the week, and the yachts worth putting a milestone birthday on, the ones above 30 metres with a proper chef and a crew of six or more, will not take a single-day booking in any case. If one evening is genuinely the whole plan, a day-hire operator is the right call and we will say so. If the birthday is the reason a family is coming to Greece at all, the week is what turns it into the trip everyone remembers."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Anniversary Yacht Charter Greece",
    seoDescription: "Anniversary yacht charter in Greek waters. 10th, 25th, 50th milestone anniversaries hosted at sea. From EUR 10,900 a week, Index 2026.",
    ...
    featuredHeading: "Intimate yachts for 2027",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "If the yacht is still on the list and available, yes. Continuity is a frequent anniversary request. Brief us at booking on the previous yacht name; we'll check availability. If the yacht is no longer chartering, we'll find the closest equivalent."
      },
      {
        q: "How much does an anniversary yacht charter cost?",
        a: "Couple-only charters: €18,000 to €60,000/week for the right boat for two. Family anniversary charters (4 to 8 guests): €40,000 to €120,000/week. Add 20 to 40% APA by yacht type and Greek VAT at the certified rate, typically 6.5-12% (statutory 13%; 24% for short charters under 48 hours). Most anniversary charters settle between €35,000 and €90,000 all-in."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Group Yacht Charter Greece | 8-12 Guest Yachts",
    seoDescription: "Group yacht charter in Greek waters for 8 to 12 guests. Multi-cabin motor yachts and catamarans. From EUR 10,900 a week, Index 2026.",
    ...
    whyBody:
      ...
      "**Multi-yacht flotillas** (two or three yachts cruising together) are how we handle 14 to 30 guest groups. The yachts dock and anchor together where possible, but each guest still has their own bed and bathroom and the total stays sensible. Our office handles the multi-yacht coordination; the captains know each other and have run shared itineraries before.",
    ...
    featuredHeading: "Group-ready yachts for 2027",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "A suitable 10-guest yacht (typically 27 to 35 metres or a 75-foot+ catamaran with 5 cabins) costs €60,000 to €180,000 per week before APA and VAT. Most 10-guest groups settle between €90,000 and €140,000 all-in for a 7-night charter. That is the whole week for the yacht."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    // 2026-08-06 (George's call) — the whole site is coming out of day
    // hire. This page led with it: the tagline said "Day charters", the
    // FAQ opened with "Yes. Day charters from a fixed marina", and the
    // only visible search demand it holds is "yacht photographer greece",
    // which is a photographer looking for work, not a client looking for a
    // yacht. Multi-day production charters were already half the page and
    // are what we actually place, so those lead now.
    tagline: "Multi-day crewed charters for editorial, brand, and commercial production in Greek waters.",
    seoTitle: "Photoshoot Yacht Charter Greece",
    seoDescription: "Multi-day crewed yacht charters for editorial, fashion and brand production in Greek waters. Location scouting, drone permits, crews used to a call sheet.",
    ...
    featuredHeading: "Photoshoot-ready yachts for 2027",

    whenTitle: "When to charter for photography",
    whenBody:
      "**Late May through mid-July** and **mid-September through mid-October** offer the best light and least crowded anchorages. Peak August has the brightest, most saturated colours but most marinas are booked. Winter shoots (November to March) work for specific moody-light projects but the water is too cold for swim shots and most charter yachts winter in marinas (limited fleet available). Lead time: **2 to 6 weeks minimum** for editorial production charters, **8 to 12 weeks** for brand commercial shoots with permits.",
    ...
    faq: [
      {
        ...
        a: "Single-day hire from a fixed marina is standard in Greece, but it is not what we place. We broker crewed charters by the week, and for production that is usually the cheaper answer anyway: a multi-day shoot costs 30 to 50 percent less per day than booking the same yacht one day at a time, and the yacht can move overnight so the second morning starts at a different island instead of the same marina."
      },
      {
...

  {
    ...
    // 2026-09-07 (plan #13, GEO): 163 impressions at 16.6 and no answer unit.
    // The programme is the five-night Saronic week or the full week; the house
    // does not write shorter. Named yachts from their own cards.
    quickAnswer: {
      question: "How much does a bachelor party yacht charter in Greece cost?",
      answer: "Per yacht per week before VAT and APA, one price for the whole group: a crewed catamaran for eight to ten from EUR 18,900 at 16 to 19 metres and EUR 31,500 to 43,500 at 20 to 22 on the Greek Charter Index 2026; a motor yacht for eight from EUR 17,500 on MARY or EUR 31,000 to 33,000 on M FIVE from their own cards; for twelve, SUMMER FUN at EUR 45,000 to 65,000. Add APA of 20 to 30% on a catamaran or 30 to 40% on a motor yacht, VAT at 5.2 to 12% by certification and a customary 10 to 15% crew gratuity on the base. The shortest programme is the five-night Saronic week from Athens; Mykonos is a full week.",
    },
    keyFacts: [
      "One price per yacht per week, split however the group likes: a 20 to 22 metre crewed catamaran for ten runs EUR 31,500 to 43,500 a week on the Index, a 23 to 24 metre for twelve EUR 54,900 to 90,000.",
      "Named for a group of eight to twelve, from their own cards: MARY EUR 17,500 to 19,900, M FIVE EUR 31,000 to 33,000, Genny (five cabins, ten guests) EUR 56,000 to 79,000, SUMMER FUN (six cabins, twelve guests) EUR 45,000 to 65,000.",
      "Mykonos anchorages from the verified guide: Psarou 8 to 15 metres over sand for Nammos, Paradise and Super Paradise 10 to 18 metres for the beach clubs, Ornos 6 to 12 metres with excellent shelter from the north for the nights.",
      "The five-night Saronic week from Alimos is the shortest programme this house writes: Aegina 18 miles, Poros, Hydra, Spetses, Dokos; a Mykonos week is seven nights, and the Cyclades passages are mornings of 25 to 30 miles.",
      "Ten guests was asked for in 7 of the 68 enquiries this desk logged in the 2026 season and eight in 2; the five and six cabin boats are the scarcest, and July and August commit six to twelve months ahead.",
    ],
    evidence: { label: "George Yachts Greek Charter Index 2026 and anchorage guides", href: "/greek-charter-index-2026" },
    seoTitle: "Bachelor Party Yacht Charter Greece",
    ...
    whyBody:
      ...
      "**Mykonos is the obvious departure**. Anchor off Ornos, tender into the chora for dinner, beach club afternoon at Scorpios or Nammos, evening back on the yacht for either a quiet conversation under stars or the kind of after-party the boat can host privately. Repeat the rhythm for the first nights. **The Cyclades opens up beyond Mykonos** for the rest of the week with Paros, Antiparos, and Folegandros adding genuine variety. " +
      "We host two patterns. **The five-night Saronic week from Athens** for 6-10 guests on a single crewed catamaran or motor yacht, the shortest programme this house writes. **Full weeks (7 nights)** for the closer crew that wants Mykonos and more islands. **Multi-yacht flotillas** (2-3 boats) for groups of 14-24 are common for bachelor weeks combining different friend groups.",

    bestFor: [
      "The five-night Saronic week from Athens, the shortest programme",
    ...
    featuredHeading: "Mykonos-based party yachts for 2027",

    whenTitle: "When to book",
    whenBody: "**June, July, August, September** are the bachelor-party months. **July-August** peak Mykonos energy. **June, September** suit slightly older groups (32+) wanting calm-but-alive. **The five-night Saronic week** from Athens, the shortest programme this house writes, and **the full Mykonos week** both commit six to twelve months ahead for July and August on the Greek Charter Index, three to four for June and September.",
    ...
    insiderTips: [
      ...
      "Tip convention for bachelor parties is the higher end of the range: 15% of base rate, paid in cash to the captain at end.",
    ...
    faq: [
      { q: "How much does a bachelor party yacht charter cost?", a: "A week, per yacht, from the Greek Charter Index 2026: a crewed sailing catamaran for eight at EUR 18,900 to 41,500 net base at 16 to 19 metres, a 20 to 22 metre catamaran at 31,500 to 43,500, a 26 to 31 metre motor yacht at 35,900 to 75,000. A two-yacht flotilla is two rate cards side by side. Add APA of 20 to 40% by yacht type and Greek VAT at the certified rate. Quoted as the week for the yacht, never split per head; the five-night Saronic week is the shortest programme this house writes." },
      ...
      { q: "Can we charter for the bachelor's day only?", a: "No. This house arranges crewed weeks only, with the five-night Saronic week from Athens as the shortest programme. A bachelor party that wants one day on the water is better served by the day-boat operators in Mykonos or Athens; a party that wants the week gets the yacht, the crew and the islands." },
...

  {
    ...
    quickAnswer: {
      question: "What does a bachelorette yacht charter in Greece cost, and where does it go?",
      answer:
        "One price per yacht per week with crew, from the Greek Charter Index 2026: a crewed sailing catamaran for eight or ten at EUR 18,900 to 43,500 net base by length, a 26 to 31 metre motor yacht at 35,900 to 75,000, before APA and Greek VAT at the certified rate. Two programmes dominate: the five-night Saronic week from Athens, the shortest this house writes, or the full Cyclades week with Mykonos as the base, 90 nautical miles from Athens, anchored at Ornos or Psarou for the beach clubs.",
    },
    keyFacts: [
      "Index 2026 bands: crewed sailing catamaran for 8 to 10 guests EUR 18,900 to 43,500; 26 to 31 m motor yacht 35,900 to 75,000 a week net base",
      "June and September list 15 to 25% below peak on the Index; July and August book 6 to 12 months ahead",
      "Mykonos is 90 nautical miles from Athens on the house table; Ornos and Psarou are the beach-club anchorages, sheltered from the Meltemi",
      "The five-night Saronic week from Athens is the shortest programme this house writes",
      "Photographers and content creators travel as guests within the yacht's licensed capacity; brief us at booking",
      "APA 20 to 30% for catamarans, 30 to 40% for motor yachts; crew gratuity 10 to 15% of base, at your discretion",
    ],
    evidence: { label: "Bands, lead time and shoulder discount from the Greek Charter Index 2026", href: "/greek-charter-index-2026" },
    seoTitle: "Bachelorette Yacht Charter Greece",
    ...
    whyBody:
      ...
      "Two patterns dominate. **The five-night Saronic week from Athens** with 6-10 friends on a crewed catamaran, the shortest programme this house writes. **Full weeks (7 nights)** with closer bachelorette parties (6-8 friends) doing the full Cycladic loop with Mykonos in it. The Greek bachelorette is now an established UHNW pattern with established yacht-charter conventions.",
    ...
    featuredHeading: "Mykonos-based yachts for 2027",

    whenTitle: "When to book",
    whenBody: "Bachelorette season runs **May to October**. **June and September** are the sweet spots - Mykonos energy still on, less crowding for the content shoots, rates 15 to 25% below peak on the Greek Charter Index. Book **6 to 12 months ahead**, the Index lead time for peak, for full-week charters in August.",
    ...
    faq: [
      { q: "How much does a bachelorette yacht charter cost?", a: "A week, per yacht, from the Greek Charter Index 2026: a crewed sailing catamaran for eight or ten at EUR 18,900 to 43,500 net base by length, a 26 to 31 metre motor yacht at 35,900 to 75,000, crew included. Add APA and VAT at the certified rate. The five-night Saronic week is the shortest programme this house writes." },
...

  {
    ...
    quickAnswer: {
      question: "How does a retreat on a chartered yacht in Greece work, and what does it cost?",
      answer:
        "The group boards in Athens, sails the Saronic Gulf on short hops (Aegina 18 nautical miles, Poros 25, Hydra 35 on the house table) and works or rests at anchor while the crew runs the boat. On the Greek Charter Index 2026 an executive off-site on a 22 to 25 metre motor yacht for six to eight lists at EUR 21,000 to 47,500 a week net base, a 26 to 31 metre at 35,900 to 75,000, and a wellness retreat on a 20 to 22 metre crewed catamaran for ten at 31,500 to 43,500, before APA and Greek VAT at the certified rate. The five-night Saronic week is the shortest programme this house writes.",
    },
    keyFacts: [
      "Index 2026 bands: 22 to 25 m motor EUR 21,000 to 47,500; 26 to 31 m motor 35,900 to 75,000; 20 to 22 m crewed catamaran 31,500 to 43,500 a week net base",
      "May, June and September list 15 to 25% below peak on the Index, the retreat months",
      "Saronic hops from Athens: Aegina 18 nm, Poros 25, Hydra 35, Spetses 50, so a working day loses two to three hours to passage, not a whole day",
      "The five-night Saronic week is the shortest programme this house writes; wellness retreats usually run the full seven nights",
      "Wi-Fi, salon table size and stabilisers are yacht-by-yacht facts, stated on each rate card before you commit",
      "One price per yacht per week with crew; APA 20 to 30% for catamarans, 30 to 40% for motor yachts",
    ],
    evidence: { label: "Bands and shoulder discount from the Greek Charter Index 2026", href: "/greek-charter-index-2026" },
    seoTitle: "Retreat Yacht Charter Greece",
    ...
    bestFor: [
      "Founder and executive off-sites (4-8 people, the five-night Saronic week)",
    ...
    featuredHeading: "Conference + wellness yachts for 2027",

    whenTitle: "When to book",
    whenBody: "**May, June, September** are the retreat-ideal months - warm enough for outdoor activities, mild enough for outdoor dining, rates 15 to 25% below peak on the Greek Charter Index. **Mid-week starts** (Monday or Tuesday) are typical for corporate retreats. Wellness retreats often run **full weeks Sunday-Saturday** to align with weekly schedules.",
    ...
    faq: [
      // 2026-08-01 SD-1 — GSC: "boat retreat" pos 16.5, the page always
      // said "retreat yacht charter" and never the plainer phrase.
      { q: "What is a boat retreat, and does it work in Greece?", a: "A boat retreat is a retreat that happens to float: the same yoga schedule, workshop agenda or leadership off-site you would run at a venue, held on a private crewed yacht that moves to a new sheltered anchorage each day. Greece suits it unusually well - calm morning water for practice, distances short enough that transit never eats a session, and a different swimming stop every afternoon. The formats and real figures for both wellness and executive versions are below." },
      { q: "How much does a retreat yacht charter cost?", a: "On the Greek Charter Index 2026: an executive off-site on a 22 to 25 metre motor yacht for six to eight at EUR 21,000 to 47,500 a week net base, or 26 to 31 metres at 35,900 to 75,000; a wellness retreat on a 20 to 22 metre crewed catamaran for ten at EUR 31,500 to 43,500. Plus APA of 20 to 40% by type and Greek VAT at the certified rate. The five-night Saronic week is the shortest programme this house writes." },
...

  {
    ...
    seoTitle: "Friends Trip Yacht Charter Greece | Group Travel",
    ...
    whyBody:
      ...
      "**The group economics work surprisingly well**. A 20 to 22 metre crewed catamaran for eight friends at EUR 40,000 net base, plus APA at 25%, VAT at 12% and a 12% gratuity, settles around EUR 60,000 all-in for the week: accommodation, all meals, all transport between islands, chef-led dining, no restaurant bills, for the whole party. Comparable to a luxury hotel week but without the fragmentation. " +
    ...
    featuredHeading: "Group-friendly yachts for 2027",
    ...
    faq: [
      ...
      { q: "How much is the week?", a: "Eight friends on a 20 to 22 metre crewed catamaran, EUR 31,500 to 43,500 net base on the Index 2026, about EUR 47,000 to 65,000 all-in: the whole week for the yacht. Ten friends on a 26 to 31 metre motor yacht, EUR 35,900 to 75,000 base, about 62,000 to 100,000 all-in: the week for the yacht." },
...

  {
    ...
    // 2026-08-06 (George's call) — this page was written day-first: the
    // tagline offered a single day, the body called day charters "the most
    // common" pattern, and the FAQ quoted a day price before a week price.
    // The company brokers weekly fully crewed charters. A proposal is still
    // one of the best reasons to take a week, so the occasion stays and the
    // week becomes the offer. No prices are invented: the day figures simply
    // come out, the week figures already existed.
    tagline: "A week built around one evening. The crew handles every detail except the ring.",
    seoTitle: "Proposal Yacht Charter Greece",
    seoDescription: "A crewed week in Greek waters with the proposal built into it. Photographers, chef-prepared dinner, the anchorage chosen for the light rather than the view.",
    ...
    whyBody:
      ...
      "**How we build it**: a full crewed week with the proposal placed on day three or four. By then the partner has stopped watching the schedule, which is the whole trick, and the anchorage can be chosen for the evening light rather than for how close it is to a marina. The photographer is aboard for the moment. The chef has known for weeks and has been building towards that dinner. And then, and this is the part couples tell me about afterwards, there are still three days left: the engagement gets a holiday attached to it instead of a taxi home. " +
    ...
    bestFor: [
      "Engagement weeks with the proposal built into day three or four",
      "Couples who want the days after the yes, not just the yes",
    ...
    featuredHeading: "Two-cabin yachts for 2027",

    whenTitle: "When to plan",
    whenBody: "**June, September, October** are the cinematic-light months for sunset proposals - golden hour stretches longer, water is calm, weather predictable. **May and October** are quietest. Book **4-6 months ahead** for a charter week with the proposal built into it, and longer if the anchorage matters as much as the date.",
    ...
    faq: [
      { q: "How much does a proposal yacht charter cost?", a: "A full week with the proposal built into it runs €60,000 to €140,000 all-in, which is the same figure as an equivalent honeymoon week because that is effectively what it is. Photographer, catering and gratuity sit inside that number rather than on top of it. We no longer place single-day proposal charters; if one evening is all you want, a day-hire operator will serve you better than we would." },
...

  {
    ...
    // 2026-09-07 (plan #13, GEO): 99 impressions at 23.4 and no answer unit.
    quickAnswer: {
      question: "Which yacht suits a milestone celebration in Greece for the whole family?",
      answer: "One that sleeps everyone in a cabin of their own: for eight to ten, a 20 to 24 metre crewed catamaran at EUR 31,500 to 90,000 a week on the Greek Charter Index 2026; for twelve, one of the nine yachts we represent with five or six cabins, from SUMMER FUN at EUR 45,000 to 65,000 to ARIELA at EUR 105,000 to 120,000, per yacht per week before VAT and APA; for more than twelve, two yachts sailing together, each on its own rate card. The milestone day is built into the middle of the week, the chef briefed on it before you board, and the anchorage chosen for the evening rather than the passage.",
    },
    keyFacts: [
      "Twelve guests on one hull, from their own cards: SUMMER FUN EUR 45,000 to 65,000, PROJECT STEEL EUR 55,000 to 67,000, ChristAl MiO 80 (a catamaran) EUR 70,000 to 90,000, CAN'T REMEMBER EUR 80,000 to 90,000, PAREAKI II EUR 98,000 to 115,000, ARIELA EUR 105,000 to 120,000, KOKOMO NIGHTS EUR 120,000 to 140,000.",
      "Twelve is the number most charter yachts are licensed for; a party beyond it sails on two yachts, or on ELYSIUM, a 64 metre passenger-certified ship for up to 49 guests at EUR 162,500 a week.",
      "One price per yacht per week, before VAT at 5.2 to 12% by certification, APA of 20 to 30% on a catamaran or 30 to 40% on a motor yacht, and a customary 10 to 15% crew gratuity on the base.",
      "The milestone evening: Hydra Town harbour stern-to on the mooring chains, or Dokos five miles west, 6 to 12 metres over sand and no other lights; in the Cyclades, Soros on Antiparos, sheltered from every direction, or the Ammoudi buoys below Oia.",
      "Fixed dates need the longest lead: six to twelve months for July and August on the Index, and a specific anniversary date on a specific yacht is a same-week decision when the yacht is free. Family parties were one in six of the 68 enquiries this desk logged in 2026.",
    ],
    evidence: { label: "George Yachts Greek Charter Index 2026 and anchorage guides", href: "/greek-charter-index-2026" },
    // 2026-08-06 (job 11) — "milestone yacht charter" brings 149 impressions
    // at position 28.1, and it is the cleanest demand we have: 76 from the US
    // and 72 from the UK, one page serving it, no cannibalisation, and a week
    // aboard rather than a day out, which is the product we actually sell.
    // The old title simply repeated the h1 with no reason to click. The
    // occasions were the reason all along; they were just buried in bullets.
    seoTitle: "Milestone Yacht Charter Greece: Birthdays and Anniversaries",
    seoDescription: "A 60th, a 25th anniversary, a retirement, a family reunion. Why a charter week holds a milestone better than a venue rented for one evening.",
    ...
    featuredHeading: "Family-celebration yachts for 2027",

    // 2026-08-06 (job 11) — "When to book" said nothing a search engine or a
    // reader could match. "anniversary yacht charter" sits at position 51.7 on
    // this same page while the word appears twice in the whole document.
    whenTitle: "When to book a milestone or anniversary charter",
    ...
    insiderTips: [
      ...
      "Crew gratuity for milestone celebrations is typically the high end: 15% of base rate, paid by the principal in cash.",
    ...
    faq: [
      { q: "How much does a milestone yacht week cost?", a: "On the Greek Charter Index 2026 a 26 to 31 metre motor yacht for eight to twelve lists at EUR 35,900 to 75,000 a week net base, a 35 to 40 metre at 59,900 to 150,000, plus APA of 30 to 40% and Greek VAT at the certified rate. A two-yacht flotilla for 14 to 24 guests is two rate cards side by side. One price per yacht per week, for the whole family." },
      ...
      // 2026-08-06 (job 11) — two exact-match answers. "anniversary yacht
      // charter" was at 51.7 with nothing on the page phrased that way, and
      // the 50th-birthday variant already ranks at position 6, which says the
      // named occasion is what gets matched. Nothing new is claimed below:
      // both answers restate what the body and the tips already say.
      { q: "What is an anniversary yacht charter?", a: "The same week as any other charter, shaped around one evening. A 25th or 50th anniversary usually means two principals and the family who came because of them, so the boat is chosen for how it seats a long table rather than how fast it moves. The anniversary itself is placed on day three or four, once everyone has stopped travelling and started relaxing, and the chef builds that day's menu as courses rather than meals. The rest of the week is the part couples tend to remember, which is the days either side of the dinner." },
      { q: "Which yacht suits a 50th or 60th birthday with the family aboard?", a: "For eight to twelve people, a 30 to 50 metre yacht. The number that matters is not length, it is whether everyone can eat at one table on deck, because a milestone dinner split across two tables stops being one occasion. Above fourteen guests we usually propose two yachts travelling together rather than one larger boat: it is often less expensive, and it lets the generations keep their own rhythm during the day and come together at night." },
    ],
