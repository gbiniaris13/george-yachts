          ...
          {availableLocales.map(l => (
            <button
              ...
              style={{
                ...
                fontFamily: "'Montserrat', sans-serif",
                fontSize: 11,
                color: locale === l.code ? '#DAA110' : 'rgba(248, 245, 240,0.5)',
                background: locale === l.code ? 'rgba(218, 161, 16,0.08)' : 'transparent',
                border: 'none',
            ...
            >
              ...
              <span>{l.label}</span>
              {locale === l.code && <span style={{ marginLeft: 'auto', fontSize: 10, color: '#DAA110' }}>✓</span>}
            </button>
          ))}
        </div>
      )}
