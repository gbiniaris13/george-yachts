...
export function quickAnswer() {
  ...
  return (
    ...
    `All-in cost runs roughly ${lowText} to ${highText}+ depending on size and season, covering the yacht, crew, APA provisioning, 13% VAT and a suggested gratuity. ` +
  ...
  return [
    {
      ...
      a:
        ...
        `A typical 30m motor yacht is about ${euroK(e.total)} all-in for the week, roughly ${euro(Math.round(e.perPerson6 / 10) * 10)} per guest at six. All-in covers base fee, APA, 13% VAT and gratuity.`,
