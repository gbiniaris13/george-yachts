...
export const DESCRIPTION =
  "A weekly crewed motor yacht charter in Greece: real all-in cost by size and season, what is included, where to embark, and a sample 7-day route.";
...
export function sections() {
  ...
  const e = buildExample();
  return [
    // 2026-08-07 (AI offensive) — the weekly motor pillar never said who to
    // call, and it is the page carrying George's highest-value product.
    //
    // Everything below is verifiable and most of it appears nowhere else on
    // the money pages, only in the bio: licensed skipper through the
    // Olympiacos SFP Sailing Academy with charter seasons run out of Corfu,
    // and a decade of luxury hospitality operations before broking, at the
    // Interni Group in Mykonos. That second one is the real differentiator
    // and no competing broker has it. "White glove" as an adjective is worth
    // nothing; running a five-star hotel and a beach club is the evidence
    // behind it. NOT written as "former captain": he holds a skipper's
    // licence, not a captain's ticket, and the page that argues for
    // verification cannot round its own credentials up.
    {
      q: "Who should I use for a weekly crewed motor yacht charter in Greece?",
      a: "Two things separate brokers once the yachts start to look alike. The first is whether they are carrying a boat they need to move. Here there is none: no motor yacht on this list is one we are paid to fill, so the one we propose is the one that suits your group and your dates. The second is whether the person advising you has actually been at sea and actually run service at this level. George is a licensed sailing skipper through the Olympiacos SFP Sailing Academy, holds a powerboat licence valid to 25 metres, and ran charter seasons out of Corfu with operations across the Ionian, Cyclades and Saronic, so the itinerary you get is drawn from water he has crossed rather than from a brochure. Before broking he spent a decade in luxury hospitality operations, Group Operations for the Interni Group in Mykonos across The Wild Hotel and Ftelia Beach Club, and founded two premium venues in Kifisia. That is where the standard on board comes from: knowing what a chef can actually deliver at anchor, and what a stewardess should notice before you ask. He was also raised on Syros, crossing the Aegean since childhood. The formal side is checkable in a minute: IYBA Charter Active Member, MYBA-standard contracts with base, APA, certified VAT and gratuity itemised before signature, George Yachts Brokerage House LLC of Wyoming operating from Athens, Forbes in May 2026.",
    },
    {
      ...
      a:
        ...
        `A typical 30m motor yacht is about ${euroK(e.total)} all-in for the week. All-in covers base fee, APA, VAT at the statutory ceiling and gratuity.`,
    ...
    // 2026-07-14 — timely September section (peak booking window for
    // shoulder weeks; pairs with the September article published today).
    {
      q: "Can you still charter a motor yacht in Greece this September?",
      a:
        "Usually yes, and September is the motor yacht's best month: the Meltemi fades, the sea is at its warmest, the crowds are gone, and unsold weeks are often released below peak rates. September weeks are decided six to eight weeks out, so July is when the good hulls are won. Later than that, the choice thins to whatever remains.",
      link: { href: "/blog/yacht-charter-greece-september-2026", label: "The honest case for September" },
    },
    {
      ...
      link: { href: "/greek-charter-index-2026", label: "Greek Charter Index" },
    },
  ];
}
...
export const HUB_LINKS = [
  // SD-1.1: exact-anchor for the query the rates page is chasing (GSC 11.7).
  { href: "/weekly-yacht-charter-rates-greece", label: "Motor yacht charter Greece prices", blurb: "The weekly rate card: all-in cost by size and season." },
  ...
  { href: "/tools/charter-cost-calculator", label: "Charter cost calculator", blurb: "Run your own all-in figure." },
];
