...
export const LONG_TAIL_PAGES = [
...

  {
    ...
    faq: [
      { q: "What's included in a crewed yacht charter?", a: "Base rate covers the yacht, crew, insurance, and routine maintenance. APA (paid separately, 25-30% of base rate) covers fuel, food, drinks, dockage, and other running costs. Crew gratuity (10-15% at end) is separate." },
