...
export const LONG_TAIL_PAGES = [
...

  {
    ...
    keyFacts: [
      ...
      "Embarkation: Athens (Alimos) for the Cyclades and Saronic, Lefkada or Corfu for the Ionian, Skiathos for the Sporades, Rhodes for the Dodecanese",
