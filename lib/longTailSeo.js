...
export const LONG_TAIL_PAGES = [
...

  {
    ...
    faq: [
      ...
      { q: "Is security available?", a: "Yes, through partners: close-protection officers with a service background, coordinated with the captain and the broker discreetly, and quoted per assignment." },
