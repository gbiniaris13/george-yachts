...
export const LONG_TAIL_PAGES = [
  ...
  // the reader down to the right satellite.
  {
    ...
    whenBody:
      "The luxury tier books earliest of the whole fleet, because there are only sixteen boats and the best two or three weeks of the summer are the same weeks for everyone. **For peak July and August 2027, the conversation starts in autumn 2026.** Early season (late April to mid-June) and late season (mid-September to October) are the connoisseur windows: the same yachts at 25 to 40% below peak, empty anchorages, and the light that photographers wait all year for. A luxury week is least itself in a crowded August bay, which is one more argument for the shoulder months.",
...

  {
    ...
    seoDescription: "Superyacht charter across the Cyclades this season. 30-60 metre vessels with full crew, chef, two tenders. Mykonos, Santorini, Paros, Folegandros. From €280K.",
    ...
    insiderTips: [
      ...
      "Crew gratuity convention 10-15% of base rate. For a €350K base-rate week, plan €35-€52K cash gratuity.",
    ...
    faq: [
      { q: "How much does a 2026 Cyclades superyacht charter cost?", a: "30-metre weeks start €280K base. 40-metre: €450-€800K. 50-metre megayacht: €900K-€1.4M. Plus 30-35% APA and Greek VAT at the certified rate (5.2-6.5% is common at this size)." },
...

  {
    ...
    seoDescription: "Crewed yacht charter across Greek islands this season. Captain, chef, hostess on every vessel. Cyclades, Ionian, Saronic, Sporades, Dodecanese. From €18K weekly.",
    ...
    faq: [
      ...
      { q: "Do I tip the crew?", a: "Yes. Convention is 10-15% of base rate, paid in cash to the captain on the final day. The captain distributes to crew. For a €60K base rate week: typical tip is €6-€9K." },
...

  {
    ...
    faq: [
      ...
      { q: "What's the typical weekly rate?", a: "50-metre megayacht: €900K-€1.4M base. 60-70 metre: €1.4M-€2.5M+. Plus APA (30-35%) and Greek VAT at the certified rate (5.2-6.5% is common at this size)." },
