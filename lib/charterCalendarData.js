...
export const SCORES = {
  ...
  mykonos: {
    may: { score: 3, note: "Water still 18-20°C, Meltemi not yet established. Anchorages empty. Pricing 15 to 25% below peak on the Greek Charter Index." },
  ...
  milos: {
    ...
    sep: { score: 5, note: "Best month. Water 24°C, geology untouched, charter rates 15 to 25% below peak on the Greek Charter Index." },
...
export function scoreColor(score) {
  ...
  switch (score) {
    case 5: return "rgba(218, 161, 16, 0.95)";   // strongest gold
    case 4: return "rgba(218, 161, 16, 0.65)";
    case 3: return "rgba(218, 161, 16, 0.38)";
