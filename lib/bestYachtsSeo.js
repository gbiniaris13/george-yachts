...
export const BEST_YACHTS_PAGES = [
  ...
  },
  {
    ...
    tagline: "Sailing vs power catamarans. Which sizes work for which use cases. The Greek catamaran landscape.",
    quickAnswerQ: "What's the best catamaran charter in Greece?",
    quickAnswerA: "For Greek catamarans, target a sailing catamaran 50-55ft for budget (€35-60k weekly), power catamaran 60-80ft for premium (€85-180k), or luxury catamaran 80-100ft (Sunreef class) for UHNW (€140-240k). Catamarans access shallow Cyclades anchorages (Donousa, Despotiko) and offer 50% more deck space at equivalent length to monohulls.",
    yachts: [
      { spec: "Sailing catamaran 50-55ft (Lagoon, Bali)", weekly: "€35,000-60,000", why: "Standard family-charter catamaran" },
      { spec: "Power catamaran 60-80ft (Sunreef Power, Aquila)", weekly: "€85,000-180,000", why: "Faster + quieter + larger" },
      { spec: "Luxury sailing catamaran 80-90ft", weekly: "€100,000-180,000", why: "Premium amenity, full crewed" },
      { spec: "Luxury power catamaran 80-100ft (Sunreef)", weekly: "€140,000-240,000", why: "UHNW spec - 6 cabins, electric option, sustainability optic" },
    ],
    faq: [
      { q: "Sailing or power catamaran for family?", a: "Sailing for lower cost + relaxed pace + sailing experience. Power for faster passages + larger interior + quieter at anchor (no rigging noise)." },
      ...
      { q: "What's the largest catamaran in the Greek market?", a: "Sunreef 100s and 110s appear in Greek waters occasionally - €240k+ weekly. Most consistent inventory tops at 80-90ft." },
    ],
