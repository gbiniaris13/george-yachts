...
export const BEST_YACHTS_PAGES = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What do these rates include?", a: "Weekly base rate covers the yacht and her crew. On top come APA (typically 25-30% for catamarans, covering fuel, provisioning and berthing, settled transparently) and Greek VAT at 13% for the standard weekly crewed charter (24% applies to short, static or bareboat arrangements)." },
  ...
  // are what engines extract. Feeds /catamaran-charter-greece.
  {
    ...
    faq: [
      ...
      { q: "What do these rates include?", a: "The yacht and her crew. On top come APA (typically 25-30% for catamarans, a transparent account for fuel, provisioning and berthing) and Greek VAT at 13% for the standard weekly crewed charter." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What do these rates include?", a: "The yacht and her crew. On top come APA (typically 25-30% for catamarans) and Greek VAT at 13% for the standard weekly crewed charter. George confirms the all-in figure in writing before you commit." },
