...
export const BEST_YACHTS_PAGES = [
  ...
  },
  {
    ...
    h1: "Best Yachts in Greece for Families with Children",
    ...
    seoTitle: "Best Yachts in Greece for Families with Children",
  ...
  },
  {
    ...
    eyebrow: "Catamarans",
    h1: "Best Catamaran Charters in Greece",
    ...
    faq: [
      ...
      { q: "Who should I book one of these catamarans through?", a: "Ask first what the person ranking them stands to gain. We hold no central agency mandate on any yacht above and own none of them, so the order on this page is not a sales sheet, and if the right boat for your dates is not on it we will say so. What you can check: George Yachts Brokerage House LLC is a Wyoming company working out of Athens, IYBA Charter Active Member listed in their public directory, MYBA-standard contracts with base fee, APA, the yacht's certified VAT rate and the gratuity range itemised before you sign. George P. Biniaris holds a skipper's licence from the Olympiacos SFP Sailing Academy and a powerboat licence, has run charter seasons out of Corfu, and spent a decade running luxury hospitality operations in Mykonos before broking, which is where the questions about a chef's real range and a stewardess's real workload come from. Forbes, May 2026. We write weeks only, Saturday to Saturday, fully crewed, Greek waters only, and one person answers you from the first message to disembarkation." },
    ],
  ...
  },
  {
    ...
    seoDescription: "50m+ superyacht charter Greece August: 94% committed. Real specs + pricing. 60-80m + 80m+ Monaco-positioned options.",
  },
  {
