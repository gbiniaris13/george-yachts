 ...
 * day" and "€9,000 and above", and an exhibitor who shows yachts there writes
...
export const YACHT_AWARDS = {
  // 2026-09-08. The first VESSEL awards in this registry. Everything below
  // them is a crew award, won by a person at a Greek charter show; these two
  // were won by the hull herself, at the international show, and a hull
  // cannot change crew out from under a claim. That is why she leads the
  // section, and the ordering in AwardedFleet.jsx says so explicitly rather
  // than leaving it to a count of first places.
  //
  // Matched to this hull, not to the model line: Boat International's own
  // editorial on this yacht states she "had won two World Superyacht Awards
  // back in 2009", identifying her under the name she carried then. The
  // model line, the Sanlorenzo 40Alloy, is not what was judged.
  naia: [
    {
      kind: "vessel", rank: 1,
      competition: "Best Semi-Displacement or Planing Motor Yacht, 30m to 39m",
      tier: null,
      award: "Winner, Best Semi-Displacement or Planing Motor Yacht, 30m to 39m",
      organiser: "World Superyacht Awards", year: 2009,
      source: "boatinternational.com editorial on this yacht, and the 2009 results",
      checked: "2026-09-08",
      hull: "Sanlorenzo 40Alloy, 38.5 m, delivered 2009, previously named Bliss Easy and Onyx. The awarding body's own editorial ties both wins to this hull.",
    },
    {
      kind: "vessel", rank: 1,
      competition: "Best Exterior Styling, Motor Yacht",
      tier: null,
      award: "Winner, Best Exterior Styling, Motor Yacht",
      organiser: "World Superyacht Awards", year: 2009,
      source: "boatinternational.com editorial on this yacht, and the 2009 results",
      checked: "2026-09-08",
      hull: "Same hull as above. Exterior by Francesco Paszkowski.",
    },
  ],
  "above-beyond": [
    {
    ...
    },
    {
      ...
      source: "the yacht's central-agent listing",
      checked: "2026-08-21",
    },
    {
  ...
  // so the name alone proved nothing. the exhibitor's own published lineup for
  ...
  "christal-mio": [
    {
      ...
      source: "the yacht's central-agent listing",
      checked: "2026-08-21",
      hull: "the central agent's EMMYS 2026 lineup lists one CHRISTAL MIO: Power Catamaran, Fountaine Pajot Power 67, 19.49 m. ChristAl MiO 80 is not in that lineup.",
    },
  ],
  ...
  // rest on the central agent naming this hull, and they are the weakest sourcing in the
...
export const WITHHELD = {
  "above-beyond-tablescaping-2025":
    "CONTESTED. One central-agent listing records a 1st Place Diamond in " +
  ...
  "pareaki-ii":
    "Checked against Sanity, all 30 fleet brochures, the the central agent page, web " +
    "search and George's own mail. Nothing anywhere. It may be true and " +
    "simply unwritten; it needs written confirmation from the central agent or the central agent.",
};
...
export const HONOURS = {
  // 2026-09-08. Finals, not wins, and written as finals. Both were verified
  // against the show's own published category pages under the names the
  // yachts carried at the time, because a name alone proves nothing.
  "black-lion": [
    {
      kind: "vessel",
      award: "Finalist, Interior Layout Award: Sailing Yachts",
      organiser: "ShowBoats Design Awards", year: 2013,
      note: "Entered as Xnoi. The award went to another yacht.",
      source: "the 2013 category results",
      checked: "2026-09-08",
    },
    {
      kind: "vessel",
      award: "Finalist, Naval Architecture Award: Sailing Yachts",
      organiser: "ShowBoats Design Awards", year: 2013,
      note: "Entered as Xnoi. The award went to another yacht.",
      source: "the 2013 category results",
      checked: "2026-09-08",
    ...
    {
      kind: "vessel",
      award: "Finalist, Best Sailing Yacht, 30m to 40m",
      organiser: "World Superyacht Awards", year: 2013,
      note: "Entered as Xnoi. The award went to another yacht.",
      source: "the 2013 finalists list",
      checked: "2026-09-08",
    },
  ],
  "riana-ii": [
    {
      kind: "vessel",
      award: "Finalist, Semi-Displacement or Planing Two Deck Motor Yacht, 30m to 37.99m",
      organiser: "World Superyacht Awards", year: 2015,
      note: "Entered as H1, the first hull of her line. The award went to another yacht.",
      source: "the 2015 finalists list",
      checked: "2026-09-08",
    },
  ],
  "just-marie-2": [
 ...
 * Yachting, the central agent and the central agent. "Δεν έχουμε permission να βάλουμε άλλα σκάφη."
 *
 ...
 */
// 2026-09-08: the houses are held as codes, not names. This repository is
// public, and which house shows which hull is their business and George's,
// not the internet's. The code-to-name map lives in the CRM, in the same
// private settings row as the social policy, and nowhere in git.
export const PERMITTED_HOUSES = ["house-a", "house-b", "house-c", "house-d"];

export const PLACED_BY = {
  // 2026-09-08 additions, shown by house-d.
  naia: "house-d",
  "black-lion": "house-d",
  "riana-ii": "house-d",
  "above-beyond": "house-a",
  "ad-astra": "house-a",
  alena: "house-a",
  aphaea: "house-a",
  "christal-mio": "house-a",
  "crazy-horse": "house-a",
  elly: "house-a",
  kimata: "house-a",
  "pi-2": "house-a",
  ...
  samara: "house-a",
  serenissima: "house-a",
  "just-marie-2": "house-a",
  alina: "house-a",
  // another house showed all four of these at MEDYS in the years they placed.
  // SAMELI is the one worth a note: another house exhibited her in 2023 and another house has
  // done so since 2024. Her placing is 2024, so it is another house's boat in the
