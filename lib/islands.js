...
export const ISLANDS = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Per yacht, anywhere from €15,000/week (smaller catamaran in shoulder season) to €235,000/week (50m motor yacht like La Pellegrina 1 in peak August). Catamaran Fleet, smaller crewed yachts, from €4,200/week for the yacht. Mykonos itself doesn't change the yacht rate  -  what changes the rate is the week of the year.",
      },
    ],
