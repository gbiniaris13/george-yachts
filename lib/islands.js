...
export const ISLANDS = [
  {
    ...
    itineraryYachts: ["serenissima", "genny", "above-beyond"],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes. Several yachts base in or near Mykonos through the high season, and most of the rest will reposition there for a charter start at no extra cost during peak weeks. Which yachts are on the mooring in your week is a question for the week itself, and George answers it with names and dates.",
      },
      {
      ...
      },
      {
        ...
        a: "Per yacht, anywhere from €17,000/week net base (a 12 to 16 metre crewed sailing catamaran on the Greek Charter Index) to €235,000/week (a 50m motor yacht like La Pellegrina 1 in peak August). Every rate is per yacht, per week, fully crewed. Mykonos itself doesn't change the yacht rate  -  what changes the rate is the week of the year.",
      },
    ],
  ...
  },
  {
    ...
    itineraryYachts: ["kimata", "genny", "la-pellegrina-1"],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yachts reposition to Santorini for a charter start at no extra cost, and Vlyhada is the boarding point. Santorini has no natural harbour, so nothing bases there year round; ask George which yachts are in range for your dates.",
      },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "P/CAT ARIVA works the Ionian out of Corfu, and several other yachts will reposition there at no extra cost for a charter start. Corfu is the natural base for an Ionian week: shorter legs, softer weather, and no Meltemi to plan around.",
      },
      {
  ...
  },
  {
    ...
    itineraryYachts: ["majesty-of-greece", "serenissima", "alena"],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The smaller catamarans (Alena, Majesty of Greece, Serenissima) are perfect for Saronic loops  -  short legs, easy mooring, gentle pace. Larger motor yachts work too but can feel oversized for the islands.",
      },
      {
...

  {
    ...
    itineraryYachts: ["genny", "above-beyond", "kimata"],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The Cyclades and Southern-Cyclades yachts can all call at Folegandros. Genny and Above & Beyond include it as standard on 7-day Southern Cyclades loops. Smaller catamarans handle the anchorages most comfortably.",
      },
    ],
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "ARIVA (Corfu) and MANU (Zakynthos) are based in the Ionian; no yacht on the list is based at Lefkada. Most other yachts will reposition to Lefkada for charter starts at no extra cost  -  typically a 24-hour journey from Athens.",
      },
    ],
...

  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Huayra, Kimata, and the catamarans Summer Star and Alteya include Kefalonia in every Ionian itinerary. Larger yachts (La Pellegrina 1, Above & Beyond) reach Kefalonia from Athens on extended 10-14 day Western Greece charters.",
      },
    ],
...

  {
    ...
    faq: [
      ...
      { q: "Can we combine Rhodes with Turkish coast charter?", a: "Not through this house. Our weeks begin and end in Greek waters and are arranged from Athens, Lefkada and Corfu; this page stays as a guide to Rhodes. Cross-border charters to the Turkish coast exist in the trade on yachts whose flag and paperwork allow it, and they are not ours to arrange." },
      ...
      // 2026-09-04. The page fell from position 14 to 30 for "rhodes
      // yacht charter" in the mid-August re-evaluation. Distances below
      // are from lib/sailingDistances.js, nothing estimated.
      { q: "How far is Rhodes from Symi, Kos and Patmos by yacht?", a: "Rhodes to Symi is 25 nautical miles, an easy morning on any yacht and the classic first day. Rhodes to Kos is 45 nm, Kos to Symi 30 and Kos to Patmos 35, which is why the seven-day loop reads Rhodes, Symi, Kos, Patmos and back with no leg longer than a lunch-to-anchorage afternoon. Athens is 270 nm away and Santorini 130, so a yacht based in Athens reaches Rhodes on a delivery, not as part of your week." },
      { q: "Is Rhodes a good base for a catamaran charter?", a: "One of the best in Greek waters. The meltemi that shapes the Cyclades arrives here softened, the east coast of Rhodes and the whole of Symi give sheltered water, and the distances between islands are short enough that a catamaran sails them without a long open-sea passage. Families and groups of eight to ten who want the table set at sea and a shallow-draft bay every evening are the guests we send here first." },
      { q: "How do we get to Rhodes to board the yacht?", a: "Rhodes has an international airport with direct seasonal flights from most of Europe from April to October and year-round connections through Athens, fifty minutes away. Mandraki marina in Rhodes town is twenty minutes from the terminal. Guests arriving from the United States usually connect through Athens or London and board the same evening." },
    ],
...

  {
    ...
    faq: [
      ...
      // 2026-09-04. The page fell from position 14 to 26 for "sporades
      // yacht charter" in the mid-August re-evaluation. Distances below
      // are from lib/sailingDistances.js, nothing estimated.
      { q: "How far are the Sporades from Athens by yacht?", a: "Skiathos is 145 nautical miles from Alimos marina in Athens and 120 from Lavrio, which is a full day and a night on a sailing catamaran and a long day on a motor yacht. That is why a Sporades week either boards at Skiathos, with the yacht repositioned ahead of the guests, or becomes a ten-day charter that sails up through Evia and back. Skiathos to Skopelos is 15 nm, and the whole Skiathos, Skopelos, Alonissos loop sails in short morning legs." },
      { q: "Are the Sporades good for a catamaran charter?", a: "The best-kept secret in Greek catamaran chartering. The meltemi sits to the south in the Cyclades, the water is green and calm inside the island group, and the pine-fringed bays of Skopelos and Alonissos are shallow, sandy and empty even in August. A catamaran with six to ten guests, a captain and a cook is the week we propose here more than any other." },
      { q: "When is the best month for a Sporades yacht charter?", a: "June and September. The water is warm from mid-June, the wind is light, the marine park is at its clearest and the islands are still quiet. July is excellent and busier; August is the Greek holiday month and the coves fill with local boats at the weekend, though the yacht anchorages stay calm. May and early October work on a motor yacht for guests who accept cooler swims." },
    ],
...

  {
    ...
    faq: [
      // 2026-08-01 SD-1 — GSC: "motor yacht symi" 30 impressions at pos 10.8
      // in July, zero clicks; the page never said "motor yacht" once.
      { q: "Can I charter a motor yacht to Symi?", a: "Yes, and a motor yacht is the natural Symi platform: from Rhodes the harbour is about 90 minutes at motor yacht pace, which turns Symi into an easy overnight or even a long-lunch call on a Dodecanese week. Rhodes-based motor yachts in the 30-40m range treat Rhodes-Symi-Kos-Patmos as the standard 7-day loop, and shallower-draft motor yachts under 35m open more mooring options inside the tight neoclassical harbour." },
...

  {
    ...
    faq: [
      // 2026-08-24 weekly GSC strike. The whole Crete cluster lands on this
      // one page and takes zero clicks: "yacht charter crete" 55 impressions
      // at 27.2, "yacht charter crete greece" 15 at 19.9, "motor yacht crete"
      // 12 at 15.8, "chania yacht charter" 12 at 10.3, "yacht charter chania"
      // 5 at 9.8. The FAQ answered Elafonisi, departure ports and season, and
      // never answered the head term or its price. Figures from
      // lib/charterIndex2026.js (Q4 refresh, 2026-08-15).
      { q: "How much does a yacht charter in Crete cost?", a: "The same as the same yacht anywhere else in Greek waters. Greek owners hold one weekly rate per vessel rather than a regional one, so the boat that starts from Chania in June carries the identical rate card in the Cyclades in August. Across the ninety-six fully crewed yachts we represent that net base runs from EUR 17,000 a week for a 15 metre sailing catamaran to EUR 150,000 for a 39 metre motor yacht, per yacht, per week. Greek VAT at the yacht's certified rate, 5.2 to 12 percent in practice, an Advance Provisioning Allowance and a customary crew gratuity of 10 to 15 percent of the base sit on top. What Crete changes is length rather than price: the island rewards 10 to 14 days, so the number of days moves the total more than the region does." },
      { q: "Can you charter a motor yacht in Crete?", a: "Yes. Chania's Venetian harbour takes the smaller yachts and Souda Bay marina, fifteen minutes east, takes the larger ones, with Heraklion and Agios Nikolaos as east-coast alternatives. Motor yacht pace is what makes the island work: the west coast run past Falasarna to Balos and Elafonisi becomes a relaxed day rather than a passage, and the south coast at Loutro comes within reach. Weekly net base runs from EUR 17,500 at 18 to 20 metres for six to eight guests, EUR 21,000 to 47,500 at 22 to 25 metres, and EUR 35,900 to 75,000 at 26 to 31 metres, before Greek VAT and APA." },
      // 2026-08-01 SD-1 — GSC: "motor yacht elafonisi" pos 8.8 with zero
      // clicks; the page mentioned Elafonisi as an anchorage but never
      // answered the motor-yacht question directly.
      { q: "Can we reach Elafonisi by motor yacht?", a: "Yes, and a motor yacht from Chania is the comfortable way to do it: Elafonisi sits on Crete's south-west corner, past Falasarna and Balos, and motor yacht pace turns that west-coast run into a relaxed day rather than a passage. Anchor off the pink-sand lagoon in the morning when the colour is most vivid, then transit onward. In peak July-August the west coast is meltemi-exposed, so the anchorage is picked on the day with the captain." },
      ...
      { q: "Can we visit the Cyclades on a Crete-based charter?", a: "As a routing, yes: Crete to Santorini is about 60 nautical miles and the southern Cyclades open from there. This house arranges its weeks from Athens, Lefkada and Corfu and keeps this page as a guide to Crete; a Cyclades week that reaches Santorini boards at Alimos, 130 nautical miles away on the house table." },
...

  {
    ...
    faq: [
      ...
      // 2026-06-10 GSC-driven: "motor yacht sifnos" sat at pos 11.9
      // with zero motor-yacht phrasing anywhere on this page.
      { q: "Can you charter a motor yacht to Sifnos?", a: "Yes. Sifnos lies about 75 nm from Athens, which a crewed motor yacht covers in under four hours at cruising speed, making it a natural second or third night on a Cycladic loop. Kamares and Platis Gialos handle tenders comfortably, and the leeward east-coast anchorages give motor yachts calm overnights even in Meltemi season." },
    ],
  ...
  // Cyclades
  {
    ...
    insiderTips: [
      ...
      "Ios → Santorini is 25 nm with prevailing Meltemi astern: 2.5 to 3 hours under motor, 4 hours under sail. Plan dawn departure for the Santorini caldera arrival in afternoon light.",
    ],
    faq: [
...

  {
    ...
    itineraryYachts: ["genny", "above-beyond", "serenissima"],
...

  {
    ...
    itineraryYachts: ["genny", "serenissima", "above-beyond"],
...

  {
    ...
    itineraryYachts: ["serenissima", "genny", "kimata"],
  ...
  // Dodecanese
  {
    ...
    faq: [
      { q: "Can we charter Kos with a Turkish-coast leg?", a: "Not through this house. Bodrum is a few miles across the strait, and cross-border charters exist in the trade on yachts whose flag and paperwork allow it, but our weeks begin and end in Greek waters and are arranged from Athens, Lefkada and Corfu. This page stays as a guide to Kos." },
  ...
  // Sporades
  {
    ...
    itineraryYachts: ["genny", "kimata", "serenissima"],
