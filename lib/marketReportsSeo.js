...
export const MARKET_REPORTS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFindings: [
      ...
      "Of the yachts we represent, **42 of 65 are catamarans**, 27 sailing and 15 power, against 17 motor yachts and 6 sailing monohulls.",
    ],
    sections: [
      {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "It is taking share. Booking Manager put catamarans at 30% of booked weeks in 2025 while motor yachts still held 57.52% of revenue, and The Traveler counted 904 catamarans among 3,030 Greek charter vessels. Of the 65 yachts we represent, 42 are catamarans.",
      },
    ],
