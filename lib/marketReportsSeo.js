...
//      the current rate cards of the ninety-three fully crewed yachts we
...
const SRC = {
  ...
  nj: src("a global brokerage house's 2026 charter market report", ""),
  bookingMgr: src(
    "Booking Manager",
    "https://www.booking-manager.com/en/blog/state-of-the-yacht-charter-industry-2025.html"
  ),
  // 2026-09-08: named a charter booking platform, which is a competitor.
  // Same treatment as the brokerage source above: the finding stays, the
  // name goes, and the link with it.
  bookingPlatform: src("a large charter booking platform's 2025 review", ""),
  traveler: src(
    "The Traveler",
  ...
  index: `<a href="/greek-charter-index-2026" style="color:${GOLD};text-decoration:none">Greek Charter Index 2026</a>`,
};
...
const INDEX_BANDS = {
  ...
  rows: [
    ...
    ["Sailing catamaran, 16 to 19m", "8 to 10", "18,900 to 41,500", "4"],
    ["Sailing catamaran, 20 to 22m", "8 to 10", "31,500 to 43,500", "7"],
    ["Sailing catamaran, 23 to 24m", "8 to 10", "54,900 to 90,000", "7"],
    ...
    ["Motor yacht, 18 to 21 m", "6 to 8", "17,500 to 28,000", "3"],
    ["Motor yacht, 22 to 25 m", "6 to 8", "21,000 to 47,500", "2"],
    ["Motor yacht, 26 to 31m", "7 to 12", "35,900 to 75,000", "5"],
    ["Motor yacht, 35 to 40m", "10 to 12", "59,900 to 150,000", "5"],
    ["Superyacht, 50m and above", "12 to 49", "162,500 to 235,000", "2"],
    ["Sailing monohull, 24 to 31m", "8", "24,000 to 55,000", "4"],
  ],
};
...
export const MARKET_REPORTS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    methodology:
      "This retrospective was rewritten on 6 September 2026 to remove modelled figures that appeared in the April edition. Every number that remains is either taken from the George Yachts Greek Charter Index 2026, which compiles the current rate cards of the ninety-three fully crewed yachts we represent, or from a third-party publication linked where the figure appears. Availability and demand statements are the observation of one Athens desk, not a survey of the Greek fleet, and the section marked opinion is exactly that. We do not hold industry-wide booking data and do not claim to.",
    faq: [
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    reportType: "snapshot",
    executiveSummary:
      "At mid-year the Greek crewed market looked like this from an Athens desk: the Mediterranean Yacht Show in Nafplio drew 106 yachts and 485 brokers in early May, the crewed rate cards held their structure with the floor at EUR 10,900 a week, and the enquiries reaching us were overwhelmingly for a full seven-night week departing Athens. Booking lead times across the wider market shortened, per a global brokerage house's 2026 market report, while the peak weeks on the best Greek yachts still moved a year ahead. The catamaran remained the hull most families asked for.",
    keyFindings: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Across the wider market, yes: a global brokerage house's 2026 market report put the average falling from 118 days in 2025 to 83 in 2026. The peak July and August weeks on the most requested Greek yachts are the exception and still move six to twelve months ahead, and a year or more for premium yachts above 40 metres.",
      },
      {
        q: "How long a charter do most clients ask for?",
        a: "Seven nights. Of the 57 dated enquiries this desk logged between 30 May and 6 September 2026, 31 asked for exactly seven nights. The same global market report puts the market-wide median rising from seven nights to eight.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          `Peak pricing in Greece is the rate card itself: an owner quotes one Greece-wide weekly fee per yacht, and the shoulder discount is taken off that. The bands below are the current cards of the ninety-three fully crewed yachts on the ${SRC.index}, per yacht per week before VAT and APA. VAT is invoiced at 5.2, 6.5, 7.8 or 12% by certification, APA runs 20 to 30% of the base on sailing yachts and catamarans and 30 to 40% on motor yachts, and a 10 to 15% crew gratuity on the base is customary.`,
        dataTable: INDEX_BANDS,
      },
      {
