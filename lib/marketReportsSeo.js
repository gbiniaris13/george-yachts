  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          `The crewed market in Greece prices by yacht, not by region: an owner publishes one Greece-wide rate card per boat, and the same yacht carries that card to the Cyclades, the Ionian or the Saronic. The table below is the band structure we quoted from through the quarter, taken from the current rate cards of the ninety-six fully crewed yachts on the ${SRC.index}. Nothing in it is an average or a model; each cell is the lowest and highest figure that appears on a rate card in that band. The floor for a fully crewed week is now EUR 17,000 for a 15 metre sailing catamaran, and the two yachts above 50 metres run from EUR 162,500 to EUR 235,000.`,
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          `The bands below are the current rate cards of the ninety-six fully crewed yachts on the ${SRC.index}, per yacht per week before VAT and APA. Greek VAT on a weekly crewed charter is invoiced at 5.2, 6.5, 7.8 or 12% depending on the yacht's certification, with 13% the statutory ceiling. APA runs 20 to 30% of the base for sailing yachts and catamarans and 30 to 40% for motor yachts, and a crew gratuity of 10 to 15% of the base is customary. A EUR 20,000 base catamaran week lands around EUR 25,000 to 28,500 all-in before gratuity.`,
        dataTable: INDEX_BANDS,
      },
    ],
    methodology:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          `Peak pricing in Greece is the rate card itself: an owner quotes one Greece-wide weekly fee per yacht, and the shoulder discount is taken off that. The bands below are the current cards of the ninety-six fully crewed yachts on the ${SRC.index}, per yacht per week before VAT and APA. VAT is invoiced at 5.2, 6.5, 7.8 or 12% by certification, APA runs 20 to 30% of the base on sailing yachts and catamarans and 30 to 40% on motor yachts, and a 10 to 15% crew gratuity on the base is customary.`,
        dataTable: INDEX_BANDS,
      },
      {
