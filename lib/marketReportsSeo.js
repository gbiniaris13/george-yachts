...
export const MARKET_REPORTS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFindings: [
      ...
      "Greek VAT rate confirmed steady at 13% reduced rate for full 2026 season  -  no policy change expected.",
    ],
    sections: [
      {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          ...
          "All figures are base charter fee only, exclusive of APA (typically +30%), Greek VAT (+13%), delivery (where applicable), and crew gratuity (typically +12%). " +
