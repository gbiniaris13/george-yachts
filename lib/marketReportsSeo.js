...
export const MARKET_REPORTS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    eyebrow: "Quarterly research",
    h1: "Mid-Year Greek Yacht Charter Market Check",
    tagline:
    ...
    keyFindings: [
      ...
      "Greek statutory charter VAT steady at 13% reduced rate for the full 2026 season, with certification-based reductions keeping invoiced rates at 5.2-12% on most yachts  -  no policy change expected.",
    ],
    sections: [
      {
      ...
      },
      {
        ...
        body:
          ...
          "**Greek VAT:** statutory 13% reduced rate; invoiced 5.2-12% on certified yachts. " +
    ...
    seoTitle: "Mid-Year Greek Yacht Charter Market Check",
    seoDescription:
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          ...
          "All figures are base charter fee only, exclusive of APA (typically +30%), Greek VAT (at each yacht's certified rate, 5.2-13%), delivery (where applicable), and crew gratuity (typically +12%). " +
