...
export const MARKET_REPORTS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Q1 2026 Greek Yacht Charter Market Retrospective | George Yachts",
    seoDescription:
      "Original Q1 2026 Greek charter market data: bookings +23% by value YoY, peak season 78% committed by March, UHNW trade-up to 40m+ tier. Research from George Yachts.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Mid-Year 2026 Greek Yacht Charter Market Check | George Yachts",
    seoDescription:
      "May 2026 snapshot: 91% of peak Greek charter inventory committed, top-tier 50m+ fully booked, shoulder-season opportunities remain. Original George Yachts research.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "2026 Greek Yacht Charter Peak Season Forecast | George Yachts Research",
    seoDescription:
