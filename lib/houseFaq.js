...
export const ABOUT_FAQ = [
  ...
  },
  {
    ...
    a: "No, and that is the point. There is nothing we gain by steering you to one hull over another. We work across the Greek fleet, currently 70 yachts placed personally: 28 motor yachts, 15 power catamarans and 27 sailing catamarans, and if the right boat for your week is not among them we will tell you and go and find it.",
  },
];
...
export const HOME_FAQ = [
  {
    ...
    a: "Crewed yacht charter rates in Greece typically range from €13,000/week for entry-level catamarans up to €500,000+/week for 50m+ motor yachts. The base weekly rate covers the yacht and crew; an APA (Advance Provisioning Allowance) on top covers fuel, food, dockage and consumables, running from about 20% of the base on a sailing yacht to about 40% on a motor yacht. Greek VAT on the charter fee follows the yacht's certification: commercial crewed charters over 48 hours carry a statutory 13% rate, invoiced in practice at 5.2% to 12% on certified yachts, with the exact rate stated in the quote.",
  },
  {
