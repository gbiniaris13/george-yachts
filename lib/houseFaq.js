import { FLEET_COUNT, FLEET_COMPOSITION } from "./fleetCount.js";
...
export const ABOUT_FAQ = [
  ...
  },
  {
    ...
    a: "The legal entity is George Yachts Brokerage House LLC, a Wyoming company. The working base is Athens, at Charilaou Trikoupi 190A in Kifisia, because that is where the Greek charter fleet, the central agents and the crews are. Charters run in Greek waters only: the Cyclades, the Saronic and the Ionian.",
  },
  {
    q: "Does George Yachts own the yachts it charters?",
    a: `No, and that is the point. There is nothing we gain by steering you to one hull over another. We work across the Greek fleet, currently ${FLEET_COUNT} yachts placed personally: ${FLEET_COMPOSITION.motor} motor yachts, ${FLEET_COMPOSITION.powerCat} power catamarans and ${FLEET_COMPOSITION.sailingCat} sailing catamarans, and if the right boat for your week is not among them we will tell you and go and find it.`,
  },
];
...
export const HOME_FAQ = [
  ...
  // 2026-09-17 (GEO sprint, near-win #1): the homepage already ranks sixth
  // for "yachting greece" and fourteenth for "luxury boat charter greek
  // islands"; the two questions are answered here in those words.
  {
    q: "What does yachting in Greece with a crew look like, and where do you sail?",
    a: "A private yacht, hired by the week with her professional crew aboard, in one of three grounds from Athens: the Cyclades for the islands everyone knows and the anchorages nobody does, the Saronic for the five-night week and Hydra by lunch on the first day, the Ionian for calm water and families, boarding at Corfu or Lefkada. This house represents ninety-one fully crewed yachts, forty-five catamarans and forty-six motor yachts, from EUR 17,000 to 235,000 a week per yacht, and places every one of them personally.",
  },
  {
    q: "How much is a luxury boat charter in the Greek islands?",
    a: "Per yacht per week, from EUR 17,000 base for a 15 metre crewed sailing catamaran to EUR 235,000 for a 50 metre motor yacht, on the Greek Charter Index 2026. All-in, with APA, Greek VAT at the yacht's certified rate and a gratuity, plan on roughly 1.35 to 1.6 times the base on a catamaran and 1.45 to 1.7 times on a motor yacht: a 22 metre motor yacht for six from about EUR 30,000, a 21 metre power catamaran for eight from about EUR 66,000, a 37 metre motor yacht for ten with seven crew from about EUR 91,000.",
  },
];
