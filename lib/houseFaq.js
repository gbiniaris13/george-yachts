...
export const HOME_FAQ = [
  {
    ...
    a: "Crewed yacht charter rates in Greece typically range from €13,000/week for entry-level catamarans up to €500,000+/week for 50m+ motor yachts. The base weekly rate covers the yacht and crew; an APA (Advance Provisioning Allowance) of 25-35% on top covers fuel, food, dockage, and consumables. Greek VAT on the charter fee follows the yacht's certification: commercial crewed charters over 48 hours carry a statutory 13% rate, invoiced in practice at 5.2% to 12% on certified yachts, with the exact rate stated in the quote.",
  },
  {
  ...
  },
  {
    ...
    a: "APA stands for Advance Provisioning Allowance. It is a deposit paid before boarding (typically 25-35% of the charter fee) that the captain uses to pay for fuel, food, drinks, dockage fees, and any guest-requested provisioning during the charter. Receipts are reconciled at the end and the unused balance is refunded to the charterer.",
  },
  {
