...
export const ABOUT_FAQ = [
  ...
  },
  {
    ...
    a: "No, and that is the point. There is nothing we gain by steering you to one hull over another. We work across the Greek fleet, currently 72 yachts placed personally: 17 motor yachts, 16 power catamarans, 33 sailing catamarans and 6 sailing monohulls, and if the right boat for your week is not among them we will tell you and go and find it.",
  },
];
