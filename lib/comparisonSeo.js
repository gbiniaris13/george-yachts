...
export const COMPARISONS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      "One hundred crewed yachts on the list, 51 catamarans and 49 motor yachts, boarding at Athens, Lefkada or Corfu; 68 carry a walkthrough video on their page",
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Both markets have serious crewed yachts. On this house's list are 100, 51 catamarans and 49 motor yachts up to 64 metres, and 68 of them carry a walkthrough video on their page so you can judge for yourself."
      },
      {
  ...
  // ───────────────────────────────────────────────────────────── (2026-06-29)
  {
    ...
    whenBody:
      ...
      "**Fleet**: Palma is the place to find and refit very large motor yachts; this house's list runs to 50 metres in LA PELLEGRINA 1 and 64 in ELYSIUM, with 100 crewed yachts in all. " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whyBody:
      ...
      "**Greece** is the older sea. The islands are sharper, the water clearer, the food simpler, and the crewed fleet is now the same builders and the same refits you would find in Antibes: 100 yachts on this house's list, 68 with a walkthrough video on their page. " +
