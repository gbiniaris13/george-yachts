...
export const COMPARISONS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Greece vs Croatia Yacht Charter 2026 | 12-Point Comparison | George Yachts",
    ...
    whyBody:
      ...
      "**Pricing differs**. Greek charter rates run 10 to 20% above Croatian for equivalent yachts in equivalent weeks. Greek VAT is 12 to 24%; Croatian VAT is fixed at 13%. Greek APA tends to settle higher due to longer cruising distances; Croatian APA is more predictable on shorter day-passages. " +
    ...
    whenBody:
      ...
      "**VAT on charter**: Greece 12% (international waters) or 24% (Greek-only); Croatia 13% flat. " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Greece vs French Riviera Yacht Charter 2026 | Comparison | George Yachts",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Greece vs Turkey Yacht Charter 2026 | Comparison | George Yachts",
    ...
    whyBody:
      ...
      "**Greek waters are more developed for charter**. The fleet is larger and newer. The brokerage infrastructure (IYBA members, MYBA contracts, established practice) is more mature. Greek charter VAT is fixed at 12 or 24%. The cross-charter regulations are well-known. " +
    ...
    whenBody:
      ...
      "**VAT**: Greek 12% (international) or 24% (Greek-only); Turkish 18% (with reductions for foreign-flagged yachts on certain itineraries). " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Cyclades vs Ionian Yacht Charter 2026 | Comparison | George Yachts",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Motor vs Sailing Yacht Charter Greece 2026 | Comparison | George Yachts",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Catamaran vs Monohull Yacht Charter Greece 2026 | Comparison | George Yachts",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Crewed vs Bareboat Yacht Charter Greece 2026 | Comparison | George Yachts",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Athens vs Mykonos vs Lefkada Yacht Charter Departure 2026 | George Yachts",
