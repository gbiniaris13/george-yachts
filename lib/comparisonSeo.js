...
export const COMPARISONS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "Greece is the bigger sea: three cruising grounds within a week of Athens, the Cyclades, the Saronic and the Ionian, with more anchorages to spread across in August and a crewed fleet priced per yacht per week from EUR 17,000 on the Greek Charter Index. Croatia is the shorter passage: a dense coastal chain where the yacht anchors by lunch, a very large bareboat market and a reduced VAT rate on charter. The first-time charterer often starts in Croatia or the Greek Saronic; the charterer who wants the week to keep changing comes to the Cyclades. This house writes only Greek weeks.",
    },
    keyFacts: [
      ...
      "Ninety-one crewed yachts on the list, 45 catamarans and 46 motor yachts, boarding at Athens, Lefkada or Corfu; 66 carry a walkthrough video on their page",
    ],
    ...
    whyBody:
      ...
      "**On price, the Greek side is published and the Croatian side is not ours to publish**. On the Greek Charter Index 2026 a crewed sailing catamaran runs from EUR 17,000 a week net base at 15 metres to 90,000 at 24, a power catamaran 21,000 to 90,000, a motor yacht from 17,500 at 20 metres to 150,000 at 39, each figure the lowest and highest on a rate card this house holds. Croatia is usually the cheaper week at the same length; ask the operator for the gross total with tax and provisioning and set it against a Greek proposal that already itemises those lines. " +
    ...
    faq: [
      {
        ...
        a: "At the same length of yacht, Croatia is usually the cheaper week. The Greek side is published: crewed catamarans from EUR 17,000 and motor yachts from 17,500 a week net base on the Greek Charter Index 2026, before VAT at the yacht's certified rate and APA of 20 to 40 per cent. We do not publish Croatian figures we cannot source; compare gross totals."
      },
      {
      ...
      },
      {
        ...
        a: "Both markets have serious crewed yachts. On this house's list are 91, 45 catamarans and 46 motor yachts up to 64 metres, and 66 of them carry a walkthrough video on their page so you can judge for yourself."
      },
      {
  ...
  // ───────────────────────────────────────────────────────────── (2026-06-29)
  {
    ...
    seoTitle: "Greece vs Spain Yacht Charter | Which Coast, Crewed Week",
    ...
    whenBody:
      ...
      "**Fleet**: Palma is the place to find and refit very large motor yachts; this house's list runs to 50 metres in LA PELLEGRINA 1 and 64 in ELYSIUM, with 91 crewed yachts in all. " +
  ...
  // ───────────────────────────────────────────────────────────── (2026-06-29)
  {
    ...
    seoTitle: "Mykonos vs Santorini Yacht Charter: Which Base, or Both",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      "Fourteen yachts above 35 metres on this house's list, all based in Athens; the largest LA PELLEGRINA 1 at 50 metres and ELYSIUM at 64",
    ...
    whyBody:
      ...
      "**Greece** is the older sea. The islands are sharper, the water clearer, the food simpler, and the crewed fleet is now the same builders and the same refits you would find in Antibes: 91 yachts on this house's list, 66 with a walkthrough video on their page. " +
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Greece. The Meltemi gives the Cyclades real wind in July and August, the Ionian gives gentle sailing between Corfu, Paxos, Lefkada and Ithaca, and this house's list has 30 crewed sailing catamarans and six crewed sailing yachts for it. The Riviera is best for short coastal motor-yacht hops."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whenBody:
      ...
      "**Fleet**: modern crewed motor yachts and catamarans in Greece, 49 and 51 on this list; the gulet at scale in Turkey. " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whyBody:
      ...
      "**Bareboat is cheaper** (a bareboat sailing yacht in Greece is a fraction of a crewed week on the bareboat operators' rate cards, which this house does not broker; a crewed 12 to 16 metre sailing catamaran on the Greek Charter Index runs EUR 17,000 to 22,000 a week net base, a crewed 24 to 31 metre sailing yacht 24,000 to 55,000). The difference is the crew and the service. Bareboat suits experienced sailors and budget-conscious charterers. Crewed suits charterers who want the boat as a hotel rather than a hands-on activity. " +
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes, by a wide margin: a bareboat week on the operators' rate cards is a fraction of a crewed one, where a 12 to 16 metre crewed catamaran starts at EUR 17,000 a week net base on the Greek Charter Index. The trade-off is that you do all the work: sailing, navigation, cooking, cleaning, anchoring, paperwork."
      },
      {
