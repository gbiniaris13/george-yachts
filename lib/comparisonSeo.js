...
import { FLEET_COUNT } from "./fleetCount";
...
export const COMPARISONS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Detailed comparison of Greece vs Croatia for yacht charter: pricing, weather, anchorages, cuisine, logistics. Which fits your trip this season.",
    ...
    whyBody:
      ...
      "**Pricing differs**. Greek charter rates run 10 to 20% above Croatian for equivalent yachts in equivalent weeks. Greek VAT is statutory 13% on commercial crewed charters over 48 hours (24% for short or static), and certified Greek yachts are invoiced lower, at 5.2% to 12%; Croatian VAT is fixed at 13%. Greek APA tends to settle higher due to longer cruising distances; Croatian APA is more predictable on shorter day-passages. " +
    ...
    whenBody:
      ...
      "**VAT on charter**: Greece statutory 13% (commercial crewed over 48 hours; 24% short or static), invoiced 5.2-12% on certified yachts; Croatia 13% flat. " +
  ...
  // ───────────────────────────────────────────────────────────── (2026-06-29)
  {
    ...
    seoDescription: "Greece vs Spain (Balearics) yacht charter compared: VAT and pricing, cruising ground, glamour, fleet, logistics. Which fits your week.",
    ...
    whyBody:
      ...
      "**The tax difference is real money**. Greece charges a reduced statutory **13% VAT** on commercial crewed charters over 48 hours, and certified Greek yachts are invoiced lower still, at 5.2% to 12%; Spain charges its standard **21% VAT** on charter with no equivalent reduced rate. On a 100,000 EUR week that is an 8,000 to 15,800 EUR swing before anything else. Balearic marina and berthing costs in peak August also run materially higher than Greek equivalents. " +
    ...
    bestFor: [
      ...
      "UHNW buyers sensitive to the Greek-vs-Spanish VAT gap (as wide as 5.2% vs 21%) at six figures",
    ...
    whenBody:
      ...
      "**VAT on charter**: Greece statutory 13% (commercial crewed over 48 hours), invoiced 5.2-12% on certified yachts; Spain 21% standard, no reduced charter rate. " +
    ...
    insiderTitle: "Notes from George",
    insiderTips: [
      "The VAT gap (5.2-13% Greece by certification vs 21% Spain) is the single biggest cost lever between the two. On a long week it pays for a chef upgrade.",
    ...
    faq: [
      {
        ...
        a: "Greece is typically cheaper all-in, and the clearest reason is tax: Greek crewed charters over 48 hours carry a statutory 13% reduced VAT, invoiced at 5.2% to 12% on certified yachts, while Spanish charter VAT is the standard 21% with no equivalent reduction. Balearic peak-August marina costs also run higher than Greek equivalents."
      },
      {
  ...
  // ───────────────────────────────────────────────────────────── (2026-06-29)
  {
    ...
    faq: [
      ...
      // asking about the passage. Same page, same answer, the words they type.
      {
        ...
        a: "Yes, and it is the single most requested leg in the Cyclades. The two islands sit roughly 65 nautical miles apart, which is a comfortable day under power and a long one under sail, so the sensible version breaks the passage at Paros, Naxos or Ios rather than running it in one push. Going south you have the Meltemi behind you, which is why we build the week Mykonos first and Santorini later rather than the reverse."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Greece vs French Riviera yacht charter compared: pricing, glamour, anchorages, cuisine, fleet, logistics. Which Mediterranean destination fits your trip.",
    ...
    insiderTips: [
      ...
      "Crew gratuity convention is similar (10-15% of base rate); the absolute Euro number is lower in Greece because the base rate is lower.",
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Yes, in two separate charters. Repositioning a yacht from Monaco to Athens takes 7-10 days and is quoted per yacht on the delivery line, so practically you'd charter one fleet in the Riviera, fly to Athens, and pick up a separate Greek yacht. We coordinate; many UHNW clients alternate between the two markets year-on-year."
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Greece vs Turkey for yacht charter: pricing, fleet, regulations, cuisine, anchorages. Detailed comparison for UHNW charterers.",
    ...
    whyBody:
      ...
      "**Greek waters are more developed for charter**. The fleet is larger and newer. The brokerage infrastructure (IYBA members, MYBA contracts, established practice) is more mature. Greek charter VAT is statutory 13% on commercial crewed charters over 48 hours, invoiced at 5.2% to 12% on certified yachts. The cross-charter regulations are well-known. " +
    ...
    whenBody:
      ...
      "**VAT**: Greek statutory 13% invoiced at 5.2-12% on certified yachts; Turkish 18% (with reductions for foreign-flagged yachts on certain itineraries). " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whyBody:
      ...
      "**Bareboat is cheaper** (a bareboat sailing yacht in Greece is a fraction of a crewed week on the bareboat operators' rate cards, which this house does not broker; a crewed 12 to 16 metre sailing catamaran on the Greek Charter Index runs EUR 10,900 to 22,000 a week net base, a crewed 24 to 31 metre sailing yacht 24,000 to 49,000). The difference is the crew and the service. Bareboat suits experienced sailors and budget-conscious charterers. Crewed suits charterers who want the boat as a hotel rather than a hands-on activity. " +
