...
export const CHARTER_INDEX_2026 = {
  ...
  statCallouts: [
    ...
    { value: "58 yachts", label: "fully crewed boats whose current rate cards this index is built from, plus seven skipper-led from EUR 4,200" },
