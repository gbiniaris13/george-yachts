...
export const CHARTER_INDEX_2026 = {
  ...
  // 16,730-48,000, power catamaran 20 to 22 m opened at 33,000. Population
  // 105 = 99 of the 100 on the list plus the six crewed monohulls.
  dataModified: "2026-09-14",
  publishedAt: "2026-06-09",

  intro:
    "Original George Yachts rate data on crewed yacht charter in Greek waters, refreshed for the autumn of 2026 as the 2027 rate cards open. Across the one hundred and five fully crewed yachts with a current rate card, a sailing catamaran runs from EUR 10,900 a week net base at 14 metres to EUR 90,000 at 24 metres; a power catamaran from EUR 14,000 to EUR 90,000; a motor yacht from EUR 17,500 at 20 metres to EUR 150,000 at 39 metres; and the two yachts above 50 metres from EUR 162,500 to EUR 235,000. Every figure below is per yacht per week, before VAT and APA, and comes from a rate card we hold rather than from a market average.",

  summaryTable: {
    caption:
      "Weekly net base charter fee by yacht type and size (EUR, per yacht, excluding VAT and APA), from the current rate cards of the one hundred and five fully crewed yachts we represent. Autumn 2026, carrying into the 2027 season, recounted 14 September after twelve yachts joined the list.",
    columns: ["Yacht type and size", "Guests", "Weekly net base (EUR)", "Yachts"],
    rows: [
      { cells: ["Sailing catamaran, 12 to 16m", "8 to 10", "10,900-22,000", "8"] },
      { cells: ["Sailing catamaran, 16 to 19m", "8 to 10", "16,730-48,000", "10"] },
      { cells: ["Sailing catamaran, 20 to 22m", "8 to 10", "31,500-43,500", "8"] },
      { cells: ["Sailing catamaran, 23 to 24m", "8 to 10", "54,900-90,000", "8"] },
      { cells: ["Power catamaran, 13 to 17m", "6 to 8", "14,000-28,000", "3"] },
      ...
      { cells: ["Motor yacht, 26 to 31m", "7 to 12", "35,900-75,000", "9"] },
      { cells: ["Motor yacht, 32 to 34m", "8 to 12", "49,000-125,000", "10"] },
      { cells: ["Motor yacht, 35 to 40m", "10 to 12", "59,900-150,000", "13"] },
  ...
  statCallouts: [
    ...
    { value: "105 yachts", label: "fully crewed boats whose current rate cards this index is built from: 99 of the 100 on the list, plus six crewed sailing monohulls quoted separately" },
    { value: "68 videos", label: "of the 100 yachts on the list carry a walkthrough video on their own page, filmed aboard, deck by deck" },
  ...
  methodology:
    "Figures are net base charter fees (EUR per yacht per week, excluding VAT and APA), compiled by George Yachts from the current rate cards of the one hundred and five fully crewed yachts we represent, together with our own booking and quotation data across the 2025 and 2026 seasons. Each band states the lowest and highest figure that appears on a rate card in it, so the numbers are observed rather than modelled, and no cell is an estimate; a yacht sits in the band of its length rounded to the metre. Fully crewed means two or more crew. The population is the one hundred yachts on the list less one that quotes on request, plus six crewed sailing monohulls that are priced here but held apart from the fleet count. The motor list was renewed on 8 September 2026 and every band was recounted on 11 September, when two motor bands, 32 to 34 metres and 45 to 48 metres, were added because the renewed list filled what had been gaps; twelve more yachts joined on 14 September and were counted into the bands the same day. Gulets, which we quote on request rather than carry, run roughly EUR 9,500 to 44,500 a week (est.), the one estimated figure on this page. Rates move with the season and with each yacht's calendar: this edition was refreshed on 11 September 2026 as the 2027 cards opened, recounted on 14 September, and it is refreshed quarterly.",

  faqItems: [
    {
      question: "How much does a crewed catamaran charter in Greece cost in 2027?",
      answer:
        "On the boats we represent, a fully crewed sailing catamaran runs from EUR 10,900 a week net base at 14 metres, EUR 16,730 to 48,000 at 16 to 19 metres, EUR 31,500 to 43,500 at 20 to 22 metres, and EUR 54,900 to 90,000 at 23 to 24 metres. Power catamarans run EUR 14,000 to 28,000 up to 17 metres, EUR 33,000 to 69,000 at 20 to 22 metres, and EUR 49,000 to 90,000 at 23 to 24 metres. All figures are per yacht per week before VAT and APA, from the rate cards of the forty-two crewed catamarans on the list.",
    },
    {
