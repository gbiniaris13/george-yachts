...
export const serviceSchema = {
  ...
  // 2026-09-10 — moved here from the Organization node, where the property
  // is not defined and was failing validation on every page. The wording is
  // the true one: Search Console puts the United States first among our
  // countries and every charter closed this season was booked by American
  // guests. "Worldwide" was the old placeholder.
  "audience": {
    "@type": "Audience",
  ...
  "offers": [
    {
      "@type": "Offer",
      "name": "Catamaran Fleet - Crewed Charter",
      "description":
        "Smaller crewed sailing yachts and catamarans, crew of two or three, 6-12 guests typical.",
      "priceCurrency": "EUR",
      "price": "11500",
      "priceSpecification": {
    ...
    {
      "@type": "Offer",
      "name": "Motor Yacht Fleet - Full-Crew Charter",
      "description":
...
export const websiteSchema = {
  ...
  "inLanguage": "en",
  // 2026-09-10 — the SearchAction that stood here is gone. Google withdrew
  // the sitelinks search box from results in late 2024, so it earned
  // nothing; the target it named, /charter-yacht-greece?search=, is not a
  // search endpoint on this site; and its `query-input` key is Google's own
  // convention rather than a schema.org property, which had every page in
  // the fleet failing validation. Nothing true was lost by removing it.
};
