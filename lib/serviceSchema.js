...
export const serviceSchema = {
  ...
  "description":
    "Personally-vetted crewed yacht charters across the Greek islands — Cyclades, Ionian, Saronic, Sporades, Dodecanese. 66 yachts curated from a working broker in Athens. MYBA-standard contracts, full APA + VAT transparency, reply within 24 hours.",
  "provider": {
    "@type": "Organization",
  ...
  "areaServed": [
    ...
    { "@type": "Place", "name": "Skiathos, Greece" },
    { "@type": "Place", "name": "Dodecanese, Greece" },
...
export async function getServiceSchemaWithReviews() {
  ...
  const { fetchReviewAggregate, aggregateRatingForSchema } = await import(
  ...
  return { ...serviceSchema, aggregateRating: ratingBlock };
}
