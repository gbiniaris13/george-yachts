...
export const COMBOS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "How much does a motor yacht charter from Mykonos cost?", a: "Weekly rates start €60K for a 22-metre motor yacht and run to €450K+ for a 40-metre superyacht. Most Mykonos motor yacht charters settle €120-€250K base before APA (30-35%) and Greek VAT (13%)." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "How much does a Santorini motor yacht charter cost?", a: "Base rate €60-€280K depending on yacht size, plus 30-35% APA and 13% Greek VAT. Most charters settle €120-€220K all-in for a 25-30m motor yacht." },
    ],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "How much does a catamaran charter from Lefkada cost?", a: "Weekly rates start €25K for a 50-foot crewed catamaran and run to €90K for an 80-foot power catamaran. Most Lefkada catamaran weeks settle €35-€55K base before APA and Greek VAT (13% (24% for short charters under 48 hours))." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "How much does a Mykonos honeymoon yacht charter cost?", a: "Weekly rates start €30K for a 50-foot sailing yacht with two crew. Mid-range 60-foot crewed catamarans run €45-€75K. 25-metre motor yachts with full crew €80-€140K. Plus APA 25-30% and Greek VAT 13%. Most honeymoon charters settle €55-€110K all-in." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "How much does a Mykonos superyacht charter cost?", a: "Weekly rates start €280K for a 30-metre superyacht and run to €1.2M+ for a 50-metre. Most Mykonos superyacht charters settle €350-€600K base before APA (30-35%) and Greek VAT (13%). All-in for a 35-metre week in peak August: typically €600-€900K." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "How much does an Athens motor yacht charter cost?", a: "Weekly rates €50K for 22-metre motor yachts and €350K+ for 50-metre superyachts. Athens has the broadest range; typical week settles €80-150K base for 25-30m motor yachts before APA (30-35%) and Greek VAT (13%)." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "How much does an Athens superyacht charter cost?", a: "Weekly rates €250K for 40-metre motor yachts and €1.2M+ for 80-metre Lürssen or Feadship superyachts. APA 30-35% on top, Greek VAT 13% (24% for short charters). Typical 50-metre week settles €500-800K base." },
