...
export const COMBOS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Which yachts are based in Mykonos?", a: "Roughly 8 motor yachts in this house base in Mykonos for high season including 2-3 in the 30-40 metre range. Direct boarding saves the Athens positioning leg." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whenTitle: "When to book",
    whenBody: "Catamarans book 6-9 months ahead for peak August. **June, July, September** are the catamaran sweet spots - warm water, manageable Meltemi (or in catamaran-tolerant range), full beach-club operation. **May and October** suit pre/post-season weeks at the low end of each Index band.",
    ...
    faq: [
      { q: "How much does a catamaran charter from Mykonos cost?", a: "On the Greek Charter Index 2026 a crewed sailing catamaran lists at EUR 10,900 to 22,000 a week net base at 12 to 16 metres, 18,900 to 27,500 at 16 to 19, 31,500 to 43,500 at 20 to 22 and 56,000 to 90,000 at 23 to 24; power catamarans EUR 14,000 to 90,000 by length, before APA of 20 to 30% and VAT at the certified rate." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whenTitle: "When to book",
    whenBody: "**Mid-July to early September** is peak superyacht season in Mykonos. Book 12-18 months ahead for the marquee weeks (August 15-22 specifically). **Late May to early July** and **mid-September to mid-October** are shoulder seasons at the low end of each Index band with full superyacht service intact.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whenTitle: "When to book",
    whenBody: "**May through October** all work in the Ionian. **June and September** are the sweet spots: water warm enough to swim, wind reliable, rates 15 to 25% below peak on the Greek Charter Index. **July and August** the thermal still blows but harbours fill; book 6-9 months ahead. The Ionian sails later into October than the Aegean: thermal lasts until mid-October most years.",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    whyBody:
      ...
      "The Athens superyacht fleet differs from **Monaco or St. Tropez** in one critical way: **older Greek-built provenance**. The Onassis, Niarchos, Latsis, Vardinoyannis families commissioned superyachts in the 1960s through 1990s; the survivors have been refit and still charter from Athens. On the Greek Charter Index 2026 the yachts above 50 metres list at EUR 162,500 to 235,000 a week net base; the newer Italian and Dutch builds of that size sit in the same band or are quoted on request.",
    ...
    yachtsHeadline: "40m+ superyachts available 2027",
    ...
    faq: [
      { q: "How much does an Athens superyacht charter cost?", a: "On the Greek Charter Index 2026 a 35 to 40 metre motor yacht lists at EUR 60,000 to 120,000 a week net base and the yachts above 50 metres at EUR 162,500 to 235,000. APA of 30 to 40% on top, Greek VAT at the certified rate, 5.2 or 6.5% common at this size (statutory 13%; 24% for short charters). A EUR 200,000 week settles around EUR 308,000 all-in at VAT 12%, less on a certified yacht." },
      { q: "What's included in a superyacht charter?", a: "The charter fee covers vessel, full crew (12-28 people), insurance, mooring at base marina. APA covers fuel, food, beverages, port fees, marina dockage. VAT is on top. Excludes crew gratuity (typically 10-15% of base) and excursions ashore." },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      { q: "Can we add Corfu and Paxos to a Kefalonia catamaran week?", a: "Possible for 10-day charters. Kefalonia → Paxos is 60 nm, Paxos → Corfu is 35 nm. 7-day weeks stay south of Lefkada; 10-day weeks reach Corfu." },
    ],
