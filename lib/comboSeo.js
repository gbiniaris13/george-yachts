...
export const COMBOS = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "One price per yacht per week with crew, from the Greek Charter Index 2026: a 22 to 25 metre motor yacht EUR 21,000 to 47,500, a 26 to 31 metre 35,900 to 75,000, a 35 to 40 metre 59,900 to 150,000, before APA of 30 to 40% and Greek VAT at the certified rate. The motor yachts this house represents base in Athens, 90 nautical miles from Mykonos on the house table, and are positioned for a Mykonos start at a fee quoted per yacht. The stabilised ones for a Meltemi week: STAR LINK, VISTA and SHERO under 28 metres, SUMMER FUN, PROJECT STEEL, PAREAKI II and ARIELA above 30.",
    },
    keyFacts: [
