...
// unpublished from the Sailing Fleet.
//
...
export const FLEET_BREAKDOWN_SENTENCE =
  `${FLEET_COUNT} yachts placed personally: ${FLEET_COMPOSITION.motor} motor yachts, ` +
  `${FLEET_COMPOSITION.powerCat} power catamarans, ${FLEET_COMPOSITION.sailingCat} sailing catamarans, ` +
  `${FLEET_COMPOSITION.monohull} sailing monohulls`;
