...
export const FLEET_COMPOSITION = {
  // Counted 2026-09-08 from the live dataset, retired hulls excluded:
  // motor 46, power catamarans 15, sailing catamarans 27, monohulls 7.
  motor: 46,
  powerCat: 15,
  sailingCat: 27,
