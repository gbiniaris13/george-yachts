...
//
// Mixing Motor Yacht Fleet (per yacht / week) and Catamaran Fleet (per
...
//     `"per_yacht_week"` (default for Motor Yacht Fleet) or
//     `"per_person_week"` (default for Catamaran Fleet).
 ...
 * Motor Yacht Fleet shows first (sorted by price descending — flagship
 * leads), then Catamaran Fleet (sorted by price ascending — entry
