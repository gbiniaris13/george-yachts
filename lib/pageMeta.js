import { titleField } from "./seoTitle";
...
export function pageMeta({
  ...
  // 2026-08-08 — a page can now name a different canonical. Used where two
  // URLs serve near-identical content and the authority should sit on one of
  // them. og:url stays on the page's own address, because that is where the
  // visitor actually is.
