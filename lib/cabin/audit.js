...
export const AUDIT_ACTIONS = {
  ...
  // 2026-06-01 — Brief 06 cabin-closeout (S1 + S2): durable per-channel
  // signal for the two other George-notify pings that used to be
  // fire-and-forget (and therefore silently dropped on Vercel). Same
  // observability pattern as BRIEF_NOTIFICATIONS.
  WELCOME_NOTIFICATION: "welcome_notification",          // /cabin/welcome profile ping (DOB/hometown/mobile)
  MEMBER_DETAILS_NOTIFICATION: "member_details_notification", // /cabin/me crew-list completion ping (allergies)
  ...
  // 2026-06-01 — Brief 06 after-sales STEP 3 (KOMMATI 3): a guest the
  // principal brought aboard completed a charter, converting one referral
  // for that principal. Idempotent via the filotimo_referrals unique pair.
  FILOTIMO_REFERRAL_CONVERTED: "filotimo_referral_converted",
