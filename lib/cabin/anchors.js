      ...
      <tr><td align="center" style="padding:32px 16px;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="max-width:560px;background:#FFFFFF;border:1px solid rgba(13,27,42,0.08);">
          <tr><td style="background:#0D1B2A;padding:24px 32px;">
            <div style="font-family:'Helvetica Neue',Arial,sans-serif;color:#DAA110;letter-spacing:3.5px;font-size:11px;text-transform:uppercase">George Yachts</div>
            <div style="font-family:Georgia,serif;color:#F8F5F0;font-size:24px;line-height:1.1;margin-top:8px;font-weight:300">The Cabin <em style="color:#DAA110;font-style:italic">· Filotimo</em></div>
          </td></tr>
          <tr><td style="padding:8px 32px 28px;font-size:15px;line-height:1.75;color:#0D1B2A">
            ...
            <style>
              .cabin-cta {
                ...
                padding:14px 28px;border:1px solid #DAA110;text-transform:uppercase;
              }
            </style>
          </td></tr>
        </table>
