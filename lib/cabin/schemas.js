...
export const guestsSchema = z.object({
  ...
  energy_level: z
    .enum(["calm_restorative", "mixed", "very_social_late_nights"])
    .optional(),
...
export const littleThingsSchema = z.object({
  ...
  drone_photography: z
    .enum(["yes_please", "already_bringing", "no_thanks"])
    .optional(),
  professional_photographer: z
    .enum(["yes_please", "already_arranging", "no_thanks"])
    .optional(),
});
