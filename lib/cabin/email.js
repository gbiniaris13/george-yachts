...
export async function sendBriefMemberConfirmation({
  ...
  const body = `
    ...
    <p style="margin:0 0 16px 0;">
      Everything you added — your menu picks, your cellar requests,
      your Life Aboard answers, your private health and dietary
      notes — was reviewed by ${principalLabel} and folded into the
      brief that George received. The principal made the final call
      on the group&apos;s shared choices (meal times, what stays on
      the menu, the wine tier) so the chef and crew work from one
      clear voice, not five.
    </p>
    <p style="margin:0 0 16px 0;">
      Your private answers (health, allergies, dietary) reach the
      captain, chef and hostess exactly as you wrote them, without
      being shared with the rest of the group.
    </p>
    <p style="margin:0 0 24px 0;">
    ...
    <p style="margin:0 0 4px 0;font-size:13px;color:rgba(13,27,42,0.6);">
      <em>
        If something doesn&apos;t look right, message George directly
        on WhatsApp from your Cabin — he can reopen the brief or
        slip a quiet correction to the captain before embarkation.
      </em>
    </p>
  `;
