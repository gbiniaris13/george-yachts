...
export async function sendMagicLinkEmail({
  ...
  const opening = inviterFirst
    ...
    : `Welcome aboard, in spirit. Slowly, then all at once, your week aboard <strong>${esc(vesselName)}</strong> (${dates}) draws closer — the Aegean turning warm, the yacht being made ready — and your private Cabin at George Yachts is open for you.`;
