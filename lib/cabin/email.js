...
export async function sendMagicLinkEmail({
  ...
  const body = `
    ...
    <p style="margin:0 0 16px 0;">Inside you will find your charter details, a short Charter Brief that helps us look after you and your guests at sea — and a few small touches we have prepared for you. The brief takes about fifteen minutes, in your own time. Leave any field blank that does not apply.</p>
    ...
    <p style="margin:0 0 8px 0;font-size:13px;color:rgba(13,27,42,0.55);">This link is valid for 24 hours. If you need a new one, simply reply to this email.</p>
