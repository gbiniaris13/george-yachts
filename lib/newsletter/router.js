...
const MATRIX = {
  ...
  // Existing-yacht spotlight (rotation) — storytelling, not "just joined"
  spotlight: {
    bridge: "always",
    wake: "always",
    compass: "never",
  ...
  // 2026-09-03 — several new hulls in one letter (the fleet grew by
  // 23 in three weeks; one-yacht announcements could not keep up).
  fleet_update: {
    bridge: "always",
    wake: "always",
    compass: "never",
...
const NEVER_REASONS = {
  ...
  spotlight: {
    compass: "compass blocked: yacht spotlights are client-facing, not peer signals",
  },
  fleet_update: {
    compass: "compass blocked: fleet lists are client-facing inventory, not peer signals",
    greece: "greece blocked: From Greece is personal, not inventory",
  },
  story: {
