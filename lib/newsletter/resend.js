...
export async function sendNewsletterEmail({
  ...
  await recordSend();
  // Phase 5.1 — baseline engagement record. Resend's email.delivered
  // webhook (when configured) will overwrite this with the actual
  // delivery time, but we want a record even if webhooks aren't wired
  // up yet so re-engagement candidate detection has data to work with.
