...
I run George Yachts. We are a boutique yacht charter brokerage, exclusively in Greek waters. I'm a working broker - that means I spend half my time on the bridge of a vessel and the other half in conversations with captains, crew, and clients. I know these yachts personally because I've stood on most of these decks.
...
Issue #2 lands next Thursday. We're entering the busiest stretch of the booking season - there's plenty to share between now and the end of June.
...
export const ISSUE_1_HERO_IMAGE_URL =
  // Sanity asset already curated as the homepage main hero — George
  // has approved this image for public marketing use, satisfies
  // Brief §11.3 (≥1600px long side, JPEG, between 80KB–800KB after
  // Resend's CDN transform). 2048×1358 source, served at 1600px.
  "https://cdn.sanity.io/images/ecqr94ey/production/3f68c317276bd93dc1f2c77abfe5215d0d227868-2048x1358.jpg?w=1600&q=85&fit=max&auto=format";
