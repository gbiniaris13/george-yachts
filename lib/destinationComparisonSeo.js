...
export const DESTINATION_COMPARISONS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "Greece is the bigger sea: three cruising grounds within a week of Athens, the Cyclades, the Saronic and the Ionian, with more anchorages to spread across in August and a crewed fleet priced per yacht per week from EUR 17,000 on the Greek Charter Index. Croatia is the shorter passage: a dense island chain where the yacht anchors by lunch, a very large bareboat market, and a reduced VAT rate on charter. A first-time charterer who wants the easiest week often starts in Croatia. The charterer who wants the week they will talk about tends to come to Greece, and this house only writes Greek weeks.",
    keyFacts: [
      "Greek crewed weeks on the Index 2026: sailing catamarans EUR 17,000 to 90,000 net base, power catamarans 21,000 to 90,000, motor yachts 17,500 to 235,000, per yacht per week before VAT and APA",
      ...
      GREEK_TAX_NOTE,
      "Ninety-one crewed yachts on this house's list, 45 catamarans and 46 motor yachts, boarding at Athens, Lefkada or Corfu; 66 carry a walkthrough video on their page",
    ...
    comparisonTable: [
      ...
      },
      {
        ...
        greece: "EUR 17,000 to 235,000 on the Index, by type and size",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      "The largest yachts on this house's list: LA PELLEGRINA 1 at 50 metres and ELYSIUM, a 64 metre passenger ship for up to 49 guests; fourteen yachts above 35 metres, all based in Athens",
      GREEK_TAX_NOTE,
      ...
      "Sixty-six of the ninety-one yachts on the list carry a walkthrough video on their own page",
    ],
    evidence: INDEX,
    introBody:
    ...
    comparisonTable: [
      ...
      },
      {
        ...
        greece: "Fourteen yachts above 35 metres on this list, the largest 50 and 64 metres",
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          ...
          "This house's list runs to 50 metres in LA PELLEGRINA 1, twelve guests with a crew of nine at EUR 180,000 to 235,000 a week, and to 64 metres in ELYSIUM, a passenger-certified ship for up to 49 guests at EUR 162,500. Between 35 and 48 metres there are twelve yachts on the list, all based in Athens, nine of them with a walkthrough video on their page. For a week above that size we say so and help you find her elsewhere.",
      },
    ],
    whoChoosesGreece: [
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Between 20 and 50 metres, yes: the yachts on this list are the same builders and the same refits you would find in Antibes, and 66 of the 91 carry a walkthrough video so you can judge for yourself. Above 70 metres the Riviera has more yachts to choose from.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      "Ninety-one crewed yachts on the list, 45 catamarans and 46 motor yachts; 66 with a walkthrough video on their page",
    ],
    evidence: INDEX,
    introBody:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    comparisonTable: [
      ...
      },
      {
        ...
        greece: "Forty-six motor yachts and forty-five catamarans on this list, 66 with a walkthrough video",
    ...
    whoChoosesGreece: [
      ...
      "Groups above 35 metres: fourteen yachts on this list, all based in Athens",
    ],
    whoChoosesCompetitor: [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "Greece is the summer charter, May to October: cultural depth in every harbour, three cruising grounds from one country, and a crewed fleet priced per yacht per week on the Greek Charter Index from EUR 17,000. The Caribbean is the winter charter, November to April: warm water, the steadiest sailing wind in the trade, and St. Barths' season. They are opposites on the calendar rather than rivals, and a family that charters twice a year often does both. This house writes only the Greek summer.",
    keyFacts: [
      ...
      "Greek crewed weeks on the Index 2026: catamarans EUR 17,000 to 90,000 net base, motor yachts 17,500 to 235,000, per yacht per week before VAT and APA",
      GREEK_TAX_NOTE,
    ...
    faq: [
      ...
      },
      {
        ...
        a: "The Caribbean week carries no charter VAT in most jurisdictions, which is a real difference on the tax line. Whether the total is lower depends on the yacht and the dates, and we do not publish Caribbean rates we cannot source. The Greek side is on the Index: crewed catamarans from EUR 17,000 and motor yachts from 17,500 a week net base, VAT at 5.2 to 12 per cent by certification, APA 20 to 40 per cent.",
      },
      {
