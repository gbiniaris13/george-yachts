...
export const DESTINATION_COMPARISONS = [
    ...
    comparisonTable: [
      {
        ...
        edge: "tie",
        note: "Both share a 13% statutory reduced rate, and certified Greek yachts are invoiced lower still (5.2-12%). Among the Mediterranean's lowest charter VAT regimes.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "Greece offers dramatically lower costs (Greek VAT invoiced at 5.2-13% by certification vs French 20%), bigger landscapes, more privacy, and a deeper Greek-flagged fleet. The French Riviera offers proximity to Monaco's UHNW social calendar, world-class restaurants ashore, and shorter passages. UHNW buyers who want scenery choose Greece; UHNW buyers who want Monaco social access choose the Riviera.",
    introBody:
    ...
    faq: [
      {
        ...
        a: "Yes  -  roughly 40% cheaper for equivalent yachts and dates. Lower VAT (5.2-13% by certification vs French 20%), lower marina fees (€400-700/night vs €1,200-2,500/night), lower restaurant costs ashore. APA percentages similar but absolute APA spend lower in Greece.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "Greece offers dramatically lower VAT (invoiced 5.2-13% by certification vs Italian effective 6.6-22%), more sailing variety across multiple island groups, and better privacy. Italy offers iconic Amalfi or Sardinia scenery, world-class restaurants, and proximity to land-based luxury (Capri, Positano hotels). UHNW buyers split: Italy for first-week iconic photography, Greece for serial annual chartering.",
    introBody:
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Italian yacht charter VAT is the Mediterranean's most complex regime. The default rate is 22%, but structured itineraries that include time in international waters or other EU jurisdictions can effectively reduce to 6.6%. The structuring requires legal sophistication and a yacht/charter agreement designed around it. " +
          ...
          "Greek VAT is the simplest Mediterranean regime: a statutory 13% ceiling with the yacht's certification setting the invoiced rate (5.2-12% on most), all stated in the contract. No structuring, no surprises, no legal acrobatics. The Italian product offers ways to reduce VAT, but only if you have the legal team to structure it.",
      },
      {
    ...
    whoChoosesGreece: [
      ...
      "Charterers prioritising lower simpler VAT (a transparent certified rate of 5.2-13% vs Italian 6.6-22% structured)",
    ...
    faq: [
      {
        ...
        a: "By default yes  -  22% Italian vs the Greek statutory 13%, with certified Greek yachts invoiced at 5.2% to 12% without any structuring. Italian VAT can be structured down to 6.6% on certain itineraries with proper legal sophistication, but this is complex and requires a yacht/charter agreement designed for it. The Greek regime is simply lower by paperwork the yacht already holds.",
      },
      {
    ...
    comparisonTable: [
      {
        ...
        greece: "5.2-13% Greek VAT (by certification)",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    comparisonTable: [
      ...
      {
        criterion: "Charter VAT",
        greece: "5.2-13% Greek (by certification)",
