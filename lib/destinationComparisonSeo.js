...
export const DESTINATION_COMPARISONS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "Greece offers more dramatic landscapes, lower VAT (12% vs 13%), better food provenance, and stronger UHNW privacy norms. Croatia offers shorter cruising distances, cheaper marinas, and an easier first-time charter logistically. Most UHNW buyers who try both ultimately prefer Greece for repeat charters.",
    introBody:
    ...
    comparisonTable: [
      {
        ...
        greece: "12% (reduced rate)",
        competitor: "13% (reduced rate)",
        edge: "greece",
        note: "Both offer Mediterranean's lowest VAT regimes. Greece is marginally cheaper.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: "Yes — roughly 40% cheaper for equivalent yachts and dates. Lower VAT (12% vs effective 10–22%), lower marina fees (€400–700/night vs €1,200–2,500/night), lower restaurant costs ashore. APA percentages similar but absolute APA spend lower in Greece.",
      },
      {
    ...
    seoTitle: "Greek Yacht Charter vs French Riviera 2026: Honest UHNW Comparison",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    shortAnswer:
      "Greece offers dramatically lower VAT (12% vs Italian effective 6.6–22%), more sailing variety across multiple island groups, and better privacy. Italy offers iconic Amalfi or Sardinia scenery, world-class restaurants, and proximity to land-based luxury (Capri, Positano hotels). UHNW buyers split: Italy for first-week iconic photography, Greece for serial annual chartering.",
    introBody:
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Italian yacht charter VAT is the Mediterranean's most complex regime. The default rate is 22%, but structured itineraries that include time in international waters or other EU jurisdictions can effectively reduce to 6.6%. The structuring requires legal sophistication and a yacht/charter agreement designed around it. " +
          ...
          "Greek VAT at 12% flat is the simplest Mediterranean regime. No structuring, no surprises, no legal acrobatics. The Italian product offers ways to reduce VAT below the Greek flat rate, but only if you have the legal team to structure it.",
      },
      {
    ...
    whoChoosesGreece: [
      ...
      "Charterers prioritising lower simpler VAT (12% flat vs Italian 6.6–22% structured)",
    ...
    faq: [
      {
        ...
        a: "By default yes — 22% Italian vs 12% Greek. Italian VAT can be structured down to 6.6% on certain itineraries with proper legal sophistication, but this is complex and requires a yacht/charter agreement designed for it. Greek 12% is the simpler regime.",
      },
      {
    ...
    seoTitle: "Greek Yacht Charter vs Italy 2026: Amalfi, Sardinia, or Greek Islands?",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Greek Yacht Charter vs Turkey 2026: Aegean Decision Guide for UHNW Buyers",
    seoDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Greek Yacht Charter vs Caribbean 2026: Summer Med vs Winter BVI/St. Barths",
    seoDescription:
