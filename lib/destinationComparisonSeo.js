...
export const DESTINATION_COMPARISONS = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      GREEK_TAX_NOTE,
      "One hundred crewed yachts on this house's list, 51 catamarans and 49 motor yachts, boarding at Athens, Lefkada or Corfu; 68 carry a walkthrough video on their page",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      "Sixty-eight of the one hundred yachts on the list carry a walkthrough video on their own page",
    ],
    evidence: INDEX,
    introBody:
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Between 20 and 50 metres, yes: the yachts on this list are the same builders and the same refits you would find in Antibes, and 68 of the 100 carry a walkthrough video so you can judge for yourself. Above 70 metres the Riviera has more yachts to choose from.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      ...
      "One hundred crewed yachts on the list, 51 catamarans and 49 motor yachts; 68 with a walkthrough video on their page",
    ],
    evidence: INDEX,
    introBody:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    comparisonTable: [
      ...
      },
      {
        ...
        greece: "Forty-nine motor yachts and fifty-one catamarans on this list, 68 with a walkthrough video",
