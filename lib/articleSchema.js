...
export function generateArticleSchema(post) {
  ...
  return {
    ...
    "author": (() => {
      ...
      const author = {
        "@type": "Person",
        // Phase 7 Round 20 (2026-05-12) — @id and url now point to the
        // canonical E-E-A-T author page /about/george-p-biniaris, which
        // carries the richest Person record (full bibliography, workExample
        // array, credentials block). Every article author byline now
        // resolves to this canonical Person entity, consolidating all
        // editorial authority into one URL for AI engines to follow.
        "@id": "https://georgeyachts.com/about/george-p-biniaris#person",
        "name": "George P. Biniaris",
        "jobTitle": "Founder and Managing Broker",
        "description": "Founder and Managing Broker at George Yachts Brokerage House. IYBA member specializing in crewed motor yacht, sailing yacht, and catamaran charters across Greek waters. Featured in Forbes (May 2026).",
        ...
        "sameAs": [
          ...
          // Cross-link to /team/george-biniaris so the two Person URLs
          // are recognised as the same entity.
