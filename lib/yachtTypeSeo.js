  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    rateTable: {
      ...
      rows: [
        {
          cells: [
            "Smaller crewed catamaran (Sailing Fleet)",
            "36-46 ft",
    ...
    deepDive: [
      {
        ...
        body:
          "The question decides your week's rhythm, so it deserves a straight answer. A **sailing catamaran** gives you the mornings under canvas, the quiet, and the lower rate: at equal length, sailing types typically run about 30% below power for the week, and the fuel line in your APA stays modest. Our sailing roster runs from the Lagoon 46 and Bali Catspace of the Sailing Fleet to full-crew flagships like the Sunreef 80 and the Fountaine Pajot Thira 80. " +
      ...
      },
      {
        ...
        body:
          ...
          "The **Ionian** is catamaran heaven for a first charter: calm seas, short hops, green water. The inside passage at [Paxos and Antipaxos](/yacht-charter-paxos-anchorages) and the quiet bays of [Meganisi](/yacht-charter-meganisi-anchorages) are shallow-draft privileges, and several Sailing Fleet catamarans base in Lefkada and Corfu, which removes repositioning cost entirely. " +
    ...
    faq: [
      ...
      },
      {
        ...
        a: "No, and deliberately so. This house brokers fully crewed weeks only: the Private Fleet with a full crew, the Sailing Fleet on a smaller yacht with a crew of two or three. The week is meant to be lived, not operated. If you hold licenses and want to sail yourself, we are honestly not the right house for that charter."
      },
      {
