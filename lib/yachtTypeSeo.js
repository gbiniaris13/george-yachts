...
export const YACHT_TYPES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      "Forty-nine crewed motor yachts on the list, 19.5 to 64 metres, EUR 17,500 to 235,000 net base per yacht per week from their own rate cards; thirty-two carry a walkthrough video on their page",
    ...
    deepDive: [
      {
        ...
        body:
          "**A crewed motor yacht charter in Greece runs from €17,500 to €235,000 for the yacht and her crew for one week**, before APA and Greek charter VAT. That is not a bracket copied off a rate card. It is the true span of the forty-nine crewed motor yachts I place personally, from a 19.5 metre four-cabin boat with a crew of three to a 50 metre with a crew of nine. " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Catamaran Charter Greece: 51 Crewed Catamarans, Captain and Chef",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    // read 11 September.
    keyFacts: [
      "Fifty-one crewed catamarans on the list, 35 sailing and 16 power, 13.4 to 24.4 metres, EUR 10,900 to 90,000 net base per yacht per week from their own rate cards; thirty-six carry a walkthrough video on their page",
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    rateTable: {
      ...
      rows: [
        { cells: ["Entry crewed", "55 ft · 16-17 m", "€16,730-48,000", "8-10 guests, 3 crew · Bali 5.4, Lagoon 55, Bali Catspace 55"] },
  ...
  // a live listing read from Sanity 2026-07-02.
  {
    ...
    keyFacts: [
      ...
      "On the Greek Charter Index 2026 the power catamaran bands run EUR 14,000 to 28,000 up to 17 metres, EUR 33,000 to 69,000 at 20 to 22 metres and EUR 49,000 to 90,000 at 23 to 24 metres.",
      ...
      "Of the 100 yachts we represent, 51 are catamarans and 16 of those are power; a power catamaran is based in the Ionian at Corfu (ARIVA) and the rest around Athens.",
    ],
    evidence: { label: "George Yachts Greek Charter Index 2026", href: "/greek-charter-index-2026" },
    ...
    faq: [
      ...
      },
      {
        ...
        a: "From the live fleet: EUR 14,000-17,500 per week base for the compact MY 44, EUR 21,000-28,000 for the Aquila 54, EUR 33,000-48,000 for Power 67s, and EUR 49,000-90,000 for the 70-80 ft flagships. Add VAT at the yacht's certified rate (typically 6.5% or 12%) and APA of 25-35% on power catamarans.",
      },
      {
