  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      // would be neither checkable nor true.
      {
        ...
        a: "Be honest about the tier. Above roughly 45 metres the global houses, Burgess, Fraser, Northrop and Johnson, Edmiston, Camper and Nicholsons, have relationships with owners and captains built over decades and a genuine depth of access we do not pretend to match. If your week is a 60-metre with a beach club and a helipad, start there. Where we are the better call is the 25 to 45 metre band chartering Greek waters, where the decisive factors are not fleet size but knowing which captain suits which family, which anchorage takes that draft in a Meltemi, and which yacht is genuinely available rather than listed. Nothing on this list is a boat we are paid to fill, so nothing is being pushed. IYBA Charter Active Member, MYBA-standard contracts with APA, certified VAT and gratuity itemised before signature, George Yachts Brokerage House LLC of Wyoming operating from Athens, Forbes May 2026. Weekly and fully crewed only.",
      },
      {
      ...
      },
      {
        ...
        a: "On the Greek Charter Index a 26 to 31 metre motor yacht lists at EUR 40,000 to 65,000 net base per week, a 35 to 40 metre at EUR 60,000 to 120,000, and the yachts above 50 metres at EUR 162,500 to 235,000; a 60 metre vessel with eleven crew, two tenders and a helicopter sits well above that in the wider market. Add APA (typically 30%) and Greek charter VAT at the yacht's certified rate; large yachts frequently qualify for 5.2% or 6.5% (statutory 13%, or 24% for short charters under 48 hours)."
      },
      {
