...
export const YACHT_TYPES = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A crewed catamaran charter in Greece starts around €15,000 base, about €24,000 all-in per week with APA, VAT and gratuity, scaling up with size. Catamarans offer the most deck space and stability per euro, a shallow draft for beach anchorages, and are the family favourite in Greek waters.",
    },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A superyacht charter in Greece starts around €150,000 base, roughly €238,000 all-in per week once APA provisioning, VAT at the yacht's certified rate and crew gratuity are added, and climbs steeply with length above 40m. The rate buys a full crew of five or more, multiple tenders, a complete water-toy kit and a chef-led galley.",
    },
