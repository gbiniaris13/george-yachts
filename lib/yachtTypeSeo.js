...
export const YACHT_TYPES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    keyFacts: [
      "Weekly net base on the Index: EUR 17,500 to 33,000 at 18 to 24m, 40,000 to 65,000 at 26 to 31m, 60,000 to 120,000 at 35 to 40m",
    ...
    deepDive: [
      {
        ...
        body:
          "**A crewed motor yacht charter in Greece runs from €17,500 to €235,000 for the yacht and her crew for one week**, before APA and Greek charter VAT. That is not a bracket copied off a rate card. It is the true span of the seventeen crewed motor yachts I place personally, from a 19.5 metre four-cabin boat with a crew of three to a 50 metre with a crew of nine. " +
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A fully crewed catamaran charter in Greece starts around €18,000 base, about €28,500 all-in per week with APA, VAT and gratuity. The rate includes a captain, chef and hostess, so you step aboard to full service. Catamarans give families the most space, stability and shallow-draft beach access of any crewed type.",
    },
    ...
    faq: [
      {
        ...
        a: "Base rate covers: the yacht, the crew (captain, chef, hostess at minimum), insurance, and routine maintenance. APA (separate payment, 25 to 35% of base rate on catamarans) covers fuel, dockage, food, drinks, and other running costs. You bring suitcases and preferences."
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoDescription: "Gulet charter in Greek waters: what a gulet is, where the wooden fleet is based, and the crewed catamarans on the Index 2026 that give the same week from Athens.",
    quickAnswer: {
  ...
  // a live listing read from Sanity 2026-07-02.
  {
    ...
    keyFacts: [
      ...
      "Of the 69 yachts we represent, 42 are catamarans and 15 of those are power; a power catamaran is based in the Ionian at Corfu (ARIVA) and the rest around Athens.",
    ],
