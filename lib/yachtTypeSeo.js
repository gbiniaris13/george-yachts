...
export const YACHT_TYPES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A crewed motor yacht charter in Greece runs roughly €45,000 to €235,000 all-in per week, depending on size and season. A 30m motor yacht is about €118,000 all-in for a peak-season week, or around €19,600 per guest at six. The all-in figure covers the yacht and full crew, APA provisioning, VAT at the yacht's certified rate and a suggested gratuity.",
    },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A crewed catamaran charter in Greece starts around €15,000 base, about €25,000 all-in per week with APA, VAT and gratuity, scaling up with size. Catamarans offer the most deck space and stability per euro, a shallow draft for beach anchorages, and are the family favourite in Greek waters.",
    },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A megayacht charter in Greek waters starts around €500,000 base, well over €800,000 all-in per week with APA, VAT and gratuity, and rises further above 80m. At this level you charter ten-plus crew, helicopter touch-and-go capability and a full tender and toy fleet, with the itinerary built entirely around you.",
    },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A fully crewed catamaran charter in Greece starts around €18,000 base, about €29,000 all-in per week with APA, VAT and gratuity. The rate includes a captain, chef and hostess, so you step aboard to full service. Catamarans give families the most space, stability and shallow-draft beach access of any crewed type.",
    },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A crewed sailing catamaran charter in Greece starts around €18,000 base, roughly €29,000 all-in per week with APA, VAT and gratuity. Brands like Lagoon, Bali and Sunreef pair the stability and space of two hulls with quiet sailing, a combination families and groups of friends choose again and again.",
    },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A gulet charter in Greek waters starts around €14,000 base, about €23,000 all-in per week with APA, VAT and gratuity, depending on size and season. Traditional wooden gulets of 18 to 40m suit groups of 8 to 16, with broad shaded decks for long lunches and a relaxed, sociable rhythm aboard.",
    },
