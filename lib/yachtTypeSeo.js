...
export const YACHT_TYPES = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    rateTable: {
      ...
      caption:
        "George Yachts crewed sailing-catamaran fleet, 2026 season. Weekly base charter fee in EUR, excluding VAT (invoiced at the yacht's certified rate, typically 6.5-12%) and APA (25-30% of base). Skippered Explorer-fleet sailing cats, 11 to 16 metres, run €4,200-€22,000 and are quoted separately.",
  ...
  // a live listing read from Sanity 2026-07-02.
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "From the live fleet: EUR 14,000-17,500 per week base for the compact MY 44, EUR 21,000-28,000 for the Aquila 54, EUR 34,000-48,000 for Power 67s, and EUR 49,000-90,000 for the 70-80 ft flagships. Add VAT at the yacht's certified rate (typically 6.5% or 12%) and APA of 25-30%.",
      },
      {
