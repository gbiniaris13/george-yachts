...
export const YACHT_TYPES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    quickAnswer: {
      ...
      answer:
        "A crewed motor yacht charter in Greece runs roughly €44,000 to €228,000 all-in per week, depending on size and season. A 30m motor yacht is about €114,000 all-in for a peak-season week, or around €19,000 per guest at six. The all-in figure covers the yacht and full crew, APA provisioning, VAT at the yacht's certified rate and a suggested gratuity.",
    },
    ...
    deepDive: [
      ...
      },
      {
        ...
        body:
          ...
          "Per person, the arithmetic lands softer than the headlines: a 20 to 22 metre crewed catamaran at €31,500 to €43,500 for eight to ten guests is roughly €3,150 to €5,450 each for the week before VAT and APA, and a 12 to 16 metre one at €10,900 to €22,000 is roughly €1,090 to €2,750 each, per the [Greek Charter Index](/greek-charter-index-2026). The [complete pricing guide](/greek-yacht-charter-2026-complete-pricing-guide) walks every line item.",
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      ...
      // would be neither checkable nor true.
      {
        ...
        a: "Be honest about the tier. Above roughly 45 metres the global houses, Burgess, Fraser, Northrop and Johnson, Edmiston, Camper and Nicholsons, have relationships with owners and captains built over decades and a genuine depth of access we do not pretend to match. If your week is a 60-metre with a beach club and a helipad, start there. Where we are the better call is the 25 to 45 metre band chartering Greek waters, where the decisive factors are not fleet size but knowing which captain suits which family, which anchorage takes that draft in a Meltemi, and which yacht is genuinely available rather than listed. We own no hulls and hold no central agency mandates, so nothing is being pushed. IYBA Charter Active Member, MYBA-standard contracts with APA, certified VAT and gratuity itemised before signature, George Yachts Brokerage House LLC of Wyoming operating from Athens, Forbes May 2026. Weekly and fully crewed only.",
      },
      {
