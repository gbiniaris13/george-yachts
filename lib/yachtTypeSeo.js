...
export const YACHT_TYPES = [
  // ─────────────────────────────────────────────────────────────
  {
    ...
    seoTitle: "Motor Yacht Charter Greece 2026 | Crewed Motor Yachts",
    ...
    quickAnswer: {
      ...
      answer:
        "A crewed motor yacht charter in Greece runs roughly €45,000 to €235,000 all-in per week, depending on size and season. A 30m motor yacht is about €117,000 all-in for a peak-season week, or around €19,600 per guest at six. The all-in figure covers the yacht and full crew, APA provisioning, 13% VAT and a suggested gratuity.",
    },
