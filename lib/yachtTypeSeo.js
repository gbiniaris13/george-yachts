    ...
    faq: [
      {
        ...
        q: "Is a power cat charter in Greece the same thing as a power catamaran?",
        a: "Yes. Power cat is simply the short form the market uses for power catamaran, and this page is the Greek power cat charter fleet: twin-hull motor yachts with catamaran stability and motor yacht pace. If you searched for a power cat charter in Greece, the specifications, rates and availability below are exactly that.",
      },
      {
