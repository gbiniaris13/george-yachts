...
export const DEFAULT_ITINERARIES = {
  ...
  sporades: {
    totalDistance: "≈ 70 nautical miles",
    days: [
      { day: 1, from: "Skiathos", to: "Tsougria",
        note: "A 30-minute hop to the uninhabited islet of Tsougria. Lunch at anchor, swim, snorkel — the perfect first-day decompression after the flight." },
      { day: 2, from: "Tsougria", to: "Skopelos",
        note: "Skopelos town is the postcard of the Sporades — whitewashed amphitheatre rising from a horseshoe harbour. Dinner at Anatoli, the rooftop taverna with the rebetiko band." },
      { day: 3, from: "Skopelos", to: "Glysteri",
        note: "A short coastal sail to Glysteri, the cove on Skopelos's north shore. Lunch at the family taverna with feet in the sand. Afternoon swim and a paddleboard out to the small chapel on the rocks." },
      { day: 4, from: "Glysteri", to: "Alonissos",
        note: "Three hours under sail. Alonissos is inside the National Marine Park of the Sporades — the captain has the cruising permit. Patitiri harbour for the evening." },
      { day: 5, from: "Alonissos", to: "Kyra Panagia",
        note: "Day inside the marine park. Kyra Panagia is uninhabited, a 13th-century monastery on a hill, anchorages so quiet you can hear the goats from the boat." },
      { day: 6, from: "Kyra Panagia", to: "Skantzoura",
        note: "A reserve-only day — the captain stays the night at anchor in the lee of Skantzoura. With luck, a Mediterranean monk-seal sighting at first light." },
      { day: 7, from: "Skantzoura", to: "Skiathos",
        note: "A long sail back, lunch under way, last swim at Lalaria beach (accessible only by sea — the white pebble stones reflect the noon sun like a mirror). Disembark at Skiathos for the evening flight." },
    ],
  },
};
...
export function resolveSampleItinerary(yacht) {
  ...
  const slug = ["saronic", "cyclades", "ionian", "sporades"].find((s) =>
    region.includes(s),
  );
